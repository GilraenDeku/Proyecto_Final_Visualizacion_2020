...
class storytellingTarrazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTarrazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTarrazuSanJose.withSampleData() {
    return new storytellingTarrazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Tarrazú es el cantón número 5 de la provincia de San José.'
                        ' Tarrazú posee como cabecera la ciudad de San Marcos.'
                        ' En un valle rodeado de montañas que forman parte de'
                        ' la Cordillera de Talamanca. La principal fuente de '
                        'ingresos de la economía local es el cultivo y '
                        'exportación del café de altura. ',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Marcos, San Lorenzo y San Carlos',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Tarrazú se observa que el 83% de las casas'
                        ' cuentan con radio o equipos de sonido, el 57% con '
                        'línea de teléfono fija, 84% con teléfono celular, 14%'
                        ' con pantalla de televisor, de este 14% el 90% de los'
                        ' televisores son convencionales y el 36% son con cable'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el cantón de Tarrazú '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Tarrazú'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/TarrazuCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Tarraz%C3%BA');
            }
        ),
