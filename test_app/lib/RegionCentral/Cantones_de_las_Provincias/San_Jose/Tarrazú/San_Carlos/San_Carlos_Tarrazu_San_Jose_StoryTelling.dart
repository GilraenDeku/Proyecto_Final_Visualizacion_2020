...
class storytellingSanCarlosTarrazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanCarlosTarrazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanCarlosTarrazuSanJose.withSampleData() {
    return new storytellingSanCarlosTarrazuSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Tarrazú, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Carlos se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 54% '
                        'con línea de teléfono fija, 79% con teléfono celular, '
                        '8% con pantalla de televisor, de este 8% el 92% de los '
                        'televisores son convencionales y el 4% son con cable o'
                        ' satélite, el 20% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 12% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Carlos '
                        'el uso de las tecnologías es bastante grande, excepto '
                        'en las pantallas de televisión, computadoras portátiles'
                        ' e internet ya que se encuentran menores de 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Carlos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/TarrazuDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 79, Color(0xffEBDC87)),
      new LinearSales(3, 8, Color(0xff799351)),
      new LinearSales(4, 92, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 4, Color(0xff00B7C2)),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source='
                  'web&cd=&ved=2ahUKEwiM0vH0gZrrAhWGdd8KHdlbCHMQFjA'
                  'AegQIAxAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2F'
                  'docs%2F545cd98e71928_5.pdf&usg=AOvVaw3SyAi0hVzcxND3x7i-4sj3');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc='
                      's&source=web&cd=&ved=2ahUKEwiM0vH0gZrrAhWGdd8KHd'
                      'lbCHMQFjAAegQIAxAB&url=https%3A%2F%2Fwww.hacienda'
                      '.go.cr%2Fdocs%2F545cd98e71928_5.pdf&usg=AOvVa'
                      'w3SyAi0hVzcxND3x7i-4sj3');
                }
            ),
          ),
        ),
