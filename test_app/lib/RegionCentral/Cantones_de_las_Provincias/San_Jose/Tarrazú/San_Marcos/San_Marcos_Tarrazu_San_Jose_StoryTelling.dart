...
class storytellingSanMarcosTarrazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanMarcosTarrazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanMarcosTarrazuSanJose.withSampleData() {
    return new storytellingSanMarcosTarrazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Marcos se observa que el 83% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% '
                        'con línea de teléfono fija, 87% con teléfono celular,'
                        ' 17% con pantalla de televisor, de este 17% el 91% de '
                        'los televisores son convencionales y el 48% son con '
                        'cable o satélite, el 34% tienen una computadora de '
                        'escritorio, 26% con una computadora portátil y el 29%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Marcos '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Marcos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
