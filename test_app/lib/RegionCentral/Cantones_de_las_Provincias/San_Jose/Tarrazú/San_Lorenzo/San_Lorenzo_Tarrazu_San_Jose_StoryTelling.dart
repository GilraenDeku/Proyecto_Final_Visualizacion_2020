...
class storytellingSanLorenzoTarrazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanLorenzoTarrazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanLorenzoTarrazuSanJose.withSampleData() {
    return new storytellingSanLorenzoTarrazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Lorenzo se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 46% '
                        'con línea de teléfono fija, 79% con teléfono celular, '
                        '9% con pantalla de televisor, de este 9% el 86% de los '
                        'televisores son convencionales y el 21% son con cable '
                        'o satélite, el 22% tienen una computadora de escritorio,'
                        ' 14% con una computadora portátil y el 15% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Lorenzo '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Lorenzo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
