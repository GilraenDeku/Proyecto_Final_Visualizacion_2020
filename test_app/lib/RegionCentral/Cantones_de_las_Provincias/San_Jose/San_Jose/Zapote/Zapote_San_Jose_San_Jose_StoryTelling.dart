...
class storytellingZapoteSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZapoteSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZapoteSanJoseSanJose.withSampleData() {
    return new storytellingZapoteSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Zapote se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% '
                        'con línea de teléfono fija, 92% con teléfono celular,'
                        ' 34% con pantalla de televisor, de este 34% el 93% de '
                        'los televisores son convencionales y el 75% son con '
                        'cable o satélite, el 52% tienen una computadora de '
                        'escritorio, 45% con una computadora portátil y el 59%'
