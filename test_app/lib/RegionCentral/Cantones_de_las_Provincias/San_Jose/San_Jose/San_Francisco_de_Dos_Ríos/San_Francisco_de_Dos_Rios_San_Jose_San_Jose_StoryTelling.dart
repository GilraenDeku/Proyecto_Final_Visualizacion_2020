...
class storytellingSanFranciscodeDosRiosSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanFranciscodeDosRiosSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanFranciscodeDosRiosSanJoseSanJose.withSampleData() {
    return new storytellingSanFranciscodeDosRiosSanJoseSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de San José, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Francisco de dos Ríos se observa que '
                        'el 89% de las casas cuentan con radio o equipos de '
                        'sonido, el 79% con línea de teléfono fija, 94% con '
                        'teléfono celular, 40% con pantalla de televisor, de '
                        'este 40% el 92% de los televisores son convencionales'
                        ' y el 78% son con cable o satélite, el 57% tienen una'
                        ' computadora de escritorio, 54% con una computadora '
                        'portátil y el 68% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Francisco de dos Ríos, el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Francisco de Dos Ríos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanJoseDistritos.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(6, 57, Color(0xff8675A9)),
