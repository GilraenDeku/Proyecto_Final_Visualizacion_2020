...
class storytellingCarmenSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCarmenSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCarmenSanJoseSanJose.withSampleData() {
    return new storytellingCarmenSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Carmen se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 82% '
                        'con línea de teléfono fija, 89% con teléfono celular,'
                        ' 36% con pantalla de televisor, de este 36% el 86% de '
                        'los televisores son convencionales y el 73% son con '
                        'cable o satélite, el 49% tienen una computadora de '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Carmen, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
