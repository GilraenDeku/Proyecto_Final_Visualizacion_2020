...
class storytellingSanSebastianSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanSebastianSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanSebastianSanJoseSanJose.withSampleData() {
    return new storytellingSanSebastianSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Sebastián se observa que el 87% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '65% con línea de teléfono fija, 92% con teléfono '
                        'celular, 26% con pantalla de televisor, de este 26% '
                        'el 94% de los televisores son convencionales y el 65%'
                        ' son con cable o satélite, el 43% tienen una '
                        'computadora de escritorio, 32% con una computadora '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Sebastián'),
              ),
              body: ListView(
                children: [
                  Image.asset(
