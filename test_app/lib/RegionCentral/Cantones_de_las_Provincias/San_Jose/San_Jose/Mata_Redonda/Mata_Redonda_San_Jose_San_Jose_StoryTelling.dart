...
class storytellingMataRedondaSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMataRedondaSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMataRedondaSanJoseSanJose.withSampleData() {
    return new storytellingMataRedondaSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mata Redonda se observa que el 84% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '80% con línea de teléfono fija, 93% con teléfono '
                        'celular, 46% con pantalla de televisor, de este 46% el'
                        ' 85% de los televisores son convencionales y el 81% '
                        'son con cable o satélite, el 52% tienen una '
                        'computadora de escritorio, 60% con una computadora'
                        ' portátil y el 72% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Mata Redonda, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Mata Redonda'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 46, Color(0xff799351)),
      new LinearSales(4, 85, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 81, Color(0xff00B7C2)),
