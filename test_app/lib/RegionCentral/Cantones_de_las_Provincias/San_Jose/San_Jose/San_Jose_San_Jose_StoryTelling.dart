...
class storytellingSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJoseSanJose.withSampleData() {
    return new storytellingSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'El cantón San José es el cantón número 1 de la provincia '
                        'de San José, Costa Rica. El cantón contiene a la '
                        'capital costarricense, aunque la influencia de la '
                        'misma manifestada en extensión territorial y '
                        'población supera ampliamente las dimensiones '
                        'cantonales, en lo que se denomina el Gran Área '
                        'Metropolitana.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Carmen, Merced, Hospital, Catedral, Zapote,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de San José'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanJoseCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_San_Jos%C3%A9');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.msj.go.cr/SitePages/home.aspx');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.msj.go.cr/MSJ/Municipalidad/Observatorio'
                  '_SanJoseenCifras/Estudio%20Ni%C3%B1ez%20y%20Adolescencia'
                  '/Informe%20final%20y%20mapas%202016-2017/Mapas/Base2.png');
            }
        ),
