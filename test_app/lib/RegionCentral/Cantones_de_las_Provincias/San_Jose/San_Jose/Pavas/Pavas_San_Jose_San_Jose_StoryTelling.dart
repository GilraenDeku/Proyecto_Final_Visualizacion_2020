...
class storytellingPavasSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPavasSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPavasSanJoseSanJose.withSampleData() {
    return new storytellingPavasSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pavas se observa que el 84% de las casas'
                        ' cuentan con radio o equipos de sonido, el 67% con '
                        'línea de teléfono fija, 92% con teléfono celular, 28%'
                        ' con pantalla de televisor, de este 28% el 91% de los '
                        'televisores son convencionales y el 64% son con cable '
                        'o satélite, el 44% tienen una computadora de '
                        'escritorio, 32% con una computadora portátil y el 46% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Pavas, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 64, Color(0xff00B7C2)),
