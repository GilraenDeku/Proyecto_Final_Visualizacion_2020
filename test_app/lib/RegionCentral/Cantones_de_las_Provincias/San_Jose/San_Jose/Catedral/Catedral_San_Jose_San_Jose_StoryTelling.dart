...
class storytellingCatedralSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCatedralSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCatedralSanJoseSanJose.withSampleData() {
    return new storytellingCatedralSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Catedral se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% '
                        'con línea de teléfono fija, 87% con teléfono celular, '
                        '27% con pantalla de televisor, de este 27% el 91% de '
                        'los televisores son convencionales y el 59% son con '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Catedral, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Catedral'),
              ),
              body: ListView(
                children: [
                  Image.asset(
