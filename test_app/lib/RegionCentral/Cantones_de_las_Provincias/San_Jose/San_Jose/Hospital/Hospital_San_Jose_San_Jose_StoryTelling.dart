...
class storytellingHospitalSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingHospitalSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingHospitalSanJoseSanJose.withSampleData() {
    return new storytellingHospitalSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Hospital se observa que el 83% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% '
                        'con línea de teléfono fija, 89% con teléfono celular,'
                        ' 23% con pantalla de televisor, de este 23% el 92% de'
                        ' los televisores son convencionales y el 55% son con '
                        'cable o satélite, el 33% tienen una computadora de '
                        'escritorio, 24% con una computadora portátil y el 34% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Hospital, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Hospital'),
              ),
              body: ListView(
                children: [
                  Image.asset(
