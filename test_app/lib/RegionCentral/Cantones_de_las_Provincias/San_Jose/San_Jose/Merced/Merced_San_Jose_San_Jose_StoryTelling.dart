...
class storytellingMercedSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMercedSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMercedSanJoseSanJose.withSampleData() {
    return new storytellingMercedSanJoseSanJose(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Merced, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
