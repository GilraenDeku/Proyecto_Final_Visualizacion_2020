...
class storytellingLaUrucaSanJoseSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaUrucaSanJoseSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaUrucaSanJoseSanJose.withSampleData() {
    return new storytellingLaUrucaSanJoseSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Uruca se observa que el 76% de las'
                        ' casas cuentan con radio o equipos de sonido, el 43% '
                        'con línea de teléfono fija, 91% con teléfono celular,'
                        ' 22% con pantalla de televisor, de este 22% el 90% '
                        'de los televisores son convencionales y el 35% son con'
                        ' cable o satélite, el 30% tienen una computadora de '
                        'escritorio, 25% con una computadora portátil y el 31% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de La Uruca, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Uruca'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 43, Color(0xffFFA36C)),
