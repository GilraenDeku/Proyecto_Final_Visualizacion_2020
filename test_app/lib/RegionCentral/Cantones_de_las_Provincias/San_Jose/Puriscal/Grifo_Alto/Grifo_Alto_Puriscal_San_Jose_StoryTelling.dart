...
class storytellingGrifoAltoPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGrifoAltoPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGrifoAltoPuriscalSanJose.withSampleData() {
    return new storytellingGrifoAltoPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Grifo Alto se observa que el 83% de las'
                        ' casas cuentan con radio o equipos de sonido, el 69%'
                        ' con línea de teléfono fija, 61% con teléfono celular,'
                        ' 7% con pantalla de televisor, de este 7% el 91% de los'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distritos de Grifo Alto'
                        ' el uso de las tecnologías es bastante grande, excepto'
                        ' en las pantallas de televisión y las computadoras de '
                        'escritorio ya que se encuentran menores de 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Grifo Alto'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 61, Color(0xffEBDC87)),
