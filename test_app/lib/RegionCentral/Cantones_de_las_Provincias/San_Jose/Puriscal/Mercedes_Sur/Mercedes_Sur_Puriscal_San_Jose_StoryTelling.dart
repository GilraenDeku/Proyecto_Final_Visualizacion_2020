...
class storytellingMercedesSurPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMercedesSurPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMercedesSurPuriscalSanJose.withSampleData() {
    return new storytellingMercedesSurPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mercedes Sur se observa que el 80% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '65% con línea de teléfono fija, 78% con teléfono '
                        'celular, 13% con pantalla de televisor, de este 13% '
                        'el 89% de los televisores son convencionales y el '
                        '25% son con cable o satélite, el 26% tienen una '
                        'computadora de escritorio, 18% con una computadora '
                        'portátil y el 19% de las casas cuentan con '
                        'acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'población, no se recomienda enfocarse solo a '
                        'esta tecnología ya que los índices de uso de '
                        'las demás tecnologías son muy altos, lo que '
                        'indica que en el distritos de Mercedes Sur el'
                        ' uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisión y las '
                        'computadoras de escritorio e internet ya que'
                        ' se encuentran menores de 20% de'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Mercedes Sur'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 78, Color(0xffEBDC87)),
