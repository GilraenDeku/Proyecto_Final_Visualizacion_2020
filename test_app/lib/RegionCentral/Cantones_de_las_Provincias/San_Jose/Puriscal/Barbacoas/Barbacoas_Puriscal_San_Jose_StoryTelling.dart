...
class storytellingBarbacoasPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBarbacoasPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBarbacoasPuriscalSanJose.withSampleData() {
    return new storytellingBarbacoasPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Barbacoas se observa que el 82% de las'
                        ...
                        'los televisores son convencionales y el 15% son con '
                        'cable o satélite, el 29% tienen una computadora de '
                        'escritorio, 19% con una computadora portátil y el 18% '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Barbacoas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
