...
class storytellingSanRafaelPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelPuriscalSanJose.withSampleData() {
    return new storytellingSanRafaelPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 79% de las'
                        ' casas cuentan con radio o equipos de sonido, el 71% '
                        'con línea de teléfono fija, 78% con teléfono celular,'
                        ' 12% con pantalla de televisor, de este 12% el 91% de '
                        'los televisores son convencionales y el 16% son con '
                        'cable o satélite, el 29% tienen una computadora de '
                        'escritorio, 16% con una computadora portátil y el 19% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distritos de San '
                        'Antonio el uso de las tecnologías es bastante grande,'
                        ' excepto en las pantallas de televisión, computadoras'
                        ' portátiles e internet ya que se '
