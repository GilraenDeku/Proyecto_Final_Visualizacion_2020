...
class storytellingDesamparaditosPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDesamparaditosPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDesamparaditosPuriscalSanJose.withSampleData() {
    return new storytellingDesamparaditosPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Desamparaditos se observa que el 77% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '77% con línea de teléfono fija, 84% con teléfono '
                        'celular, 17% con pantalla de televisor, de este 17% '
                        'el 89% de los televisores son convencionales y el 22%'
                        ' son con cable o satélite, el 32% tienen una '
                        'computadora de escritorio, 27% con una computadora '
                        'portátil y el 22% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distritos de '
                        'Desamparaditos el uso de las tecnologías es bastante'
                        ' grande, excepto en las pantallas de ya que se '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Desamparaditos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
