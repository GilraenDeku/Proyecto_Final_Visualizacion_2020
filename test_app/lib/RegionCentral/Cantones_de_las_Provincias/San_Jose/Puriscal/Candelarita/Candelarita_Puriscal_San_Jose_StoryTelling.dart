...
class storytellingCandelaritaPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCandelaritaPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCandelaritaPuriscalSanJose.withSampleData() {
    return new storytellingCandelaritaPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Candelarita se observa que el 71% de las'
                        ' casas cuentan con radio o equipos de sonido, el 70% '
                        'con línea de teléfono fija, 63% con teléfono celular, '
                        '7% con pantalla de televisor, de este 7% el 90% de los '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Candelarita'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 71, Color(0xffD54062)),
      new LinearSales(1, 70, Color(0xffFFA36C)),
      new LinearSales(2, 63, Color(0xffEBDC87)),
