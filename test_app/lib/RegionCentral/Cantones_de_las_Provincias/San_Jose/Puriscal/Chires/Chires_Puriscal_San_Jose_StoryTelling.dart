...
class storytellingChiresPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingChiresPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingChiresPuriscalSanJose.withSampleData() {
    return new storytellingChiresPuriscalSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Chires se observa que el 69% de las '
                        'casas cuentan con radio o equipos de sonido, el 56% '
                        'con línea de teléfono fija, 69% con teléfono celular,'
                        ' 4% con pantalla de televisor, de este 4% el 85% de '
                        'los televisores son convencionales y el 4% son con '
                        'cable o satélite, el 12% tienen una computadora de '
                        'escritorio, 11% con una computadora portátil y el 7% '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 69, Color(0xffEBDC87)),
