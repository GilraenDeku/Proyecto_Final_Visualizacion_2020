...
class storytellingSanAntonioPuriscalSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAntonioPuriscalSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAntonioPuriscalSanJose.withSampleData() {
    return new storytellingSanAntonioPuriscalSanJose(
      _createSampleData(),
