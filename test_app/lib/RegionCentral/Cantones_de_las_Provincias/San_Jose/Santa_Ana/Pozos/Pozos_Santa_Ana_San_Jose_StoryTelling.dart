...
class storytellingPozosSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPozosSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPozosSantaAnaSanJose.withSampleData() {
    return new storytellingPozosSantaAnaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pozos se observa que el 85% de las casas'
                        ' cuentan con radio o equipos de sonido, el 77% con '
                        'línea de teléfono fija, 96% con teléfono celular, 48%'
                        ' con pantalla de televisor, de este 48% el 85% de los'
                        ' televisores son convencionales y el 81% son con cable'
                        ' o satélite, el 51% tienen una computadora de '
                        'escritorio, 55% con una computadora portátil y el 67%'
