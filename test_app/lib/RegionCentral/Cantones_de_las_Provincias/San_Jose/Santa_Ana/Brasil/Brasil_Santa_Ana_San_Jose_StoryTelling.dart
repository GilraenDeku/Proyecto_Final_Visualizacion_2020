...
class storytellingBrasilSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBrasilSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBrasilSantaAnaSanJose.withSampleData() {
    return new storytellingBrasilSantaAnaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Brasil se observa que el 80% de las '
                        ...
                        'escritorio, 31% con una computadora portátil y el 41%'
