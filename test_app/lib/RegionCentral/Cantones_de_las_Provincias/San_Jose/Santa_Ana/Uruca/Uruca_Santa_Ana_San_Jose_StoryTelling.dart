...
class storytellingUrucaSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingUrucaSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingUrucaSantaAnaSanJose.withSampleData() {
    return new storytellingUrucaSantaAnaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Uruca se observa que el 85% de las casas'
                        ' cuentan con radio o equipos de sonido, el 71% con '
                        'línea de teléfono fija, 93% con teléfono celular, 40% '
                        'con pantalla de televisor, de este 40% el 86% de los '
                        'televisores son convencionales y el 80% son con cable '
                        'o satélite, el 42% tienen una computadora de '
                        'escritorio, 47% con una computadora portátil y el 57% '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 80, Color(0xff00B7C2)),
