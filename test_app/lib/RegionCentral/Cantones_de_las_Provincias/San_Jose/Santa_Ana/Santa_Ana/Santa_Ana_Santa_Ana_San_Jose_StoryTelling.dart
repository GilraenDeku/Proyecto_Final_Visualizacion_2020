...
class storytellingSantaAnaSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaAnaSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaAnaSantaAnaSanJose.withSampleData() {
    return new storytellingSantaAnaSantaAnaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Santa Ana, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Ana se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 76% '
                        'con línea de teléfono fija, 94% con teléfono celular,'
                        ' 44% con pantalla de televisor, de este 44% el 82% '
                        'de los televisores son convencionales y el 83% son '
                        'con cable o satélite, el 49% tienen una computadora '
                        'de escritorio, 54% con una computadora portátil y el'
                        ' 67% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Ana'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SantaAnaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 44, Color(0xff799351)),
      new LinearSales(4, 82, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 83, Color(0xff00B7C2)),
