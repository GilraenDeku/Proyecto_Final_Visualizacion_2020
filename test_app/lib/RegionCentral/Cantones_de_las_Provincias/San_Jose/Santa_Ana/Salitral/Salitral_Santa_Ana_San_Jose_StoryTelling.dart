...
class storytellingSalitralSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSalitralSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSalitralSantaAnaSanJose.withSampleData() {
    return new storytellingSalitralSantaAnaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Salitral se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 52% '
                        'con línea de teléfono fija, 90% con teléfono celular,'
                        ' 19% con pantalla de televisor, de este 19% el 89% de '
                        'los televisores son convencionales y el 65% son con '
                        'cable o satélite, el 30% tienen una computadora de '
                        'escritorio, 23% con una computadora portátil y el 31% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Salitral, el '
                        'uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de'
                        ' televisión ya que se encuentran menores de 20% '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Salitral'),
              ),
              body: ListView(
                children: [
                  Image.asset(
