...
class storytellingSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaAnaSanJose.withSampleData() {
    return new storytellingSantaAnaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Santa Ana es un cantón situado en el área centro-norte '
                        'de la provincia de San José, en Costa Rica, y '
                        'perteneciente al Gran Área Metropolitana. Su '
                        'cabecera es el distrito de Santa Ana, con categoría'
                        ' de ciudad. El cantón se caracteriza por ofrecer a'
                        ' sus habitantes y visitantes un ambiente relajado y'
                        ' de modernas comodidades en cuanto a hospedaje, '
                        'gastronomía, recreación y entretenimiento.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Santa Ana, Salitral, Pozos, Uruca, Piedades y'
                        ' Brasil.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Santa Ana se observa que el 84% de las'
                        ' casas cuentan con radio o equipos de sonido, el 72%'
                        ' con línea de teléfono fija, 94% con teléfono celular,'
                        ' 40% con pantalla de televisor, de este 40% el 86% de'
                        ' los televisores son convencionales y el 77% son con '
                        'cable o satélite, el 46% tienen una computadora de '
                        'escritorio, 47% con una computadora portátil y el 58% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'cantón de Santa Ana, el '
                        'uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Santa Ana'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SantaAnaCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Santa_Ana_(Costa_Rica)');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.santaana.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.santaana.go.cr/images/documentos'
                  '/2018/Mapa%20Santa%20Ana%20Mayo%202018.pdf');
            }
        ),
