...
class storytellingPiedadesSantaAnaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPiedadesSantaAnaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPiedadesSantaAnaSanJose.withSampleData() {
    return new storytellingPiedadesSantaAnaSanJose(
      _createSampleData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Piedades'),
              ),
              body: ListView(
                children: [
                  Image.asset(
