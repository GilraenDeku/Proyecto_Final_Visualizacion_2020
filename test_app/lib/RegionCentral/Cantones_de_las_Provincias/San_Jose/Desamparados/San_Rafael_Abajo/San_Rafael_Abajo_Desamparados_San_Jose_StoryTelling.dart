...
class storytellingSanRafaelAbajoDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelAbajoDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelAbajoDesamparadosSanJose.withSampleData() {
    return new storytellingSanRafaelAbajoDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael Abajo se observa que el 86% '
                        'de las casas cuentan con radio o equipos de sonido, '
                        'el 60% con línea de teléfono fija, 89% con teléfono '
                        'celular, 25% con pantalla de televisor, de este 25% '
                        'el 94% de los televisores son convencionales y el '
                        '68% son con cable o satélite, el 43% tienen una '
                        'computadora de escritorio, 29% con una computadora '
                        'portátil y el 43% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Rafael Abajo, el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Rafael Abajo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 68, Color(0xff00B7C2)),
      new LinearSales(6, 43, Color(0xff8675A9)),
      new LinearSales(7, 29, Color(0xffEEBB40)),
      new LinearSales(8, 43, Color(0xff900C3F)),
    ];
