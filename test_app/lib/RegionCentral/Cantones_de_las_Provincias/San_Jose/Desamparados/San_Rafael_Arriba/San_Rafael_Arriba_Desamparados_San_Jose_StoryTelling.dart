...
class storytellingSanRafaelArribaDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelArribaDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelArribaDesamparadosSanJose.withSampleData() {
    return new storytellingSanRafaelArribaDesamparadosSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Desamparados, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael Arriba se observa que el 87%'
                        ' de las casas cuentan con radio o equipos de sonido,'
                        ' el 65% con línea de teléfono fija, 93% con teléfono'
                        ' celular, 26% con pantalla de televisor, de este 26%'
                        ' el 93% de los televisores son convencionales y el 65%'
                        ' son con cable o satélite, el 46% tienen una '
                        'computadora de escritorio, 30% con una computadora '
                        'portátil y el 45% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Rafael Arriba, el uso de las '
                        'tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Rafael Arriba'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 26, Color(0xff799351)),
      ...
      new LinearSales(8, 45, Color(0xff900C3F)),
    ];
