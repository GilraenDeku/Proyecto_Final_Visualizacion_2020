...
class storytellingLosGuidosDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLosGuidosDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLosGuidosDesamparadosSanJose.withSampleData() {
    return new storytellingLosGuidosDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Los Guido, se observa que el 78% de las'
                        ' casas cuentan con radio o equipos de sonido, el 56%'
                        ' con línea de teléfono fija, 89% con teléfono celular,'
                        ' 10% con pantalla de televisor, de este 10% el 95% de'
                        ' los televisores son convencionales y el 48% son con '
                        'cable o satélite, el 24% tienen una computadora de '
                        'escritorio, 9% con una computadora portátil y el 16%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Los Guido el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de '
                        'televisor, computadoras portátiles e internet ya '
                        'que se encuentran menor del 20% de disponibilidad de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Los Guidos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 78, Color(0xffD54062)),
      ...
      new LinearSales(5, 48, Color(0xff00B7C2)),
      new LinearSales(6, 24, Color(0xff8675A9)),
      new LinearSales(7, 9, Color(0xffEEBB40)),
