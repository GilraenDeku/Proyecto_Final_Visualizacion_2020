...
class storytellingDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDesamparadosSanJose.withSampleData() {
    return new storytellingDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Desamparados es un cantón situado en el área central de '
                        'la provincia de San José, en Costa Rica, y '
                        'perteneciente al Gran Área Metropolitana. Su '
                        'cabecera es el distrito de Desamparados, con '
                        'categoría de ciudad. El cantón cuenta con 235 863 '
                        'habitantes, de acuerdo con la última proyección '
                        'demográfica del INEC. El cantón se caracteriza '
                        'por ser uno de los más poblados del Gran Área '
                        'Metropolitana y del país.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Desamparados, San Miguel, San Juan de Dios,'
                        ' San Rafael Arriba, San Rafael Abajo, San Antonio,'
                        ' Frailes, Patarrá, San Cristóbal, Rosario, Damas,'
                        ' Gravilias y los Guidos',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Desamparados, se observa que el 86% de las'
                        ' casas cuentan con radio o equipos de sonido, el 65%'
                        ' con línea de teléfono fija, 91% con teléfono celular,'
                        ' 23% con pantalla de televisor, de este 23% el 94% de'
                        ' los televisores son convencionales y el 62% son con '
                        'cable o satélite, el 42% tienen una computadora de '
                        'escritorio, 27% con una computadora portátil y el 40%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'cantón de Desamparados, el uso de las tecnologías '
                        'es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Desamparados'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/DesamparadosCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 65, Color(0xffFFA36C)),
      ...
      new LinearSales(6, 42, Color(0xff8675A9)),
      new LinearSales(7, 27, Color(0xffEEBB40)),
      new LinearSales(8, 40, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Desamparados');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.desamparados.go.cr/es');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source='
                  'web&cd=&cad=rja&uact=8&ved=2ahUKEwjz3rDy65nrAhWlp1kKHS_UDk'
                  '0QFjATegQICRAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fdocs'
                  '%2F58123b80a600c_Mapa%2520del%2520Canton%2520Desamparados%'
                  '252003%2520Norte%2520Distrito%252001%2520a%252013.pdf&usg='
                  'AOvVaw1_xsLkZPIRGHZi3UbCm1mP');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjz3rDy65nr'
                      'AhWlp1kKHS_UDk0QFjATegQICRAB&url=https%3A%2F%2Fwww.'
                      'hacienda.go.cr%2Fdocs%2F58123b80a600c_Mapa%2520del%'
                      '2520Canton%2520Desamparados%252003%2520Norte%2520'
                      'Distrito%252001%2520a%252013.pdf&usg=AOvVaw1_xsLkZ'
                      'PIRGHZi3UbCm1mP');
                }
            ),
          ),
