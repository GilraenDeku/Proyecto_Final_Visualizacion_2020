...
class storytellingGraviliasDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGraviliasDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGraviliasDesamparadosSanJose.withSampleData() {
    return new storytellingGraviliasDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Gravilias, se observa que el 90% de las'
                        ' casas cuentan con radio o equipos de sonido, el 76% '
                        'con línea de teléfono fija, 93% con teléfono celular,'
                        ' 35% con pantalla de televisor, de este 35% el 93% de'
                        ' los televisores son convencionales y el 77% son con'
                        ' cable o satélite, el 54% tienen una computadora de '
                        'escritorio, 43% con una computadora portátil y el 58%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Gravilias, el uso de las tecnologías es'
                        ' bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Gravilias'),
              ),
              body: ListView(
                children: [
                  Image.asset(
