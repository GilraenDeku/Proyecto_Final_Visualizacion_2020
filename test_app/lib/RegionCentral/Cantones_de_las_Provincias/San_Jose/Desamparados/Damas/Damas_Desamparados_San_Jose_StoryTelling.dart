...
class storytellingDamasDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDamasDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDamasDesamparadosSanJose.withSampleData() {
    return new storytellingDamasDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Damas, se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 70% '
                        'con línea de teléfono fija, 94% con teléfono celular,'
                        ' 27% con pantalla de televisor, de este 27% el 93% '
                        'de los televisores son convencionales y el 72% son '
                        'con cable o satélite, el 49% tienen una computadora '
                        'de escritorio, 32% con una computadora portátil y el '
                        '49% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Damas, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
