...
class storytellingPatarraDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPatarraDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPatarraDesamparadosSanJose.withSampleData() {
    return new storytellingPatarraDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Patarrá, se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% '
                        'con línea de teléfono fija, 90% con teléfono celular,'
                        ' 17% con pantalla de televisor, de este 17% el 92% de '
                        'los televisores son convencionales y el 50% son con '
                        'cable o satélite, el 36% tienen una computadora de '
                        'escritorio, 18% con una computadora portátil y el 30% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Patarrá el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de '
                        'televisor y computadoras portátiles ya que se '
                        'encuentran menor del 20% de disponibilidad de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Patarrá'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 50, Color(0xff00B7C2)),
      new LinearSales(6, 36, Color(0xff8675A9)),
      new LinearSales(7, 18, Color(0xffEEBB40)),
