...
class storytellingRosarioDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingRosarioDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingRosarioDesamparadosSanJose.withSampleData() {
    return new storytellingRosarioDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Rosario, se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 60% '
                        'con línea de teléfono fija, 83% con teléfono celular, '
                        '10% con pantalla de televisor, de este 10% el 94% de '
                        'los televisores son convencionales y el 7% son con '
                        'cable o satélite, el 27% tienen una computadora de '
                        'escritorio, 14% con una computadora portátil y el 16%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Rosario'
                        ' el uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisor, computadoras '
                        'portátiles e internet ya que se encuentran menor del '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Rosario'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 60, Color(0xffFFA36C)),
      ...
      new LinearSales(7, 14, Color(0xffEEBB40)),
      new LinearSales(8, 16, Color(0xff900C3F)),
    ];
