...
class storytellingFrailesDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingFrailesDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingFrailesDesamparadosSanJose.withSampleData() {
    return new storytellingFrailesDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Desamparados, se observa que el 87% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '68% con línea de teléfono fija, 92% con teléfono '
                        'celular, 28% con pantalla de televisor, de este 28% '
                        'el 94% de los televisores son convencionales y el 70%'
                        ' son con cable o satélite, el 47% tienen una '
                        'computadora de escritorio, 35% con una computadora '
                        'portátil y el 48% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' distrito de Frailes el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de '
                        'televisor ya que se encuentra , computadoras '
                        'portátiles e internet menor del 20% de disponibilidad'
                        ' de posesión en la población.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Frailes'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 8, Color(0xff00B7C2)),
      new LinearSales(6, 26, Color(0xff8675A9)),
      new LinearSales(7, 16, Color(0xffEEBB40)),
      new LinearSales(8, 18, Color(0xff900C3F)),
    ];
