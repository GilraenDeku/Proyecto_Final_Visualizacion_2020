...
class storytellingSanCristobalDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanCristobalDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanCristobalDesamparadosSanJose.withSampleData() {
    return new storytellingSanCristobalDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Cristóbal, se observa que el '
                        '88% de las casas cuentan con radio o equipos de '
                        'sonido, el 68% con línea de teléfono fija, 87% '
                        'con teléfono celular, 10% con pantalla de televisor,'
                        ' de este 10% el 94% de los televisores son '
                        'convencionales y el 14% son con cable o satélite,'
                        ' el 34% tienen una computadora de escritorio, 16% con'
                        ' una computadora portátil y el 22% de las casas '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Cristóbal el uso de las tecnologías '
                        'es bastante grande, excepto en las pantallas de '
                        'televisor, computadoras portátiles e internet ya que'
                        ' se encuentran menor del 20% de disponibilidad de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Cristóbal'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 10, Color(0xff799351)),
      ...
      new LinearSales(8, 22, Color(0xff900C3F)),
    ];
