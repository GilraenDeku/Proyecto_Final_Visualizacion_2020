...
class storytellingSanJuandeDiosDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuandeDiosDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuandeDiosDesamparadosSanJose.withSampleData() {
    return new storytellingSanJuandeDiosDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan de Dios se observa que el 84%'
                        ' de las casas cuentan con radio o equipos de sonido,'
                        ' el 58% con línea de teléfono fija, 91% con teléfono'
                        ' celular, 19% con pantalla de televisor, de este 19%'
                        ' el 95% de los televisores son convencionales y el '
                        '60% son con cable o satélite, el 36% tienen una '
                        'computadora de escritorio, 21% con una computadora'
                        ' portátil y el 32% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'Juan de Dios el uso de las tecnologías es bastante '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Juan de Dios'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 60, Color(0xff00B7C2)),
      new LinearSales(6, 36, Color(0xff8675A9)),
      new LinearSales(7, 21, Color(0xffEEBB40)),
      new LinearSales(8, 32, Color(0xff900C3F)),
    ];
