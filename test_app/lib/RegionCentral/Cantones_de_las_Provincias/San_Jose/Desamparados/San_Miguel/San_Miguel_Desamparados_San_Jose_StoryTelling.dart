...
class storytellingSanMiguelDesamparadosSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanMiguelDesamparadosSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanMiguelDesamparadosSanJose.withSampleData() {
    return new storytellingSanMiguelDesamparadosSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Miguel se observa que el 86% de las'
                        ' casas cuentan con radio o equipos de sonido, el 66% '
                        'con línea de teléfono fija, 91% con teléfono celular,'
                        ' 20% con pantalla de televisor, de este 20% el 95% de'
                        ' los televisores son convencionales y el 62% son con '
                        'cable o satélite, el 41% tienen una computadora de '
                        'escritorio, 23% con una computadora portátil y el 36%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Miguel,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Miguel'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 36, Color(0xff900C3F)),
    ];
