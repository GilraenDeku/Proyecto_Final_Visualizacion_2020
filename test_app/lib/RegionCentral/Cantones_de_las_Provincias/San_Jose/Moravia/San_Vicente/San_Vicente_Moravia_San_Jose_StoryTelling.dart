...
class storytellingSanVicenteMoraviaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanVicenteMoraviaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanVicenteMoraviaSanJose.withSampleData() {
    return new storytellingSanVicenteMoraviaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Vicente se observa que el 90% de las'
                        ' casas cuentan con radio o equipos de sonido, el 79%'
                        ' con línea de teléfono fija, 94% con teléfono celular,'
                        ' 41% con pantalla de televisor, de este 41% el 92% de'
                        ' los televisores son convencionales y el 78% son con '
                        'cable o satélite, el 58% tienen una computadora de '
                        'escritorio, 54% con una computadora portátil y el 68% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Vicente, el uso de las tecnologías '
                        'es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Vicente'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 90, Color(0xffD54062)),
      new LinearSales(1, 79, Color(0xffFFA36C)),
      new LinearSales(2, 94, Color(0xffEBDC87)),
      new LinearSales(3, 41, Color(0xff799351)),
      new LinearSales(4, 92, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 78, Color(0xff00B7C2)),
      new LinearSales(6, 58, Color(0xff8675A9)),
      new LinearSales(7, 54, Color(0xffEEBB40)),
      new LinearSales(8, 68, Color(0xff900C3F)),
    ];
