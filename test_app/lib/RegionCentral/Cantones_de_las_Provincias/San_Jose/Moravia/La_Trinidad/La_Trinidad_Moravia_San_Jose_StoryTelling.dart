...
class storytellingLaTrinidadMoraviaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaTrinidadMoraviaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaTrinidadMoraviaSanJose.withSampleData() {
    return new storytellingLaTrinidadMoraviaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Trinidad se observa que el 88% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '67% con línea de teléfono fija, 94% con teléfono '
                        'celular, 28% con pantalla de televisor, de este 28% '
                        'el 94% de los televisores son convencionales y el '
                        '67% son con cable o satélite, el 50% tienen una '
                        'computadora de escritorio, 34% con una computadora '
                        'portátil y el 50% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de La '
                        'Trinidad, el uso de las tecnologías es bastante '
                        'grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Trinidad'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 34, Color(0xffEEBB40)),
      new LinearSales(8, 50, Color(0xff900C3F)),
    ];
