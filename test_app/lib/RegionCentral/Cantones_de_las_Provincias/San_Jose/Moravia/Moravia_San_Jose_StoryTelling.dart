...
class storytellingMoraviaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMoraviaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMoraviaSanJose.withSampleData() {
    return new storytellingMoraviaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Moravia es un cantón situado en el área norte de la '
                        'provincia de San José, en Costa Rica, y '
                        'perteneciente al Gran Área Metropolitana. Su '
                        'cabecera es el distrito de San Vicente, con '
                        'categoría de ciudad. El cantón se caracteriza por ser'
                        ' uno de los más desarrollados de la provincia de San'
                        ' José y del país. El cantón resalta por su alta '
                        'producción de artesanías y combinar un estilo antiguo'
                        ' con un estilo moderno en sus ciudades y villas.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Vicente, San Jerónimo y La Trinidad',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Moravia se observa que el 89% de las '
                        'casas cuentan con radio o equipos de sonido, el '
                        '73% con línea de teléfono fija, 94% con teléfono '
                        'celular, 34% con pantalla de televisor, de este '
                        '34% el 93% de los televisores son convencionales y'
                        ' el 71% son con cable o satélite, el 53% tienen'
                        ' una computadora de escritorio, 44% con una '
                        'computadora portátil y el 58% de las casas cuentan'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'cantón de Moravia, el uso de las tecnologías '
                        'es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Moravia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/MoraviaCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 73, Color(0xffFFA36C)),
      new LinearSales(2, 94, Color(0xffEBDC87)),
      new LinearSales(3, 34, Color(0xff799351)),
      new LinearSales(4, 93, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 71, Color(0xff00B7C2)),
      new LinearSales(6, 53, Color(0xff8675A9)),
      new LinearSales(7, 44, Color(0xffEEBB40)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Moravia');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.moravia.go.cr/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwjEgpqd-pnrAhXHwVkKHbteD'
                  'S8QFjACegQIAhAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fd'
                  'ocs%2F55367b1cbd81e_114_Mapa_Valores_Distrito%252001%252'
                  '0a%252003%2520(Canton%2520Moravia).pdf&usg=AOvVaw1o48zTSbr'
                  'nt3Dj6-qSVFzz');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjEgpqd-pnr'
                      'AhXHwVkKHbteDS8QFjACegQIAhAB&url=https%3A%2F%2Fwww.h'
                      'acienda.go.cr%2Fdocs%2F55367b1cbd81e_114_Mapa_Valore'
                      's_Distrito%252001%2520a%252003%2520(Canton%2520Moravi'
                      'a).pdf&usg=AOvVaw1o48zTSbrnt3Dj6-qSVFzz');
                }
            ),
          ),
        ),
