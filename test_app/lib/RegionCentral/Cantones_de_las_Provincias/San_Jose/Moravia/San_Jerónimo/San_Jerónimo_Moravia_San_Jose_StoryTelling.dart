...
class storytellingSanJeronimoMoraviaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJeronimoMoraviaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJeronimoMoraviaSanJose.withSampleData() {
    return new storytellingSanJeronimoMoraviaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Moravia, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Jerónimo se observa que el 85% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '60% con línea de teléfono fija, 91% con teléfono '
                        'celular, 18% con pantalla de televisor, de este 18% '
                        'el 95% de los televisores son convencionales y el 46% '
                        'son con cable o satélite, el 38% tienen una '
                        'computadora de escritorio, 24% con una computadora '
                        'portátil y el 30% de las casas cuentan con acceso de '
                        'internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' los cuales van en un aumento considerable. '
                        'A pesar de que los celulares son los que más '
                        'utiliza la población, no se recomienda enfocarse'
                        ' solo a esta tecnología ya que los índices de '
                        'uso de las demás tecnologías son muy altos, lo '
                        'que indica que en el distrito de San Jerónimo, '
                        'el uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de ya que se encuentran'
                        ' menores de 20% de disponibilidad de posesión '
                        'en la población.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Jerónimo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/MoraviaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 46, Color(0xff00B7C2)),
