...
class storytellingSanJuanTibasSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuanTibasSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuanTibasSanJose.withSampleData() {
    return new storytellingSanJuanTibasSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 32% '
                        'con pantalla de televisor, de este 32% el 93% de los '
                        'televisores son convencionales y el 74% son con cable o '
                        'satélite, el 51% tienen una computadora de escritorio, '
                        '47% con una computadora portátil y el 59% de las casas '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Juan, el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Juan'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 74, Color(0xff00B7C2)),
