...
class storytellingLeonXIIITibasSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLeonXIIITibasSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLeonXIIITibasSanJose.withSampleData() {
    return new storytellingLeonXIIITibasSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de León XIII se observa que el 81% de las'
                        ' casas cuentan con radio o equipos de sonido, el 48%'
                        ' con línea de teléfono fija, 90% con teléfono celular,'
                        ' 16% con pantalla de televisor, de este 16% el 93% de'
                        ' los televisores son convencionales y el 32% son con '
                        'cable o satélite, el 28% tienen una computadora de '
                        'escritorio, 11% con una computadora portátil y el 16% '
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'sonido, telefonía celular y fija y computadoras de '
                        'escritorio siendo el teléfono celular la tecnología '
                        'de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de León XIII'),
              ),
              body: ListView(
                children: [
                  Image.asset(
