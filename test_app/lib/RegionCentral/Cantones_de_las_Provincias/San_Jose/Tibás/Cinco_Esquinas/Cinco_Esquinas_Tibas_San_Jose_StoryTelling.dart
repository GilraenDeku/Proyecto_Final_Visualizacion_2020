...
class storytellingCincoEsquinasTibasSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCincoEsquinasTibasSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCincoEsquinasTibasSanJose.withSampleData() {
    return new storytellingCincoEsquinasTibasSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cinco Esquinas se observa que el 87% de'
                        ' las casas cuentan con radio o equipos de sonido, el'
                        ' 52% con línea de teléfono fija, 90% con teléfono '
                        'celular, 19% con pantalla de televisor, de este 19% '
                        'el 95% de los televisores son convencionales y el 58% '
                        'son con cable o satélite, el 36% tienen una '
                        'computadora de escritorio, 22% con una computadora '
                        'portátil y el 37% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Cinco Esquinas '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cinco Esquinas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 58, Color(0xff00B7C2)),
