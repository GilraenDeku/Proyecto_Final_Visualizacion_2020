...
class storytellingColimaTibasSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingColimaTibasSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingColimaTibasSanJose.withSampleData() {
    return new storytellingColimaTibasSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Colima se observa que el 89% de las casas'
                        ' cuentan con radio o equipos de sonido, el 71% con línea'
                        ' de teléfono fija, 94% con teléfono celular, 34% con '
                        'pantalla de televisor, de este 34% el 92% de los '
                        'televisores son convencionales y el 72% son con cable o'
                        ' satélite, el 51% tienen una computadora de escritorio,'
                        ' 45% con una computadora portátil y el 58% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Colima '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 45, Color(0xffEEBB40)),
