...
class storytellingAnselmoLlorenteTibasSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAnselmoLlorenteTibasSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAnselmoLlorenteTibasSanJose.withSampleData() {
    return new storytellingAnselmoLlorenteTibasSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Tibás, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Anselmo Llorente se observa que el 89% '
                        'de las casas cuentan con radio o equipos de sonido, '
                        'el 80% con línea de teléfono fija, 94% con teléfono '
                        'celular, 39% con pantalla de televisor, de este 39% '
                        'el 92% de los televisores son convencionales y el 78%'
                        ' son con cable o satélite, el 56% tienen una '
                        'computadora de escritorio, 53% con una computadora '
                        'portátil y el 67% de las casas cuentan con acceso de'
                        ' internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Anselmo Llorente '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Anselmo Llorente'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/TibasDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 80, Color(0xffFFA36C)),
      new LinearSales(2, 94, Color(0xffEBDC87)),
      new LinearSales(3, 39, Color(0xff799351)),
      new LinearSales(4, 92, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 78, Color(0xff00B7C2)),
      new LinearSales(6, 56, Color(0xff8675A9)),
      new LinearSales(7, 53, Color(0xffEEBB40)),
      new LinearSales(8, 67, Color(0xff900C3F)),
    ];
