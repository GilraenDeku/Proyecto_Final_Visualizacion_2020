...
class storytellingJardinDotaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingJardinDotaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingJardinDotaSanJose.withSampleData() {
    return new storytellingJardinDotaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Dota, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Jardín se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% '
                        'con línea de teléfono fija, 88% con teléfono celular, '
                        '9% con pantalla de televisor, de este 9% el 92% de los'
                        ' televisores son convencionales y el 16% son con cable'
                        ' o satélite, el 28% tienen una computadora de '
                        'escritorio, 13% con una computadora portátil y el 17%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Jardín el uso de las tecnologías es '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Jardín'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/DotaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 59, Color(0xffFFA36C)),
      ...
      new LinearSales(6, 28, Color(0xff8675A9)),
