...
class storytellingSantaMariaDotaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaMariaDotaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaMariaDotaSanJose.withSampleData() {
    return new storytellingSantaMariaDotaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa María se observa que el 83% de las'
                        ' casas cuentan con radio o equipos de sonido, el 68% '
                        'con línea de teléfono fija, 85% con teléfono celular, '
                        '18% con pantalla de televisor, de este 18% el 86% de '
                        'los televisores son convencionales y el 65% son con '
                        'cable o satélite, el 36% tienen una computadora de '
                        'escritorio, 26% con una computadora portátil y el 31% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Santa María el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de televisor'
                        ' ya que se encuentra menor del 20% de disponibilidad '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa María'),
              ),
              body: ListView(
                children: [
                  Image.asset(
