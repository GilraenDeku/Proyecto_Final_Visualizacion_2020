...
class storytellingCopeyDotaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCopeyDotaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCopeyDotaSanJose.withSampleData() {
    return new storytellingCopeyDotaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Copey se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% '
                        'con línea de teléfono fija, 84% con teléfono celular,'
                        ' 6% con pantalla de televisor, de este 6% el 91% de '
                        'los televisores son convencionales y el 26% son con '
                        'cable o satélite, el 27% tienen una computadora de '
                        'escritorio, 18% con una computadora portátil y el '
                        '16% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' distrito de Copey el uso de las tecnologías es '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 26, Color(0xff00B7C2)),
