...
class storytellingSanRafaelEscazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelEscazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelEscazuSanJose.withSampleData() {
    return new storytellingSanRafaelEscazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 89% de las'
                        ' casas cuentan con radio o equipos de sonido, el 85% '
                        'con línea de teléfono fija, 95% con teléfono celular,'
                        ' 61% con pantalla de televisor, de este 61% el 81% de'
                        ' los televisores son convencionales y el 84% son con '
                        'cable o satélite, el 57% tienen una computadora de '
                        'escritorio, 69% con una computadora portátil y el 79% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'Rafael, el uso de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 61, Color(0xff799351)),
      new LinearSales(4, 81, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 84, Color(0xff00B7C2)),
      new LinearSales(6, 57, Color(0xff8675A9)),
      new LinearSales(7, 69, Color(0xffEEBB40)),
      new LinearSales(8, 79, Color(0xff900C3F)),
    ];
