...
class storytellingEscazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingEscazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingEscazuSanJose.withSampleData() {
    return new storytellingEscazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Escazú es el cantón número 2 de la provincia de San José'
                        ' y perteneciente al Gran Área Metropolitana, siendo '
                        'uno de los cantones que la conforman con mayor área '
                        'habitacional. Su cabecera, comúnmente conocida con '
                        'el propio nombre del cantón, es la ciudad de San Miguel.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Miguel, San Antonio y San Rafael.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Escazú se observa que el 88% de las casas'
                        ' cuentan con radio o equipos de sonido, el 77% con '
                        'línea de teléfono fija, 92% con teléfono celular, '
                        '42% con pantalla de televisor, de este 42% el 88% de'
                        ' los televisores son convencionales y el 71% son con'
                        ' cable o satélite, el 50% tienen una computadora de '
                        'escritorio, 50% con una computadora portátil y el '
                        '62% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Escazú, '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Escazú'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/EscazuCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 77, Color(0xffFFA36C)),
      ...
      new LinearSales(7, 50, Color(0xffEEBB40)),
      new LinearSales(8, 62, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Escaz%C3%BA');
            }
        ),
