...
class storytellingSanMiguelEscazuSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanMiguelEscazuSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanMiguelEscazuSanJose.withSampleData() {
    return new storytellingSanMiguelEscazuSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Miguel/Escazú se observa que el 88% '
                        'de las casas cuentan con radio o equipos de sonido, el'
                        ' 75% con línea de teléfono fija, 92% con teléfono '
                        'celular, 35% con pantalla de televisor, de este 35% el '
                        '91% de los televisores son convencionales y el 69% son'
                        ' con cable o satélite, el 47% tienen una computadora '
                        'de escritorio, 44% con una computadora portátil y el '
                        '56% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'Miguel/Escazú, el uso de las tecnologías es bastante '
                        'grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Miguel/Escazú'),
              ),
              body: ListView(
                children: [
                  Image.asset(
