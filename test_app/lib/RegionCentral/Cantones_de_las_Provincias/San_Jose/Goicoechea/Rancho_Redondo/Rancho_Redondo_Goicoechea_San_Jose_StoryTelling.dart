...
class storytellingRanchoRedondoGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingRanchoRedondoGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingRanchoRedondoGoicoecheaSanJose.withSampleData() {
    return new storytellingRanchoRedondoGoicoecheaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Goicoechea, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Rancho Redondo se observa que el 86% de'
                        ' las casas cuentan con radio o equipos de sonido, el'
                        ' 65% con línea de teléfono fija, 88% con teléfono '
                        'celular, 15% con pantalla de televisor, de este 15% el'
                        ' 95% de los televisores son convencionales y el 25% '
                        'son con cable o satélite, el 30% tienen una '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'que los celulares son los que más utiliza la población,'
                        ' no se recomienda enfocarse solo a esta tecnología ya '
                        'que los índices de uso de las demás tecnologías son '
                        'muy altos, lo que indica que en el distrito de Rancho '
                        'Redondo el uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisor y computadora '
                        'portátil ya que se encuentran menor del 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Rancho Redondo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/GoicoecheaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 25, Color(0xff00B7C2)),
