...
class storytellingMatadePlatanoGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMatadePlatanoGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMatadePlatanoGoicoecheaSanJose.withSampleData() {
    return new storytellingMatadePlatanoGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mata de Plátano se observa que el 88% de'
                        ' las casas cuentan con radio o equipos de sonido, el '
                        '76% con línea de teléfono fija, 94% con teléfono '
                        'celular, 31% con pantalla de televisor, de este 31% el'
                        ' 92% de los televisores son convencionales y el 73% '
                        'son con cable o satélite, el 51% tienen una '
                        'computadora de escritorio, 42% con una computadora '
                        'portátil y el 57% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Mata de Plátano, el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Mata de Plátano'),
              ),
              body: ListView(
                children: [
                  Image.asset(
