...
class storytellingCalleBlancosGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCalleBlancosGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCalleBlancosGoicoecheaSanJose.withSampleData() {
    return new storytellingCalleBlancosGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Calle Blancos se observa que el 87% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '68% con línea de teléfono fija, 93% con teléfono '
                        'celular, 29% con pantalla de televisor, de este 29% '
                        'el 93% de los televisores son convencionales y el '
                        '69% son con cable o satélite, el 47% tienen una '
                        'computadora de escritorio, 40% con una computadora'
                        ' portátil y el 54% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Calle Blancos, el uso de las tecnologías '
                        'es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Calle Blancos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 40, Color(0xffEEBB40)),
