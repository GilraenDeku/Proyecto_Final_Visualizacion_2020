...
class storytellingGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGoicoecheaSanJose.withSampleData() {
    return new storytellingGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Goicoechea es un cantón de Costa Rica situado en el '
                        'norte de la provincia de San José, sobre la meseta '
                        'intervolcánica del Valle Central, y perteneciente en '
                        'su totalidad a la Gran Área Metropolitana. Fundado '
                        'en 1891, el cantón se caracteriza en la actualidad '
                        'por ser uno de los más importantes de la Gran Área '
                        'Metropolitana de Costa Rica, y cuya economía se '
                        'centra en el sector de servicios, ya que cerca del '
                        '82% de la población activa del cantón labora en esta '
                        'área.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Guadalupe, San Francisco, Calle Blancos, '
                        'Mata de Plátano, Ipís, Rancho Redondo y Purral.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Goicoechea se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 68% '
                        'con línea de teléfono fija, 92% con teléfono celular,'
                        ' 25% con pantalla de televisor, de este 25% el 94% de'
                        ' los televisores son convencionales y el 61% son con '
                        'cable o satélite, el 45% tienen una computadora de '
                        'escritorio, 33% con una computadora portátil y el 48%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'los cuales van en un aumento considerable. A pesar de'
                        ' que los celulares son los que más utiliza la '
                        ...
                        'cantón de Goicoechea, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Goicoechea'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/GoicoecheaCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 25, Color(0xff799351)),
      new LinearSales(4, 94, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 61, Color(0xff00B7C2)),
      new LinearSales(6, 45, Color(0xff8675A9)),
      new LinearSales(7, 33, Color(0xffEEBB40)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Goicoechea');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.munigoicoechea.com/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwjWhJGh8pnrAhUpwlkKHeF'
                  '5CFAQFjANegQICBAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2'
                  'Fdocs%2F545cd98f968f1_8.pdf&usg=AOvVaw0YeVKOXd2MH6pXidMypBK1');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjWhJGh8pnrA'
                      'hUpwlkKHeF5CFAQFjANegQICBAB&url=https%3A%2F%2Fwww.ha'
                      'cienda.go.cr%2Fdocs%2F545cd98f968f1_8.pdf&usg=AOvVaw'
                      '0YeVKOXd2MH6pXidMypBK1');
                }
            ),
          ),
        ),
