...
class storytellingIpisGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingIpisGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingIpisGoicoecheaSanJose.withSampleData() {
    return new storytellingIpisGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Ipís se observa que el 88% de las casas'
                        ' cuentan con radio o equipos de sonido, el 70% con '
                        'línea de teléfono fija, 92% con teléfono celular, 23%'
                        ' con pantalla de televisor, de este 23% el 95% de los '
                        'televisores son convencionales y el 65% son con cable'
                        ' o satélite, el 47% tienen una computadora de '
                        'escritorio, 30% con una computadora portátil y el 47% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Ipís, '
