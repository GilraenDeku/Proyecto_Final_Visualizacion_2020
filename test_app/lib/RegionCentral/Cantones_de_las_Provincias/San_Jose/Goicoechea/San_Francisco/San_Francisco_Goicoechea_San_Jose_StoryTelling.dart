...
class storytellingSanFranciscoGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanFranciscoGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanFranciscoGoicoecheaSanJose.withSampleData() {
    return new storytellingSanFranciscoGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Francisco se observa que el 90% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '62% con línea de teléfono fija, 86% con teléfono '
                        'celular, 21% con pantalla de televisor, de este 21% el'
                        ' 92% de los televisores son convencionales y el 56% '
                        'son con cable o satélite, el 40% tienen una '
                        'computadora de escritorio, 27% con una computadora '
                        'portátil y el 42% de las casas cuentan con acceso de '
                        'internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San '
                        'Francisco, el uso de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Francisco'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 42, Color(0xff900C3F)),
    ];
