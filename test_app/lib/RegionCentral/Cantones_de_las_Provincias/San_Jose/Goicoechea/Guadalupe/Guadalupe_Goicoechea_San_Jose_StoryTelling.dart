...
class storytellingGuadalupeGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGuadalupeGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGuadalupeGoicoecheaSanJose.withSampleData() {
    return new storytellingGuadalupeGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Guadalupe se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 74% '
                        'con línea de teléfono fija, 91% con teléfono celular, '
                        '30% con pantalla de televisor, de este 30% el 93% de '
                        'los televisores son convencionales y el 70% son con '
                        'cable o satélite, el 48% tienen una computadora de '
                        'escritorio, 42% con una computadora portátil y el 56%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'Guadalupe, el uso de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Guadalupe'),
              ),
              body: ListView(
                children: [
                  Image.asset(
