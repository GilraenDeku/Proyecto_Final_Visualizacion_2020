...
class storytellingPurralGoicoecheaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPurralGoicoecheaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPurralGoicoecheaSanJose.withSampleData() {
    return new storytellingPurralGoicoecheaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Purral se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 56% '
                        'con línea de teléfono fija, 93% con teléfono celular,'
                        ' 17% con pantalla de televisor, de este 17% el 95% de'
                        ' los televisores son convencionales y el 38% son con '
                        'cable o satélite, el 37% tienen una computadora de '
                        'escritorio, 19% con una computadora portátil y el 33%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Purral'
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 38, Color(0xff00B7C2)),
      new LinearSales(6, 37, Color(0xff8675A9)),
      new LinearSales(7, 19, Color(0xffEEBB40)),
