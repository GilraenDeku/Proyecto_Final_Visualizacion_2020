...
class storytellingGuayaboMoraSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGuayaboMoraSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGuayaboMoraSanJose.withSampleData() {
    return new storytellingGuayaboMoraSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Guayabo se observa que el 73% de las '
                        'casas cuentan con radio o equipos de sonido, el 60%'
                        ' con línea de teléfono fija, 84% con teléfono celular,'
                        ' 13% con pantalla de televisor, de este 13% el 89% de'
                        ' los televisores son convencionales y el 53% son con '
                        'cable o satélite, el 29% tienen una computadora de '
                        'escritorio, 17% con una computadora portátil y el 20%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Guayabo, el'
                        ' uso de las tecnologías es bastante grande, excepto en'
                        ' las pantallas de televisor y computadoras portátiles '
                        'ya que se encuentran menores de 20% de disponibilidad '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Guayabo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 20, Color(0xff900C3F)),
    ];
