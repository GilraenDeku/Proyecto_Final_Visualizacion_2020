...
class storytellingTabarciaMoraSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTabarciaMoraSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTabarciaMoraSanJose.withSampleData() {
    return new storytellingTabarciaMoraSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tarbacia se observa que el 70% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% '
                        'con línea de teléfono fija, 80% con teléfono celular,'
                        ' 7% con pantalla de televisor, de este 7% el 90% de '
                        'los televisores son convencionales y el 31% son con '
                        'cable o satélite, el 25% tienen una computadora de '
                        'escritorio, 14% con una computadora portátil y el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tabarcia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
