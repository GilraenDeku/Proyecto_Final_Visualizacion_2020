...
class storytellingMoraSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMoraSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMoraSanJose.withSampleData() {
    return new storytellingMoraSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Mora es un cantón situado en el oeste de la provincia de '
                        'San José, en Costa Rica, y perteneciente, '
                        'parcialmente, al Gran Área Metropolitana. Su '
                        'cabecera es Colón, con categoría de ciudad. El '
                        'cantón se caracteriza por ser considerado como el '
                        'más seguro del país, en 2011, ​ debido a su '
                        'formación rural y a su extremadamente bajo nivel de '
                        'delincuencia, el cual es prácticamente imperceptible.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Ciudad Colón, Guayabo, Tabarcia, Piedras Negras,'
                        ' Picagres,'
                    ' Jaris y Quitirrisí.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Mora se observa que el 76% de las casas'
                        ' cuentan con radio o equipos de sonido, el 70% con '
                        'línea de teléfono fija, 87% con teléfono celular, '
                        '22% con pantalla de televisor, de este 22% el 88% de'
                        ' los televisores son convencionales y el 59% son '
                        'con cable o satélite, el 35% tienen una computadora '
                        'de escritorio, 30% con una computadora portátil y el'
                        ' 39% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'cantón de Mora, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Mora'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/MoraCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 22, Color(0xff799351)),
      new LinearSales(4, 88, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 59, Color(0xff00B7C2)),
      new LinearSales(6, 35, Color(0xff8675A9)),
      new LinearSales(7, 30, Color(0xffEEBB40)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Mora');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwi-9sTO-JnrAhVP0FkKHRU2'
                  'AG4QFjAOegQIBhAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fd'
                  'ocs%2F58123b5857d8c_Mapa%2520del%2520Canton%2520Mora%2520%'
                  '252007%2520Distrito%252001%2520a%252007.pdf&usg=AOvVaw2TIh'
                  'dYE5qFUFUi4b1Z1oKo');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc'
                      '=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwi-9'
                      'sTO-JnrAhVP0FkKHRU2AG4QFjAOegQIBhAB&url=https%3A%2'
                      'F%2Fwww.hacienda.go.cr%2Fdocs%2F58123b5857d8c_Mapa%25'
                      '20del%2520Canton%2520Mora%2520%252007%2520Distrito%252'
                      '001%2520a%252007.pdf&usg=AOvVaw2TIhdYE5qFUFUi4b1Z1oKo');
                }
            ),
          ),
        ),
