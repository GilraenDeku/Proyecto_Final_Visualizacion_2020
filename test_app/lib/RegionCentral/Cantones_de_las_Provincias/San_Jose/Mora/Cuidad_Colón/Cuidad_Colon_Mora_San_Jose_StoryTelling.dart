...
class storytellingCuidadColonMoraSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCuidadColonMoraSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCuidadColonMoraSanJose.withSampleData() {
    return new storytellingCuidadColonMoraSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cuidad Colón se observa que el 78% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '75% con línea de teléfono fija, 91% con teléfono '
                        'celular, 30% con pantalla de televisor, de este 30% '
                        'el 87% de los televisores son convencionales y el 72%'
                        ' son con cable o satélite, el 42% tienen una '
                        'computadora de escritorio, 39% con una computadora '
                        'portátil y el 52% de las casas cuentan con acceso de '
                        'internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Cuidad Colón, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cuidad Colón'),
              ),
              body: ListView(
                children: [
                  Image.asset(
