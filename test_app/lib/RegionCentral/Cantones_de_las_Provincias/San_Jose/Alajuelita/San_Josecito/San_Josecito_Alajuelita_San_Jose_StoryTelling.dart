...
class storytellingSanJosecitoAlajuelitaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJosecitoAlajuelitaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJosecitoAlajuelitaSanJose.withSampleData() {
    return new storytellingSanJosecitoAlajuelitaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Josecito, se observa que el 86% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '63% con línea de teléfono fija, 91% con teléfono '
                        'celular, 21% con pantalla de televisor, de este 21% '
                        'el 94% de los televisores son convencionales y el '
                        '48% son con cable o satélite, el 41% tienen una '
                        'computadora de escritorio, 25% con una computadora '
                        'portátil y el 33% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que'
                        ...
                        'los que más utiliza la población, no se '
                        'recomienda enfocarse solo a esta tecnología ya que'
                        ' los índices de uso de las demás tecnologías son '
                        'muy altos, lo que indica que en el distrito de '
                        'San Josecito el uso de las tecnologías es bastante'
                        ' grande. ',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Josecito'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 25, Color(0xffEEBB40)),
