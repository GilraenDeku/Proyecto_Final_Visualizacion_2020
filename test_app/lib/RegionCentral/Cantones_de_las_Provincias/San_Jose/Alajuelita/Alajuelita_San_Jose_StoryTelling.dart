          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Alajuelita, se observa que el 83% de '
                        'las casas cuentan con radio o equipos de sonido, '
                        'el 58% con línea de teléfono fija, 91% con teléfono '
                        'celular, 19% con pantalla de televisor, de este '
                        '19% el 95% de los televisores son convencionales '
                        'y el 52% son con cable o satélite, el 35% tienen '
                        'una computadora de escritorio, 21% con una '
                        'computadora portátil y el 30% de las casas cuentan '
                ...
                SizedBox(height: 20),
                Text(
                    'En conclusión, se puede observar que la '
                        'tecnología que más utiliza la población son los '
                        'teléfonos celulares los cuales van en un aumento '
                        ...
                        'lo que indica que en el cantón de Alajuelita el '
