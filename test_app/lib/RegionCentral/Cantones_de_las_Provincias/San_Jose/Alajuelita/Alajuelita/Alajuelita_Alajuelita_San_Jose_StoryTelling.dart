...
class storytellingAlajuelitaAlajuelitaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlajuelitaAlajuelitaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlajuelitaAlajuelitaSanJose.withSampleData() {
    return new storytellingAlajuelitaAlajuelitaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Alajuelita, Provincia de San José, Región Central',
                      style: TextStyle(
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'considerable. A pesar de que los celulares son los '
                        'que más utiliza la población, no se recomienda '
                        'enfocarse solo a esta tecnología ya que los índices'
                        ' de uso de las demás tecnologías son muy altos, '
                        'lo que indica que en el distrito de Alajuelita el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Alajuelita'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/AlajuelitaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 28, Color(0xffEEBB40)),
