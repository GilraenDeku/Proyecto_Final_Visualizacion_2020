...
class storytellingSanAntonioAlajuelitaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAntonioAlajuelitaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAntonioAlajuelitaSanJose.withSampleData() {
    return new storytellingSanAntonioAlajuelitaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Antonio, se observa que el 84% de '
                        'las casas cuentan con radio o equipos de sonido, el'
                        ' 59% con línea de teléfono fija, 88% con teléfono '
                        'celular, 16% con pantalla de televisor, de este 16% '
                        'el 93% de los televisores son convencionales y el 32% '
                        'son con cable o satélite, el 29% tienen una '
                        'computadora de escritorio, 16% con una computadora '
                        'portátil y el 23% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'que indica que en el distrito de San Antonio el '
                        'uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisor y en las '
                        'computadoras portátiles ya que ambas se '
                        'encuentran menores del 20% de disponibilidad de'
