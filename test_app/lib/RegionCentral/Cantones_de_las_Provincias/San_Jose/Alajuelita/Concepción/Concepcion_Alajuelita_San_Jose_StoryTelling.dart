...
class storytellingConcepcionAlajuelitaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingConcepcionAlajuelitaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingConcepcionAlajuelitaSanJose.withSampleData() {
    return new storytellingConcepcionAlajuelitaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Concepción, se observa que el 82% de'
                        ' las casas cuentan con radio o equipos de sonido, '
                        'el 54% con línea de teléfono fija, 91% con '
                        'teléfono celular, 16% con pantalla de televisor, '
                        'de este 16% el 95% de los televisores son '
                        'convencionales y el 57% son con cable o satélite, '
                        'el 35% tienen una computadora de escritorio, 18% '
                        'con una computadora portátil y el 30% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Concepción el uso de las tecnologías es'
                        ' bastante grande, excepto en las pantallas de '
                        'televisor y en las computadoras portátiles ya que '
                        'ambas se encuentran menores del 20% de '
