...
class storytellingSanFelipeAlajuelitaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanFelipeAlajuelitaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanFelipeAlajuelitaSanJose.withSampleData() {
    return new storytellingSanFelipeAlajuelitaSanJose(
      _createSampleData(),
