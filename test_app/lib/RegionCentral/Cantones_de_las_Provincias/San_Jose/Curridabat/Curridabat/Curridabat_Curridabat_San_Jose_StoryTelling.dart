...
class storytellingCurridabatCurridabatSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCurridabatCurridabatSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCurridabatCurridabatSanJose.withSampleData() {
    return new storytellingCurridabatCurridabatSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Curridabat, se observa que el 88% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '76% con línea de teléfono fija, 94% con teléfono '
                        'celular, 42% con pantalla de televisor, de este 42% '
                        'el 90% de los televisores son convencionales y el '
                        '76% son con cable o satélite, el 54% tienen una '
                        'computadora de escritorio, 54% con una computadora '
                        'portátil y el 67% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Curridabat el uso de las tecnologías'
                        ' es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Curridabat'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 42, Color(0xff799351)),
      new LinearSales(4, 90, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 76, Color(0xff00B7C2)),
