...
class storytellingSanchezCurridabatSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanchezCurridabatSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanchezCurridabatSanJose.withSampleData() {
    return new storytellingSanchezCurridabatSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Curridabat, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sánchez, se observa que el 93% de las '
                        'casas cuentan con radio o equipos de sonido, el 94% '
                        'con línea de teléfono fija, 98% con teléfono celular,'
                        ' 73% con pantalla de televisor, de este 73% el 83% de '
                        'los televisores son convencionales y el 93% son con '
                        'cable o satélite, el 73% tienen una computadora de '
                        'escritorio, 82% con una computadora portátil y el 93%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' distrito de Sánchez el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Sánchez'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/CurridabatDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 93, Color(0xffD54062)),
      new LinearSales(1, 94, Color(0xffFFA36C)),
      new LinearSales(2, 98, Color(0xffEBDC87)),
      new LinearSales(3, 73, Color(0xff799351)),
      new LinearSales(4, 83, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 93, Color(0xff00B7C2)),
      new LinearSales(6, 73, Color(0xff8675A9)),
      new LinearSales(7, 82, Color(0xffEEBB40)),
      new LinearSales(8, 93, Color(0xff900C3F)),
    ];
