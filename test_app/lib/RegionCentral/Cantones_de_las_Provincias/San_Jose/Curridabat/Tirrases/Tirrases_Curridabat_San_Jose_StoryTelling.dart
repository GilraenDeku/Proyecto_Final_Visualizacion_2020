...
class storytellingTirrasesCurridabatSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTirrasesCurridabatSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTirrasesCurridabatSanJose.withSampleData() {
    return new storytellingTirrasesCurridabatSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tirrases, se observa que el 81% de '
                        'las casas cuentan con radio o equipos de sonido, '
                        'el 47% con línea de teléfono fija, 91% con teléfono'
                        ' celular, 19% con pantalla de televisor, de este 19%'
                        ' el 92% de los televisores son convencionales y el '
                        '54% son con cable o satélite, el 30% tienen una '
                        'computadora de escritorio, 21% con una computadora '
                        'portátil y el 28% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' distrito de Tirrases el uso de las tecnologías es'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tirrases'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 47, Color(0xffFFA36C)),
      ...
      new LinearSales(8, 28, Color(0xff900C3F)),
    ];
