...
class storytellingCurridabatSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCurridabatSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCurridabatSanJose.withSampleData() {
    return new storytellingCurridabatSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Curridabat es el cantón número 18 de la provincia de San '
                        'José y perteneciente a la Gran Área Metropolitana. Su '
                        'cabecera es el distrito de Curridabat, con categoría '
                        'de ciudad. Cuenta con 77 028 habitantes, de acuerdo '
                        'con la última proyección demográfica del INEC.​ El '
                        'cantón se caracteriza por poseer un alto grado de '
                        'desarrollo urbano, económico y educativo.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Curridabat, Granadilla, Sánchez y Tirrases',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Curridabat, se observa que el 87% de las'
                        ' casas cuentan con radio o equipos de sonido, el 71%'
                        ' con línea de teléfono fija, 94% con teléfono celular,'
                        ' 38% con pantalla de televisor, de este 38% el 90% de'
                        ' los televisores son convencionales y el 72% son con '
                        'cable o satélite, el 50% tienen una computadora de '
                        'escritorio, 47% con una computadora portátil y el 59%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' cantón de Curridabat el uso de las tecnologías es'
                        ' bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Curridabat'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/CurridabatCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 71, Color(0xffFFA36C)),
      new LinearSales(2, 94, Color(0xffEBDC87)),
      new LinearSales(3, 38, Color(0xff799351)),
      new LinearSales(4, 90, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 72, Color(0xff00B7C2)),
      new LinearSales(6, 50, Color(0xff8675A9)),
      new LinearSales(7, 47, Color(0xffEEBB40)),
      new LinearSales(8, 59, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Curridabat');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.curridabat.go.cr/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source='
                  'web&cd=&cad=rja&uact=8&ved=2ahUKEwiv6szn6ZnrAhXIxVkKHaq_DU'
                  'kQFjAQegQIBBAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fdocs'
                  '%2F545cdad101dc9_10a.pdf&usg=AOvVaw1Slga-vrJP_MeJ98UQJrO4');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiv6szn6Znr'
                      'AhXIxVkKHaq_DUkQFjAQegQIBBAB&url=https%3A%2F%2Fwww.'
                      'hacienda.go.cr%2Fdocs%2F545cdad101dc9_10a.pdf&usg=A'
                      'OvVaw1Slga-vrJP_MeJ98UQJrO4');
                }
            ),
          ),
        ),
