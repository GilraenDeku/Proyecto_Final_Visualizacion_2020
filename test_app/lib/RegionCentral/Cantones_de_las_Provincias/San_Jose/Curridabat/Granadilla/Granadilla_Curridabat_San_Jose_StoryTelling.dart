...
class storytellingGranadillaCurridabatSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGranadillaCurridabatSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGranadillaCurridabatSanJose.withSampleData() {
    return new storytellingGranadillaCurridabatSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Granadilla, se observa que el 88% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '74% con línea de teléfono fija, 94% con teléfono '
                        'celular, 36% con pantalla de televisor, de este '
                        '36% el 91% de los televisores son convencionales y '
                        'el 71% son con cable o satélite, el 53% tienen una '
                        'computadora de escritorio, 46% con una computadora '
                        'portátil y el 61% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'indica que en el distrito de Granadilla el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Granadilla'),
              ),
              body: ListView(
                children: [
                  Image.asset(
