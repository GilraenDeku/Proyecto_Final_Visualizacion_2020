...
class storytellingCascajalVazquezdeCoronadoSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCascajalVazquezdeCoronadoSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCascajalVazquezdeCoronadoSanJose.withSampleData() {
    return new storytellingCascajalVazquezdeCoronadoSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cascajal se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 15% '
                        ...
                        ' 21% con una computadora portátil y el 31% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Cascajal, el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cascajal'),
              ),
              body: ListView(
                children: [
                  Image.asset(
