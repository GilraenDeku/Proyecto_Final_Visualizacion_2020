...
class storytellingVazquezdeCoronadoSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingVazquezdeCoronadoSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingVazquezdeCoronadoSanJose.withSampleData() {
    return new storytellingVazquezdeCoronadoSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Vázquez de Coronado es un cantón de Costa Rica y '
                        'perteneciente en casi su totalidad a la Gran Área '
                        'Metropolitana. Su cabecera es el distrito de San '
                        'Isidro, con categoría de ciudad, el cantón se destaca'
                        ' por sus principales actividades económicas: la '
                        'ganadería, la producción de leche y la agricultura, '
                        'colocando al cantón como un punto económico '
                        'importante de la Gran Área Metropolitana y del país, '
                        'dando lugar a diversas haciendas, fincas '
                        'ganaderas y áreas de cultivo.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Isidro, San Rafael, Dulce Nombre de Jesús, '
                        'Patalillo y Cascajal.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Vázquez de Coronado se observa que el 87% '
                        'de las casas cuentan con radio o equipos de sonido, el'
                        ' 74% con línea de teléfono fija, 93% con teléfono '
                        'celular, 28% con pantalla de televisor, de este 28% el '
                        '94% de los televisores son convencionales y el 67% son '
                        'con cable o satélite, el 50% tienen una computadora de '
                        'escritorio, 37% con una computadora portátil y el 52% de'
                        ' las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el cantón de Vázquez de '
                        'Coronado, el uso de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Vázquez de Coronado'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/VasquezdeCoronadoCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_V%C3%A1zquez_de_Coronado');
            }
        ),
