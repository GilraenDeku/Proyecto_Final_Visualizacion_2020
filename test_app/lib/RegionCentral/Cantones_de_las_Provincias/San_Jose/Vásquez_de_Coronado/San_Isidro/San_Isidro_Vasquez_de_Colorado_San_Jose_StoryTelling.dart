...
class storytellingSanIsidroVazquezdeCoronadoSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroVazquezdeCoronadoSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroVazquezdeCoronadoSanJose.withSampleData() {
    return new storytellingSanIsidroVazquezdeCoronadoSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Isidro se observa que el 89% de las'
                        ' casas cuentan con radio o equipos de sonido, el 80% '
                        'con línea de teléfono fija, 94% con teléfono celular, '
                        '34% con pantalla de televisor, de este 34% el 93% de los'
                        ' televisores son convencionales y el 73% son con cable '
                        'o satélite, el 53% tienen una computadora de escritorio,'
                        ' 44% con una computadora portátil y el 60% de las casas'
