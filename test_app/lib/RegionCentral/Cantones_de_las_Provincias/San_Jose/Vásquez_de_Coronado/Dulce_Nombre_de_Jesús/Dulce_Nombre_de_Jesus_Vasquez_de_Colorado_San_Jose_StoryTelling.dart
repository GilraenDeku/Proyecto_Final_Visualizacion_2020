...
class storytellingDulceNombredeJesusVazquezdeCoronadoSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDulceNombredeJesusVazquezdeCoronadoSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDulceNombredeJesusVazquezdeCoronadoSanJose.withSampleData() {
    return new storytellingDulceNombredeJesusVazquezdeCoronadoSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Distrito de Dulce Nombre de Jesús',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Dulce Nombre de Jesús se observa que el '
                        '86% de las casas cuentan con radio o equipos de sonido,'
                        ' el 70% con línea de teléfono fija, 93% con teléfono '
                        'celular, 23% con pantalla de televisor, de este 23% el'
                        ' 95% de los televisores son convencionales y el 62% son'
                        ' con cable o satélite, el 48% tienen una computadora de'
                        ' escritorio, 29% con una computadora portátil y el 45% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        ' de Jesús, el uso de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Dulce Nombre de Jesús'),
              ),
              body: ListView(
                children: [
                  Image.asset(
