...
class storytellingSanRafaelVazquezdeCoronadoSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelVazquezdeCoronadoSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelVazquezdeCoronadoSanJose.withSampleData() {
    return new storytellingSanRafaelVazquezdeCoronadoSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 73% con'
                        ' línea de teléfono fija, 89% con teléfono celular, 22% '
                        'con pantalla de televisor, de este 22% el 92% de los '
                        'televisores son convencionales y el 64% son con cable o'
                        ' satélite, el 44% tienen una computadora de escritorio,'
                        ' 29% con una computadora portátil y el 41% de las casas'
