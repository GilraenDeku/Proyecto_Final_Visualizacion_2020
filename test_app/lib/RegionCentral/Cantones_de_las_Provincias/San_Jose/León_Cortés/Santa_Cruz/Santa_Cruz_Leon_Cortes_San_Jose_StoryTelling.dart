...
class storytellingSantaCruzLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaCruzLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaCruzLeonCortesSanJose.withSampleData() {
    return new storytellingSantaCruzLeonCortesSanJose(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'teléfono celular la tecnología de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Cruz'),
              ),
              body: ListView(
                children: [
                  Image.asset(
