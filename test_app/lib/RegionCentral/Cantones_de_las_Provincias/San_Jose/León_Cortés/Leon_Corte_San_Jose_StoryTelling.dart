...
class storytellingLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLeonCortesSanJose.withSampleData() {
    return new storytellingLeonCortesSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'León Cortés Castro es el cantón número 20 de la Provincia'
                        ' de San José, Costa Rica. Su cabecera es la ciudad de'
                        ' San Pablo de León Cortés. Está localizado hacia el '
                        'sureste de San José, en la denominada Zona de Los '
                        'Santos. Localizado en una de las áreas cafetaleras '
                        'por excelencia del país, León Cortés es uno de los '
                        'cantones con mayor producción agrícola de café de '
                        'Costa Rica para la exportación y consumo nacional. '
                        'Existe, además, presencia de actividades industriales'
                        ' relacionadas a este cultivo.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Pablo, San Andrés, Llano Bonito, '
                        'San Isidro, Santa Cruz y San Antonio',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de León Cortés se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% '
                        'con línea de teléfono fija, 82% con teléfono celular,'
                        ' 9% con pantalla de televisor, de este 9% el 92% de '
                        'los televisores son convencionales y el 20% son con'
                        ' cable o satélite, el 27% tienen una computadora '
                        'de escritorio, 16% con una computadora portátil y '
                        'el 14% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de León '
                        'Cortés el uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisor y computadora '
                        'portátil e internet ya que se encuentran menor del 20%'
                        ' de disponibilidad de posesión en la población.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de León Cortés'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/LeonCortesCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 9, Color(0xff799351)),
      new LinearSales(4, 92, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 20, Color(0xff00B7C2)),
      new LinearSales(6, 27, Color(0xff8675A9)),
      new LinearSales(7, 16, Color(0xffEEBB40)),
      new LinearSales(8, 14, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Le%C3%B3n_Cort%C3%A9s_Castro');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwjAppLA9JnrAhXwwVkKHWZAD'
                  'FEQFjAPegQIBRAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fdoc'
                  's%2F545cdad17f7da_12a.pdf&usg=AOvVaw3HH9YpBxhAk2sRjzgHkE43');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjAppLA9JnrA'
                      'hXwwVkKHWZADFEQFjAPegQIBRAB&url=https%3A%2F%2Fwww.ha'
                      'cienda.go.cr%2Fdocs%2F545cdad17f7da_12a.pdf&usg=AOvVa'
                      'w3HH9YpBxhAk2sRjzgHkE43');
                }
            ),
          ),
        ),
