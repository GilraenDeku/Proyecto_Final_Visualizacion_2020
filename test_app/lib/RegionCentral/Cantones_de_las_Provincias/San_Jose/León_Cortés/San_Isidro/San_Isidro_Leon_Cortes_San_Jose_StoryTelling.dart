...
class storytellingSanIsidroLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroLeonCortesSanJose.withSampleData() {
    return new storytellingSanIsidroLeonCortesSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Isidro se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% '
                        'con línea de teléfono fija, 79% con teléfono celular, '
                        '7% con pantalla de televisor, de este 7% el 92% de los'
                        ' televisores son convencionales y el 8% son con cable'
                        ' o satélite, el 25% tienen una computadora de '
                        'escritorio, 12% con una computadora portátil y el 10%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'sonido. En el distrito de San Isidro el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Isidro'),
              ),
              body: ListView(
                children: [
                  Image.asset(
