...
class storytellingSanPabloLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPabloLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPabloLeonCortesSanJose.withSampleData() {
    return new storytellingSanPabloLeonCortesSanJose(
      _createSampleData(),
