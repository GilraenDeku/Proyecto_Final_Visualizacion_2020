...
class storytellingSanAntonioLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAntonioLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAntonioLeonCortesSanJose.withSampleData() {
    return new storytellingSanAntonioLeonCortesSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Antonio se observa que el 83% de las'
                        ' casas cuentan con radio o equipos de sonido, el 67% '
                        'con línea de teléfono fija, 82% con teléfono celular,'
                        ' 11% con pantalla de televisor, de este 11% el 91% de'
                        ' los televisores son convencionales y el 10% son con '
                        'cable o satélite, el 32% tienen una computadora de '
                        'escritorio, 12% con una computadora portátil y el '
                        '10% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 10, Color(0xff00B7C2)),
