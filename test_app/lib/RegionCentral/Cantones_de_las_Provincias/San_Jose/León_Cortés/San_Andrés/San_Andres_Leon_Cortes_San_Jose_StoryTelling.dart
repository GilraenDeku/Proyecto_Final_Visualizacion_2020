...
class storytellingSanAndresLeonCortesSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAndresLeonCortesSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAndresLeonCortesSanJose.withSampleData() {
    return new storytellingSanAndresLeonCortesSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Andrés se observa que el 80% de las'
                        ' casas cuentan con radio o equipos de sonido, el 51% '
                        'con línea de teléfono fija, 85% con teléfono celular,'
                        ' 6% con pantalla de televisor, de este 6% el 96% de '
                        'los televisores son convencionales y el 4% son con '
                        'cable o satélite, el 22% tienen una computadora de '
                        'escritorio, 9% con una computadora portátil y el 7% de'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Andrés'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 96, Color(0xff0F4C75)), //ff6538
