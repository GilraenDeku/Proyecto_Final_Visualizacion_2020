...
class storytellingAserriAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAserriAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAserriAserriSanJose.withSampleData() {
    return new storytellingAserriAserriSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Aserrí, se observa que el 86% de las'
                        ' casas cuentan con radio o equipos de sonido, el '
                        '65% con línea de teléfono fija, 91% con teléfono '
                        'celular, 21% con pantalla de televisor, de este '
                        '21% el 94% de los televisores son convencionales y'
                        ' el 57% son con cable o satélite, el 39% tienen '
                        'una computadora de escritorio, 26% con una '
                        'computadora portátil y el 37% de las casas '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'celulares los cuales van en un aumento '
                        'considerable. A pesar de que los celulares son '
                        'los que más utiliza la población, no se recomienda'
                        ' enfocarse solo a esta tecnología ya que los '
                        'índices de uso de las demás tecnologías son muy '
                        'altos, lo que indica que en el distrito de Aserrí '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(6, 39, Color(0xff8675A9)),
      new LinearSales(7, 26, Color(0xffEEBB40)),
      new LinearSales(8, 37, Color(0xff900C3F)),
    ];
