...
class storytellingTarbacaAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTarbacaAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTarbacaAserriSanJose.withSampleData() {
    return new storytellingTarbacaAserriSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tarbaca, se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% '
                        'con línea de teléfono fija, 84% con teléfono celular,'
                        ' 15% con pantalla de televisor, de este 15% el 94% '
                        'de los televisores son convencionales y el 18% son '
                        'con cable o satélite, el 32% tienen una computadora'
                        ' de escritorio, 13% con una computadora portátil y '
                        'el 23% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        ' tecnologías son muy altos, lo que indica que en '
                        'el distrito de Tarbaca el uso de las tecnologías es'
                        ' bastante grande, excepto en las pantallas de '
                        'televisor, computadoras portátiles ya que se '
                        'encuentra menor del 20% de disponibilidad de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tarbaca'),
              ),
              body: ListView(
                children: [
                  Image.asset(
