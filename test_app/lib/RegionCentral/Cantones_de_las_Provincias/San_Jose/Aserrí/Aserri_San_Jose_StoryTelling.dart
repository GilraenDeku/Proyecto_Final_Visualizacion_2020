...
class storytellingAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAserriSanJose.withSampleData() {
    return new storytellingAserriSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Aserrí es un cantón situado en el área central de la '
                        'provincia de San José, en Costa Rica, y '
                        'perteneciente, parcialmente, al Gran Área'
                        ' Metropolitana. Su cabecera es el Distrito '
                        'de Aserrí, con categoría de ciudad. El cantón '
                        'cuenta con 61 338 habitantes, de acuerdo con la '
                        'última proyección demográfica del INEC. El cantón '
                        'se caracteriza por sus famosas tamaleras y también '
                        'se caracteriza por la producción de mascaradas.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Aserrí, Tarbaca, Vuelta de Jorco, '
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Alajuelita, se observa que el 86% de'
                        ' las casas cuentan con radio o equipos de sonido, '
                        'el 67% con línea de teléfono fija, 91% con teléfono '
                        'celular, 27% con pantalla de televisor, de este '
                        '27% el 94% de los televisores son convencionales y '
                        'el 61% son con cable o satélite, el 41% tienen una '
                        'computadora de escritorio, 28% con una computadora '
                        'portátil y el 42% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que'
                        ...
                        ' distrito de Aserrí el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de '
                        'televisor ya que se encuentra menor del 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Aserrí'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/AserriCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 45, Color(0xff00B7C2)),
      new LinearSales(6, 34, Color(0xff8675A9)),
      new LinearSales(7, 20, Color(0xffEEBB40)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Aserr%C3%AD');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwie676H55nrAhWCjlkK'
                  'Hf_VA04QFjAVegQIBhAB&url=https%3A%2F%2Fwww.hacienda'
                  '.go.cr%2Fdocs%2F58123b97f1009_Mapa%2520del%2520Canto'
                  'n%2520Aserri%252006%2520Distrito%252001%2520a%252007'
                  '.pdf&usg=AOvVaw12L92TPN3V3NFxtncDrE3M');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc='
                      's&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwie676H'
                      '55nrAhWCjlkKHf_VA04QFjAVegQIBhAB&url=https%3A%2F%'
                      '2Fwww.hacienda.go.cr%2Fdocs%2F58123b97f1009_Mapa%25'
                      '20del%2520Canton%2520Aserri%252006%2520Distrito%252'
                      '001%2520a%252007.pdf&usg=AOvVaw12L92TPN3V3NFxtncDrE3M');
                }
            ),
          ),
        ),
