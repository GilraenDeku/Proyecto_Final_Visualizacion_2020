...
class storytellingVueltadeJorcoAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingVueltadeJorcoAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingVueltadeJorcoAserriSanJose.withSampleData() {
    return new storytellingVueltadeJorcoAserriSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Vuelta de Jorco, se observa que el 80%'
                        ' de las casas cuentan con radio o equipos de sonido,'
                        ' el 68% con línea de teléfono fija, 81% con teléfono'
                        ' celular, 12% con pantalla de televisor, de este 12%'
                        ' el 94% de los televisores son convencionales y el '
                        '33% son con cable o satélite, el 30% tienen una '
                        'computadora de escritorio, 15% con una computadora '
                        'portátil y el 17% de las casas cuentan con acceso '
                        'de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Vuelta de Jorco el uso de las tecnologías'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Vuelta de Jorco'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 81, Color(0xffEBDC87)),
      new LinearSales(3, 12, Color(0xff799351)),
      new LinearSales(4, 94, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 33, Color(0xff00B7C2)),
      new LinearSales(6, 30, Color(0xff8675A9)),
      new LinearSales(7, 15, Color(0xffEEBB40)),
      new LinearSales(8, 17, Color(0xff900C3F)),
    ];
