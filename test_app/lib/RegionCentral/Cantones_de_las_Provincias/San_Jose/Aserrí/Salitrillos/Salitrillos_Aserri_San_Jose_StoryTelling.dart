...
class storytellingSalitrillosAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSalitrillosAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSalitrillosAserriSanJose.withSampleData() {
    return new storytellingSalitrillosAserriSanJose(
      _createSampleData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Salitrillos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
