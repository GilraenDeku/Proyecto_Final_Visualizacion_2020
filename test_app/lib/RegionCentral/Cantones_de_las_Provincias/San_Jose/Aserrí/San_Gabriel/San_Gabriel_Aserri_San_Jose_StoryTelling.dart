...
class storytellingSanGabrielAserriSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanGabrielAserriSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanGabrielAserriSanJose.withSampleData() {
    return new storytellingSanGabrielAserriSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Gabriel, se observa que el 81% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '63% con línea de teléfono fija, 82% con teléfono '
                        'celular, 11% con pantalla de televisor, de este 11%'
                        ' el 94% de los televisores son convencionales y el'
                        ' 16% son con cable o satélite, el 29% tienen una '
                        'computadora de escritorio, 14% con una computadora'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Gabriel el uso de las tecnologías '
                        'es bastante grande, excepto en las pantallas de '
                        'televisor, computadoras portátiles y el internet ya'
                        ' que se encuentra menor del 20% de disponibilidad '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Gabriel'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 11, Color(0xff799351)),
