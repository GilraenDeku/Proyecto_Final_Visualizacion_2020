...
class storytellingSabanillaMontesdeOcaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSabanillaMontesdeOcaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSabanillaMontesdeOcaSanJose.withSampleData() {
    return new storytellingSabanillaMontesdeOcaSanJose(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Montes de Oca, Provincia de San José, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sabanilla se observa que el 89% de las '
                        'casas cuentan con radio o equipos de sonido, el 82% '
                        'con línea de teléfono fija, 94% con teléfono celular,'
                        ' 40% con pantalla de televisor, de este 40% el 90% de'
                        ' los televisores son convencionales y el 78% son con'
                        ' cable o satélite, el 58% tienen una computadora de '
                        'escritorio, 60% con una computadora portátil y el '
                        '74% de las casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Sabanilla, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Sabanilla'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/MontesdeOcaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
