...
class storytellingMercedesMontesdeOcaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMercedesMontesdeOcaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMercedesMontesdeOcaSanJose.withSampleData() {
    return new storytellingMercedesMontesdeOcaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mercedes se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% '
                        'con línea de teléfono fija, 94% con teléfono celular,'
                        ' 34% con pantalla de televisor, de este 34% el 85% de'
                        ' los televisores son convencionales y el 69% son con '
                        'cable o satélite, el 50% tienen una computadora de '
                        'escritorio, 66% con una computadora portátil y el 75% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Mercedes, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Mercedes'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 69, Color(0xff00B7C2)),
      new LinearSales(6, 50, Color(0xff8675A9)),
      new LinearSales(7, 66, Color(0xffEEBB40)),
      new LinearSales(8, 75, Color(0xff900C3F)),
    ];
