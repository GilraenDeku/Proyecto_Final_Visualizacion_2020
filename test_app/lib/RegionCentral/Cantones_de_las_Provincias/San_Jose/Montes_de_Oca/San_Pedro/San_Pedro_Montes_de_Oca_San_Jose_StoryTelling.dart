...
class storytellingSanPedroMontesdeOcaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPedroMontesdeOcaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPedroMontesdeOcaSanJose.withSampleData() {
    return new storytellingSanPedroMontesdeOcaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Pedro se observa que el 84% de las '
                        ...
                        'escritorio, 59% con una computadora portátil y el 72%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Pedro, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 59, Color(0xffEEBB40)),
      new LinearSales(8, 72, Color(0xff900C3F)),
    ];
