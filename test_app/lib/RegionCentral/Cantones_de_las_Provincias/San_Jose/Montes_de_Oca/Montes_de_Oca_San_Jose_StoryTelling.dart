...
class storytellingMontesdeOcaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMontesdeOcaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMontesdeOcaSanJose.withSampleData() {
    return new storytellingMontesdeOcaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Montes de Oca es el cantón número 15 de la provincia de '
                        'San José, perteneciente al Gran Área Metropolitana. '
                        'Su cabecera es el distrito de San Pedro, con '
                        'categoría de ciudad. El cantón se caracteriza por '
                        'su desarrollo comercial, centros de estudio (en '
                        'especial las universidades), y por su vida nocturna '
                        'en áreas como la reconocida Calle de la Amargura, y '
                        'es conocido por sus actividades en el sector '
                        'servicios. Es uno de los cantones más urbanizados y '
                        'activos, tanto de día como por la noche.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Pedro, Sabanilla, Mercedes y San Rafael.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Montes de Oca se observa que el 85% de las'
                        ' casas cuentan con radio o equipos de sonido, el 74% '
                        'con línea de teléfono fija, 93% con teléfono celular, '
                        '37% con pantalla de televisor, de este 37% el 89% de '
                        'los televisores son convencionales y el 75% son con '
                        'cable o satélite, el 52% tienen una computadora de '
                        'escritorio, 57% con una computadora portátil y el 69% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Montes de Oca, el uso de las tecnologías '
                        'es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Montes de Oca'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/MontesdeOcaCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 85, Color(0xffD54062)),
      new LinearSales(1, 74, Color(0xffFFA36C)),
      new LinearSales(2, 93, Color(0xffEBDC87)),
      new LinearSales(3, 37, Color(0xff799351)),
      new LinearSales(4, 89, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 75, Color(0xff00B7C2)),
      new LinearSales(6, 52, Color(0xff8675A9)),
      new LinearSales(7, 57, Color(0xffEEBB40)),
      new LinearSales(8, 69, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Montes_de_Oca');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://montesdeoca.go.cr/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwjZ07jH9pnrAhWv2FkKHSyvD'
                  'ggQFjAQegQIARAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fdoc'
                  's%2F5536851c2a2da_115_Zonas%2520Homogeneas_Cantonal_Canto'
                  'n%252015.pdf&usg=AOvVaw0ZJmtioOIWuMfUm75M2Npq');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjZ07jH9pnr'
                      'AhWv2FkKHSyvDggQFjAQegQIARAB&url=https%3A%2F%2Fwww.'
                      'hacienda.go.cr%2Fdocs%2F5536851c2a2da_115_Zonas%2520'
                      'Homogeneas_Cantonal_Canton%252015.pdf&usg=AOvVaw0ZJm'
                      'tioOIWuMfUm75M2Npq');
                }
            ),
          ),
