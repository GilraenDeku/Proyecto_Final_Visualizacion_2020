...
class storytellingSanRafaelMontesdeOcaSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelMontesdeOcaSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelMontesdeOcaSanJose.withSampleData() {
    return new storytellingSanRafaelMontesdeOcaSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 70% '
                        'con línea de teléfono fija, 93% con teléfono celular,'
                        ' 31% con pantalla de televisor, de este 31% el 91% de'
                        ' los televisores son convencionales y el 67% son con '
                        'cable o satélite, el 46% tienen una computadora de '
                        'escritorio, 40% con una computadora portátil y el 52%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Rafael, el uso de las tecnologías es '
                        'bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Rafael'),
              ),
              body: ListView(
                children: [
                  Image.asset(
