...
class storytellingSanPabloTurrubaresSanJose extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPabloTurrubaresSanJose(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPabloTurrubaresSanJose.withSampleData() {
    return new storytellingSanPabloTurrubaresSanJose(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Pablo se observa que el 78% de las '
                        'casas cuentan con radio o equipos de sonido, el 55%'
                        ' con línea de teléfono fija, 87% con teléfono celular,'
                        ' 7% con pantalla de televisor, de este 7% el 94% de '
                        'los televisores son convencionales y el 22% son con '
                        'cable o satélite, el 22% tienen una computadora de '
                        'escritorio, 18% con una computadora portátil y el 19%'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Pablo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 22, Color(0xff00B7C2)),
      new LinearSales(6, 22, Color(0xff8675A9)),
      new LinearSales(7, 18, Color(0xffEEBB40)),
      new LinearSales(8, 19, Color(0xff900C3F)),
    ];
