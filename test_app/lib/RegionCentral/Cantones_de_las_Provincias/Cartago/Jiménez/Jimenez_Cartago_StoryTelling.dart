...
class storytellingJimenezCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingJimenezCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingJimenezCartago.withSampleData() {
    return new storytellingJimenezCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Jiménez es el cantón número 4 de la provincia de Cartago.'
                        ' El cantón es esencialmente montañoso y despoblado. '
                        'Su ciudad cabecera es Juan Viñas. Al igual que su '
                        'vecino cantón de Turrialba, se caracteriza por su '
                        'fuerte producción de caña de azúcar. En la época '
                        'precolombina el territorio que actualmente '
                        'corresponde al cantón de Jiménez estuvo habitado '
                        'por indígenas del llamado Reino Huetar de Oriente, '
                        'que eran dominios del cacique Guarco, quien murió '
                        'antes o principio de la conquista, asumiendo el '
                        'cacicazgo su hijo Correque.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Juan Viñas, Tucurrique y Pejibaye',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el Cantón de Jiménez se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 50% con'
                        ' línea de teléfono fija, 81% con teléfono celular, 10%'
                        ' con pantalla de televisor, de este 10% el 94% de los '
                        'televisores son convencionales y el 31% son con cable '
                        'o satélite, el 26% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 15% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de'
                        ...
                        'sonido y telefonía celular, fija y computadora de'
                        ' escritorio siendo el teléfono celular la '
                        'tecnología de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Jiménez'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/JimenezCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Jim%C3%A9nez');
            }
        ),
