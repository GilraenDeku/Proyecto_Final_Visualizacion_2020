...
class storytellingTucurriqueJimenezCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTucurriqueJimenezCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTucurriqueJimenezCartago.withSampleData() {
    return new storytellingTucurriqueJimenezCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tucurrique se observa que el 75% de las '
                        'casas cuentan con radio o equipos de sonido, el 45% con'
                        ' línea de teléfono fija, 76% con teléfono celular, 7%'
                        ' con pantalla de televisor, de este 7% el 92% de los '
                        'televisores son convencionales y el 21% son con cable '
                        'o satélite, el 23% tienen una computadora de escritorio,'
                        ' 9% con una computadora portátil y el 10% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tucurrique'),
              ),
              body: ListView(
                children: [
                  Image.asset(
