...
class storytellingPejibayeJimenezCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPejibayeJimenezCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPejibayeJimenezCartago.withSampleData() {
    return new storytellingPejibayeJimenezCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pejibaye se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 45% con'
                        ' línea de teléfono fija, 82% con teléfono celular, 8%'
                        ' con pantalla de televisor, de este 8% el 96% de los '
                        'televisores son convencionales y el 39% son con cable '
                        'o satélite, el 24% tienen una computadora de escritorio,'
                        ' 12% con una computadora portátil y el 8% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Pejibaye'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 8, Color(0xff900C3F)),
    ];
