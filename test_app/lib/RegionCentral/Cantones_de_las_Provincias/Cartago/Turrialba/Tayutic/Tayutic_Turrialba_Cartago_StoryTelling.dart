...
class storytellingTayuticTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTayuticTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTayuticTurrialbaCartago.withSampleData() {
    return new storytellingTayuticTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tayutic se observa que el 77% de las '
                        'casas cuentan con radio o equipos de sonido, el 55% con'
                        ' línea de teléfono fija, 70% con teléfono celular, 7%'
                        ' con pantalla de televisor, de este 7% el 89% de los '
                        'televisores son convencionales y el 5% son con cable '
                        'o satélite, el 17% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 10% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'portátil siendo el radio o equipo de sonido la tecnología '
                        'de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tayutic'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 70, Color(0xffEBDC87)),
