...
class storytellingTuisTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTuisTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTuisTurrialbaCartago.withSampleData() {
    return new storytellingTuisTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tuis se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% con'
                        ' línea de teléfono fija, 74% con teléfono celular, 8%'
                        ' con pantalla de televisor, de este 8% el 95% de los '
                        'televisores son convencionales y el 7% son con cable '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(2, 74, Color(0xffEBDC87)),
