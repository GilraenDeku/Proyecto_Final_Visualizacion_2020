...
class storytellingChirripoTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingChirripoTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingChirripoTurrialbaCartago.withSampleData() {
    return new storytellingChirripoTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Chirripó se observa que el 53% de las '
                        'casas cuentan con radio o equipos de sonido, el 10% con'
                        ' línea de teléfono fija, 25% con teléfono celular, 2%'
                        ' con pantalla de televisor, de este 2% el 27% de los '
                        'televisores son convencionales y el 2% son con cable '
                        'o satélite, el 4% tienen una computadora de escritorio,'
                        ' 4% con una computadora portátil y el 4% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Chirripó'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 53, Color(0xffD54062)),
      new LinearSales(1, 10, Color(0xffFFA36C)),
      new LinearSales(2, 25, Color(0xffEBDC87)),
      new LinearSales(3, 2, Color(0xff799351)),
      new LinearSales(4, 27, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 2, Color(0xff00B7C2)),
      new LinearSales(6, 4, Color(0xff8675A9)),
