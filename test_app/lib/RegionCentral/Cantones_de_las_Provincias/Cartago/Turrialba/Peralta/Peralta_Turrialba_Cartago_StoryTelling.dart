...
class storytellingPeraltaTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPeraltaTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPeraltaTurrialbaCartago.withSampleData() {
    return new storytellingPeraltaTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Peralta se observa que el 69% de las '
                        'casas cuentan con radio o equipos de sonido, el 41% con'
                        ' línea de teléfono fija, 77% con teléfono celular, 6%'
                        ' con pantalla de televisor, de este 6% el 93% de los '
                        'televisores son convencionales y el 3% son con cable '
                        'o satélite, el 9% tienen una computadora de escritorio,'
                        ' 3% con una computadora portátil y el 3% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Peralta'),
              ),
              body: ListView(
                children: [
                  Image.asset(
