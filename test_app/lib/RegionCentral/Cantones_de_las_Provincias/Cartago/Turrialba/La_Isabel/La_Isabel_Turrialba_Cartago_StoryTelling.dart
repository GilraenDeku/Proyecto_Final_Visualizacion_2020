...
class storytellingLaIsabelTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaIsabelTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaIsabelTurrialbaCartago.withSampleData() {
    return new storytellingLaIsabelTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Isabel se observa que el 83% de las '
                        'casas cuentan con radio o equipos de sonido, el 48% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 10%'
                        ' con pantalla de televisor, de este 10% el 95% de los '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Isabel'),
              ),
              body: ListView(
                children: [
                  Image.asset(
