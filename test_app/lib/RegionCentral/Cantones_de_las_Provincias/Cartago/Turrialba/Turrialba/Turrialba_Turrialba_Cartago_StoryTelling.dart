...
class storytellingTurrialbaTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTurrialbaTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTurrialbaTurrialbaCartago.withSampleData() {
    return new storytellingTurrialbaTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Turrialba se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 22%'
                        ' con pantalla de televisor, de este 22% el 92% de los '
                        'televisores son convencionales y el 51% son con cable '
                        'o satélite, el 36% tienen una computadora de escritorio,'
                        ' 32% con una computadora portátil y el 38% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Turrialba el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Turrialba'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 51, Color(0xff00B7C2)),
