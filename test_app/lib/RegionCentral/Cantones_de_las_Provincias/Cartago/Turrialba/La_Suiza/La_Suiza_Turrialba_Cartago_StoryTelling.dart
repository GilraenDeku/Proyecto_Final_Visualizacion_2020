...
class storytellingLaSuizaTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaSuizaTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaSuizaTurrialbaCartago.withSampleData() {
    return new storytellingLaSuizaTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Suiza se observa que el 81% de las '
                        ...
                        'televisores son convencionales y el 26% son con cable '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de La Suiza el uso de las tecnologías es '
                        'bastante grande, excepto en las pantallas de '
                        'televisión y computadora portátil ya que se '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Suiza'),
              ),
              body: ListView(
                children: [
                  Image.asset(
