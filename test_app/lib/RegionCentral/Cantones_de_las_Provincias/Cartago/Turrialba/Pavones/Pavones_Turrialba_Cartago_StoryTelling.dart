...
class storytellingPavonesTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPavonesTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPavonesTurrialbaCartago.withSampleData() {
    return new storytellingPavonesTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pavones se observa que el 78% de las '
                        'casas cuentan con radio o equipos de sonido, el 52% con'
                        ' línea de teléfono fija, 83% con teléfono celular, 8%'
                        ' con pantalla de televisor, de este 8% el 93% de los '
                        'televisores son convencionales y el 6% son con cable '
                        'o satélite, el 19% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 14% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Pavones'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(6, 19, Color(0xff8675A9)),
