...
class storytellingTresEquisTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTresEquisTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTresEquisTurrialbaCartago.withSampleData() {
    return new storytellingTresEquisTurrialbaCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Turrialba, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tres Equis se observa que el 77% de las '
                        'casas cuentan con radio o equipos de sonido, el 44% con'
                        ' línea de teléfono fija, 77% con teléfono celular, 4%'
                        ' con pantalla de televisor, de este 4% el 94% de los '
                        'televisores son convencionales y el 5% son con cable '
                        'o satélite, el 12% tienen una computadora de escritorio,'
                        ' 7% con una computadora portátil y el 10% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tres Equis'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/TurrialbaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
