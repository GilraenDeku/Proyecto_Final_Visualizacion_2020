...
class storytellingSantaTeresitaTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaTeresitaTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaTeresitaTurrialbaCartago.withSampleData() {
    return new storytellingSantaTeresitaTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Teresita se observa que el 78% de las '
                        'casas cuentan con radio o equipos de sonido, el 38% con'
                        ' línea de teléfono fija, 83% con teléfono celular, 6%'
                        ' con pantalla de televisor, de este 6% el 94% de los '
                        'televisores son convencionales y el 6% son con cable '
                        'o satélite, el 15% tienen una computadora de escritorio,'
                        ' 8% con una computadora portátil y el 10% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'sonido y telefonía celular, fija y computadora '
                        'portátil siendo el teléfono celular la tecnología de '
                        'mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Teresita'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 38, Color(0xffFFA36C)),
