...
class storytellingSantaCruzTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaCruzTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaCruzTurrialbaCartago.withSampleData() {
    return new storytellingSantaCruzTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Cruz se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 57% con'
                        ' línea de teléfono fija, 82% con teléfono celular, 10%'
                        ' con pantalla de televisor, de este 10% el 93% de los '
                        'televisores son convencionales y el 15% son con cable '
                        'o satélite, el 24% tienen una computadora de escritorio,'
                        ' 14% con una computadora portátil y el 14% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        ' y telefonía celular, fija y computadora portátil '
