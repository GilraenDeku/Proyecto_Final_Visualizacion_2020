...
class storytellingSantaRosaTurrialbaCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaRosaTurrialbaCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaRosaTurrialbaCartago.withSampleData() {
    return new storytellingSantaRosaTurrialbaCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Rosa se observa que el 84% de las '
                        ...
                        ' 24% con una computadora portátil y el 24% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Santa '
                        'Rosa el uso de las tecnologías es bastante grande, '
