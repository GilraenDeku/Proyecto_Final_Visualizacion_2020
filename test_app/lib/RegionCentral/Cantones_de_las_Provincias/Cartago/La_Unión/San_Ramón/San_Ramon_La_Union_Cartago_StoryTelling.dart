...
class storytellingSanRamonLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRamonLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRamonLaUnionCartago.withSampleData() {
    return new storytellingSanRamonLaUnionCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Ramón se observa que el 89% de las '
                        'casas cuentan con radio o equipos de sonido, el 73% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 33%'
                        ...
                        ' 42% con una computadora portátil y el 57% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Ramón el'
