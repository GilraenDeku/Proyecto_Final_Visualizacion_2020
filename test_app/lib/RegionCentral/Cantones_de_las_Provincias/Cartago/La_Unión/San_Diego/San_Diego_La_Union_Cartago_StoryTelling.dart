...
class storytellingSanDiegoLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanDiegoLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanDiegoLaUnionCartago.withSampleData() {
    return new storytellingSanDiegoLaUnionCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Diego se observa que el 85% de las '
                        ...
                        ' 30% con una computadora portátil y el 43% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Diego el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Diego'),
              ),
              body: ListView(
                children: [
                  Image.asset(
