...
class storytellingSanJuanLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuanLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuanLaUnionCartago.withSampleData() {
    return new storytellingSanJuanLaUnionCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de La Unión, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan se observa que el 89% de las '
                        'casas cuentan con radio o equipos de sonido, el 82% con'
                        ' línea de teléfono fija, 96% con teléfono celular, 51%'
                        ' con pantalla de televisor, de este 51% el 87% de los '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 51, Color(0xff799351)),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.hacienda.go.cr/docs/5812418d2593d_Mapa'
                      '%20del%20Canton%20La%20Union%2003%20'
                      'Distrito%2001%20a%2008.pdf');
                }
            ),
          ),
