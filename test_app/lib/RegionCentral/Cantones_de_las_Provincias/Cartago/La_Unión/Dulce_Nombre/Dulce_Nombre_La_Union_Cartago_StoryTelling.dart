...
class storytellingDulceNombreLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDulceNombreLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDulceNombreLaUnionCartago.withSampleData() {
    return new storytellingDulceNombreLaUnionCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Dulce Nombre se observa que el 83% de las '
                        ...
                        ' 18% con una computadora portátil y el 30% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'en las pantallas de televisión y computadoras portátiles'
