...
class storytellingSanRafaelLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelLaUnionCartago.withSampleData() {
    return new storytellingSanRafaelLaUnionCartago(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de San Rafael se observa que el 88% de las '
                        ...
                        ' línea de teléfono fija, 94% con teléfono celular, 29%'
                        ...
                        ' 35% con una computadora portátil y el 47% de las casas'
