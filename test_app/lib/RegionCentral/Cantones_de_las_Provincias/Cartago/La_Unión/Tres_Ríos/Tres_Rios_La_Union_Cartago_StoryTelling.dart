...
class storytellingTresRiosLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTresRiosLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTresRiosLaUnionCartago.withSampleData() {
    return new storytellingTresRiosLaUnionCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tres Ríos se observa que el 91% de las '
                        'casas cuentan con radio o equipos de sonido, el 78% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 33%'
                        ' con pantalla de televisor, de este 33% el 94% de los '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Tres Ríos el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tres Ríos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
