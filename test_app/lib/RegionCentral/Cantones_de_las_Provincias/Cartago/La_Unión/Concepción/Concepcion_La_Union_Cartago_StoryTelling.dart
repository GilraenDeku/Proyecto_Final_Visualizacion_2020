...
class storytellingConcepcionLaUnionCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingConcepcionLaUnionCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingConcepcionLaUnionCartago.withSampleData() {
    return new storytellingConcepcionLaUnionCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Concepción se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 25%'
                        ' con pantalla de televisor, de este 25% el 93% de los '
                        'televisores son convencionales y el 59% son con cable '
                        'o satélite, el 39% tienen una computadora de escritorio,'
                        ' 32% con una computadora portátil y el 43% de las casas'
