...
class storytellingQuebradillaCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingQuebradillaCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingQuebradillaCartagoCartago.withSampleData() {
    return new storytellingQuebradillaCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Quebradilla se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 50% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 94% de los '
                        'televisores son convencionales y el 15% son con cable '
                        'o satélite, el 28% tienen una computadora de escritorio,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Quebradilla'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 15, Color(0xff00B7C2)),
