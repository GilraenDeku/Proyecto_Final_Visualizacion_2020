...
class storytellingTierraBlancaCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTierraBlancaCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTierraBlancaCartagoCartago.withSampleData() {
    return new storytellingTierraBlancaCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tierra Blanca se observa que el 91% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 11%'
                        ' con pantalla de televisor, de este 11% el 97% de los '
                        'televisores son convencionales y el 49% son con cable '
                        'o satélite, el 30% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 19% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tierra Blanca'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 97, Color(0xff0F4C75)), //ff6538
