...
class storytellingLlanoGrandeCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLlanoGrandeCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLlanoGrandeCartagoCartago.withSampleData() {
    return new storytellingLlanoGrandeCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Llano Grande se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 14%'
                        ' con pantalla de televisor, de este 14% el 94% de los '
                        'televisores son convencionales y el 16% son con cable '
                        'o satélite, el 24% tienen una computadora de escritorio,'
                        ' 12% con una computadora portátil y el 17% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        ' y telefonía celular, fija y computadora de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Llano Grande'),
              ),
              body: ListView(
                children: [
                  Image.asset(
