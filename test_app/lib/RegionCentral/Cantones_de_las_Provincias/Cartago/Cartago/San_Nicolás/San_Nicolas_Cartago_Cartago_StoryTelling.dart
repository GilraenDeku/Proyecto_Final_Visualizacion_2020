...
class storytellingSanNicolasCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanNicolasCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanNicolasCartagoCartago.withSampleData() {
    return new storytellingSanNicolasCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Nicolás se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 20%'
                        ' con pantalla de televisor, de este 20% el 95% de los '
                        'televisores son convencionales y el 33% son con cable '
                        'o satélite, el 38% tienen una computadora de escritorio,'
                        ' 23% con una computadora portátil y el 32% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Nicolás'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Nicolás'),
              ),
              body: ListView(
                children: [
                  Image.asset(
