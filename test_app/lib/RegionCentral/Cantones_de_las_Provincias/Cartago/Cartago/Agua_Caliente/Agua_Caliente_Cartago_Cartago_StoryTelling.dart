...
class storytellingAguaCalienteCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAguaCalienteCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAguaCalienteCartagoCartago.withSampleData() {
    return new storytellingAguaCalienteCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Agua Caliente se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 67% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 23%'
                        ' con pantalla de televisor, de este 23% el 95% de los '
                        'televisores son convencionales y el 43% son con cable '
                        'o satélite, el 44% tienen una computadora de escritorio,'
                        ' 28% con una computadora portátil y el 38% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Agua Caliente '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Agua Caliente'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 38, Color(0xff900C3F)),
    ];
