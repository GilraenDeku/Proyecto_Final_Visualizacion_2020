...
class storytellingOccidentalCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingOccidentalCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingOccidentalCartagoCartago.withSampleData() {
    return new storytellingOccidentalCartagoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Cartago, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Occidental se observa que el 91% de las '
                        'casas cuentan con radio o equipos de sonido, el 80% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 36%'
                        ' con pantalla de televisor, de este 36% el 93% de los '
                        'televisores son convencionales y el 66% son con cable '
                        'o satélite, el 56% tienen una computadora de escritorio,'
                        ' 46% con una computadora portátil y el 61% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'Occidental el uso de las tecnologías es bastante '
                        'grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Occidental'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/CartagoCantonDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 66, Color(0xff00B7C2)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.muni-carta.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/58123bb077353_'
                  'Mapa%20del%20Canton%20%20de%20Cartago%2001%20'
                  'Distrito%2001%20a%2011.pdf');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/58123bb077353_Mapa'
                      '%20del%20Canton%20%20de%20Cartago%2001%20'
                      'Distrito%2001%20a%2011.pdf');
                }
            ),
          ),
