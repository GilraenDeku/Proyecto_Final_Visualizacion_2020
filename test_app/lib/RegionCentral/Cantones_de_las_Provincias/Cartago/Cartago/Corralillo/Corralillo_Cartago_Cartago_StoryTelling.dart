...
class storytellingCorralilloCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCorralilloCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCorralilloCartagoCartago.withSampleData() {
    return new storytellingCorralilloCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Corralillo se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 71% con'
                        ' línea de teléfono fija, 83% con teléfono celular, 10%'
                        ' con pantalla de televisor, de este 10% el 96% de los '
                        'televisores son convencionales y el 13% son con cable '
                        'o satélite, el 32% tienen una computadora de escritorio,'
                        ' 16% con una computadora portátil y el 20% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Corralillo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 13, Color(0xff00B7C2)),
