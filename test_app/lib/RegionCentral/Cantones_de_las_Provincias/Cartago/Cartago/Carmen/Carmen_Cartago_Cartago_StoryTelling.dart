...
class storytellingCarmenCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCarmenCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCarmenCartagoCartago.withSampleData() {
    return new storytellingCarmenCartagoCartago(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de Carmen se observa que el 88% de las '
                        ...
                        ' línea de teléfono fija, 91% con teléfono celular, 25%'
                        ' con pantalla de televisor, de este 25% el 94% de los '
                        'televisores son convencionales y el 46% son con cable '
                        'o satélite, el 43% tienen una computadora de escritorio,'
                        ' 31% con una computadora portátil y el 43% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Carmen '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de El Carmen'),
              ),
              body: ListView(
                children: [
                  Image.asset(
