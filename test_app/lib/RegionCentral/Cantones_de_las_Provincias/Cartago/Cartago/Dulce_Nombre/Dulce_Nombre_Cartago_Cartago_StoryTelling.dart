...
class storytellingDulceNombreCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingDulceNombreCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingDulceNombreCartagoCartago.withSampleData() {
    return new storytellingDulceNombreCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Dulce Nombre se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 67% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 26%'
                        ' con pantalla de televisor, de este 26% el 93% de los '
                        'televisores son convencionales y el 43% son con cable '
                        'o satélite, el 45% tienen una computadora de escritorio,'
                        ' 35% con una computadora portátil y el 44% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Dulce Nombre'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Dulce Nombre'),
              ),
              body: ListView(
                children: [
                  Image.asset(
