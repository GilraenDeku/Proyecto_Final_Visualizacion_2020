...
class storytellingCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCartagoCartago.withSampleData() {
    return new storytellingCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Cartago se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 66% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 23%'
                        ' con pantalla de televisor, de este 23% el 94% de los '
                        'televisores son convencionales y el 42% son con cable '
                        'o satélite, el 42% tienen una computadora de escritorio,'
                        ' 30% con una computadora portátil y el 39% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Cartago '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Cartago'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/CartagoCantonPrincipal.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 42, Color(0xff00B7C2)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Cartago');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.hacienda.go.cr/docs/58123bb077353_Mapa'
                  '%20del%20Canton%20%20de%20Cartago%2001%20Distrito'
                  '%2001%20a%2011.pdf');
            }
        ),
