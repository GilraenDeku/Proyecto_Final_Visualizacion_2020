...
class storytellingGuadalupeCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGuadalupeCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGuadalupeCartagoCartago.withSampleData() {
    return new storytellingGuadalupeCartagoCartago(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de Guadalupe se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 27%'
                        ' con pantalla de televisor, de este 27% el 94% de los '
                        'televisores son convencionales y el 46% son con cable '
                        'o satélite, el 44% tienen una computadora de escritorio,'
                        ' 34% con una computadora portátil y el 41% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Guadalupe el'
