...
class storytellingOrientalCartagoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingOrientalCartagoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingOrientalCartagoCartago.withSampleData() {
    return new storytellingOrientalCartagoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Oriental se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 77% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 32%'
                        ' con pantalla de televisor, de este 32% el 94% de los '
                        'televisores son convencionales y el 62% son con cable '
                        'o satélite, el 50% tienen una computadora de escritorio,'
                        ' 49% con una computadora portátil y el 60% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'Oriental el uso de las tecnologías es bastante '
                        'grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Oriental'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 49, Color(0xffEEBB40)),
