...
class storytellingCipresesOreamunoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCipresesOreamunoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCipresesOreamunoCartago.withSampleData() {
    return new storytellingCipresesOreamunoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cipreses se observa que el 86% de las '
                        ...
                        'televisores son convencionales y el 27% son con cable '
                        'o satélite, el 29% tienen una computadora de escritorio,'
                        ' 15% con una computadora portátil y el 15% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de'
                        ...
                        'de escritorio siendo el teléfono celular la '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cipreses'),
              ),
              body: ListView(
                children: [
                  Image.asset(
