...
class storytellingSanRafaelOreamunoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelOreamunoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelOreamunoCartago.withSampleData() {
    return new storytellingSanRafaelOreamunoCartago(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de San Rafael el uso de las tecnologías'
                        ' es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
