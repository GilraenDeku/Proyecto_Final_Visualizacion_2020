...
class storytellingPotreroCerradoOreamunoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPotreroCerradoOreamunoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPotreroCerradoOreamunoCartago.withSampleData() {
    return new storytellingPotreroCerradoOreamunoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Oreamuno, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Potrero Cerrado se observa que el 93% de las '
                        'casas cuentan con radio o equipos de sonido, el 68% con'
                        ' línea de teléfono fija, 89% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 96% de los '
                        'televisores son convencionales y el 33% son con cable '
                        'o satélite, el 31% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 21% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que '
                        ...
                        'distrito de Potrero Cerrado el uso de las tecnologías'
                        ' es bastante grande, excepto en las pantallas de '
                        'televisión y computadoras portátiles ya que se '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Potrero Cerrado'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/OreamunoDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
