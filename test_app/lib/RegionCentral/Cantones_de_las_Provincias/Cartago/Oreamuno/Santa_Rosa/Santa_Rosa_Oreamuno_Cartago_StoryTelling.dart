...
class storytellingSantaRosaOreamunoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaRosaOreamunoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaRosaOreamunoCartago.withSampleData() {
    return new storytellingSantaRosaOreamunoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Rosa se observa que el 91% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 9%'
                        ' con pantalla de televisor, de este 9% el 98% de los '
                        'televisores son convencionales y el 16% son con cable '
                        'o satélite, el 18% tienen una computadora de escritorio,'
                        ' 12% con una computadora portátil y el 10% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Rosa'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 98, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 16, Color(0xff00B7C2)),
      new LinearSales(6, 18, Color(0xff8675A9)),
