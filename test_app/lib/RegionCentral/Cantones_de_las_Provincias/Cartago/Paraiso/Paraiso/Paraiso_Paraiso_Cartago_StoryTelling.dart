...
class storytellingParaisoParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingParaisoParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingParaisoParaisoCartago.withSampleData() {
    return new storytellingParaisoParaisoCartago(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Paraíso el uso'
                        ' de las tecnologías es bastante grande.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Paraíso'),
              ),
              body: ListView(
                children: [
                  Image.asset(
