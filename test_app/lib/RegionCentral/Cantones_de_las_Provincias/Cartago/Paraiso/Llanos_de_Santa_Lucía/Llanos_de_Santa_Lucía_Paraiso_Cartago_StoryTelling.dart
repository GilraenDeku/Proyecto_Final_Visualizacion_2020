...
class storytellingLlanosdeSantaLuciaParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLlanosdeSantaLuciaParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLlanosdeSantaLuciaParaisoCartago.withSampleData() {
    return new storytellingLlanosdeSantaLuciaParaisoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Distrito de Llanos de Santa Lucía',
                      style: TextStyle(
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Paraíso, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Llanos de Santa Lucía se observa que el '
                        '85% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 17%'
                        ' con pantalla de televisor, de este 17% el 97% de los '
                        'televisores son convencionales y el 22% son con cable '
                        'o satélite, el 36% tienen una computadora de escritorio,'
                        ' 18% con una computadora portátil y el 26% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Llanos de '
                        'Santa Lucía el uso'
                        ' de las tecnologías es bastante grande, excepto en las'
                        ' pantallas de televisión y computadoras portátil ya que'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Llanos de Santa Lucía'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/ParaisoDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
