...
class storytellingSantiagoParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantiagoParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantiagoParaisoCartago.withSampleData() {
    return new storytellingSantiagoParaisoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Paraiso, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santiago se observa que el 85% de las '
                        ...
                        'televisores son convencionales y el 10% son con cable '
                        'o satélite, el 23% tienen una computadora de escritorio,'
                        ' 12% con una computadora portátil y el 16% de las casas'
