...
class storytellingOrosiParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingOrosiParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingOrosiParaisoCartago.withSampleData() {
    return new storytellingOrosiParaisoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Orosi se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 95% de los '
                        'televisores son convencionales y el 25% son con cable '
                        'o satélite, el 29% tienen una computadora de escritorio,'
                        ' 19% con una computadora portátil y el 23% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Orosi el uso'
