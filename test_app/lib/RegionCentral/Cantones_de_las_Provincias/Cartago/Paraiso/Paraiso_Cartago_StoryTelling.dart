...
class storytellingParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingParaisoCartago.withSampleData() {
    return new storytellingParaisoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Paraíso es el cantón número 2 de la provincia de Cartago,'
                        ' está situado al este del Valle del Guarco. Su ciudad'
                        ' cabecera del mismo nombre. Paraíso fue uno de los '
                        'primeros lugares en ser colonizado cuando llegaron '
                        'los españoles, aún hoy se conservan la iglesia '
                        'colonial de Orosi y las ruinas de Ujarrás (antiguo '
                        'templo de la Virgen del Rescate) como recuerdo de la'
                        ' colonización española. Paraíso es una de las zonas '
                        'con mayores atracciones turísticas del país tales '
                        'como: Jardín Botánico Lankester, Represa de Cachí, '
                        'Iglesia de Orosi, templo colonial, Ruinas de Ujarrás '
                        'y Parque nacional Tapantí.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Paraíso, Orosi, Cachí, Santiago y'
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 28, Color(0xff00B7C2)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Para%C3%ADso');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://muniparaiso.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/545cdd5ba073b_2.pdf');
            }
        ),
