...
class storytellingCachiParaisoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCachiParaisoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCachiParaisoCartago.withSampleData() {
    return new storytellingCachiParaisoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cachí se observa que el 89% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 9%'
                        ' con pantalla de televisor, de este 9% el 95% de los '
                        'televisores son convencionales y el 16% son con cable '
                        'o satélite, el 32% tienen una computadora de escritorio,'
                        ' 16% con una computadora portátil y el 21% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Cachí el uso'
