...
class storytellingCapelladesAlvaradoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCapelladesAlvaradoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCapelladesAlvaradoCartago.withSampleData() {
    return new storytellingCapelladesAlvaradoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Capellades se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 57% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 11%'
                        ' con pantalla de televisor, de este 11% el 94% de los '
                        'televisores son convencionales y el 31% son con cable '
                        'o satélite, el 23% tienen una computadora de escritorio,'
                        ' 10% con una computadora portátil y el 9% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Capellades'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(6, 23, Color(0xff8675A9)),
      new LinearSales(7, 10, Color(0xffEEBB40)),
      new LinearSales(8, 9, Color(0xff900C3F)),
    ];
