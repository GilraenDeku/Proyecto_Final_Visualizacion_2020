...
class storytellingCervantesAlvaradoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCervantesAlvaradoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCervantesAlvaradoCartago.withSampleData() {
    return new storytellingCervantesAlvaradoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cervantes se observa que el 86% de las '
                        ...
                        ' 14% con una computadora portátil y el 18% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cervantes'),
              ),
              body: ListView(
                children: [
                  Image.asset(
