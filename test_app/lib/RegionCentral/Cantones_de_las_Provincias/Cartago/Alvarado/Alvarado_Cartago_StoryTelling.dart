...
class storytellingAlvaradoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlvaradoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlvaradoCartago.withSampleData() {
    return new storytellingAlvaradoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Alvarado es el cantón número 6 de la provincia de Cartago,'
                        ' Costa Rica. Su ciudad cabecera es Pacayas. '
                        'Alvarado es el segundo cantón más pequeño de'
                        ' la provincia, después de La Unión. La actividad'
                        ' económica es básicamente agrícola, con la siembra'
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Capellades, Cervantes y Pacayas',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Alvarado se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 55% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 96% de los '
                        'televisores son convencionales y el 35% son con cable '
                        'o satélite, el 25% tienen una computadora de escritorio,'
                        ' 14% con una computadora portátil y el 16% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este cantón el uso de '
                        ...
                        ' y telefonía celular, fija y computadora de escritorio'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Alvarado'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/alvaradoCartago.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Alvarado');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('http://www.munialvarado.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/59f7640eadba7_'
                  '306%20cartago%2006%20alvarado%20dist%2001%20al%2003.pdf');
            }
        ),
