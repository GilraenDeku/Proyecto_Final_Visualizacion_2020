...
class storytellingPacayasAlvaradoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPacayasAlvaradoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPacayasAlvaradoCartago.withSampleData() {
    return new storytellingPacayasAlvaradoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Alvarado, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pacayas se observa que el 90% de las '
                        'casas cuentan con radio o equipos de sonido, el 57% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 11%'
                        ' con pantalla de televisor, de este 11% el 96% de los '
                        'televisores son convencionales y el 31% son con cable '
                        'o satélite, el 24% tienen una computadora de escritorio,'
                        ' 15% con una computadora portátil y el 18% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Pacayas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/alvaradoCanton.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
