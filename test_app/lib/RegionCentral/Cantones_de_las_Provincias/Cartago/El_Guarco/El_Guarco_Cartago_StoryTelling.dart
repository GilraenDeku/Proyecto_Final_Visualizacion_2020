...
class storytellingElGuarcoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingElGuarcoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingElGuarcoCartago.withSampleData() {
    return new storytellingElGuarcoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'El Cantón de El Guarco corresponde al número 8 de la '
                        'provincia de Cartago y está situado al extremo '
                        'suroeste. La ciudad cabecera es El Tejar, que se '
                        'localiza aproximadamente a 2 kilómetros al suroeste'
                        ' de la ciudad de Cartago, en el Valle del Guarco, '
                        'por lo que forma parte de su área metropolitana. '
                        'Esta ciudad y su respectivo distrito concentran '
                        'poco más del 65% de la población total del cantón. '
                        'El nombre del cantón es en memoria del cacique '
                        'Huetar que habitó en la región, El Guarco fue un '
                        'rey indígena en la época de la conquista española.',
                    softWrap: true,
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de El Guarco se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 22%'
                        ' con pantalla de televisor, de este 22% el 94% de los '
                        'televisores son convencionales y el 35% son con cable '
                        'o satélite, el 38% tienen una computadora de escritorio,'
                        ' 27% con una computadora portátil y el 33% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de El Guarco'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de El Guarco'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/ElGuarcoCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_El_Guarco');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/545cdd8162289_8.pdf');
            }
        ),
