...
class storytellingTobosiElGuarcoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTobosiElGuarcoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTobosiElGuarcoCartago.withSampleData() {
    return new storytellingTobosiElGuarcoCartago(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de El Guarco, Provincia de Cartago, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tobosi se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 50% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 14%'
                        ' con pantalla de televisor, de este 14% el 95% de los '
                        'televisores son convencionales y el 16% son con cable '
                        'o satélite, el 32% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 16% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tobosi'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/ElGuarcoDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
