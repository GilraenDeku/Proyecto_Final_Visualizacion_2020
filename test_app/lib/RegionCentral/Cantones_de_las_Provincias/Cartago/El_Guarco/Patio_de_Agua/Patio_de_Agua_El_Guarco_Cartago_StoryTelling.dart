...
class storytellingPatiodeAguaElGuarcoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPatiodeAguaElGuarcoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPatiodeAguaElGuarcoCartago.withSampleData() {
    return new storytellingPatiodeAguaElGuarcoCartago(
      _createSampleData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Patio de Agua'),
              ),
              body: ListView(
                children: [
                  Image.asset(
