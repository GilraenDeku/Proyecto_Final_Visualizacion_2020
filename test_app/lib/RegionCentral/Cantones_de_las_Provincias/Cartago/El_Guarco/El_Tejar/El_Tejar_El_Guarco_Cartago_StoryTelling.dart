...
class storytellingElTejarElGuarcoCartago extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingElTejarElGuarcoCartago(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingElTejarElGuarcoCartago.withSampleData() {
    return new storytellingElTejarElGuarcoCartago(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de El Tejar se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 28%'
                        ' con pantalla de televisor, de este 28% el 94% de los '
                        'televisores son convencionales y el 49% son con cable '
                        'o satélite, el 45% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 45% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de El Tejar'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de El Tejar'),
              ),
              body: ListView(
                children: [
                  Image.asset(
