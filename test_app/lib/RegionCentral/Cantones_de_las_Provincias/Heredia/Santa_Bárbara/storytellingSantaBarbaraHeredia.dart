...
class storytellingSantaBarbaraHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaBarbaraHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaBarbaraHeredia.withSampleData() {
    return new storytellingSantaBarbaraHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Santa Bárbara es el cantón número 4 de la provincia de'
                        ' Heredia, Costa Rica. El cantón forma parte de la'
                        ' Gran Área Metropolitana, su cabecera es la ciudad'
                        ' de Santa Bárbara. Las principales actividades '
                        'agropecuarias son los cultivos de hortalizas, café'
                        ' y caña de azúcar y la ganadería. Al norte de la '
                        'región se localiza parcialmente la Reserva Forestal'
                        ' Cordillera Volcánica Central; así como una zona '
                        'de mineralización de azufre volcánico.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Santa Bárbara, San Pedro, San Juan,'
                        ' Barrio Jesús, Santo Domingo y Puraba',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Santa Bárbara se observa que el '
                        '84% de las '
                        'casas cuentan con radio o equipos de sonido, el 67% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 24%'
                        ' con pantalla de televisor, de este 24% el 94% de los '
                        'televisores son convencionales y el 49% son con cable '
                        'o satélite, el 41% tienen una computadora de escritorio,'
                        ' 30% con una computadora portátil y el 40% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el cantón de Santa Bárbara el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Santa Bárbara'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 49, Color(0xff00B7C2)),
      new LinearSales(6, 41, Color(0xff8675A9)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Santa_B%C3%A1rbara');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('http://www.santabarbara.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/58125fcfdb480_Mapa%20del'
                  '%20Canton%20Santa%20Barbara%2004%20Distrito%2001%20'
                  'a%2006.pdf');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/58125fcfdb480_Mapa'
                      '%20del%20Canton%20Santa%20Barbara%2004%20Distrito%'
                      '2001%20a%2006.pdf');
                }
            ),
          ),
