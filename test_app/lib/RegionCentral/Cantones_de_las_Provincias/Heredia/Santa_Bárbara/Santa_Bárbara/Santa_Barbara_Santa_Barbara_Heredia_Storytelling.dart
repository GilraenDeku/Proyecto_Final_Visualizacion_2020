...
class storytellingSantaBarbaraSantaBarbaraHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaBarbaraSantaBarbaraHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaBarbaraSantaBarbaraHeredia.withSampleData() {
    return new storytellingSantaBarbaraSantaBarbaraHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Bárbara se observa que el '
                        '84% de las '
                        'casas cuentan con radio o equipos de sonido, el 70% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 28%'
                        ' con pantalla de televisor, de este 28% el 93% de los '
                        'televisores son convencionales y el 59% son con cable '
                        'o satélite, el 44% tienen una computadora de escritorio,'
                        ' 34% con una computadora portátil y el 47% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Santa Bárbara el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Bárbara'),
              ),
              body: ListView(
                children: [
                  Image.asset(
