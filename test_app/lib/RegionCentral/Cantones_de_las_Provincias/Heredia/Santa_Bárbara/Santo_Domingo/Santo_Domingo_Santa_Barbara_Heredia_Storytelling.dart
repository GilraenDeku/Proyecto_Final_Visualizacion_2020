...
class storytellingSantoDomingoSantaBarbaraHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantoDomingoSantaBarbaraHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantoDomingoSantaBarbaraHeredia.withSampleData() {
    return new storytellingSantoDomingoSantaBarbaraHeredia(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de Santo Domingo se observa que el '
                        ...
                        ' línea de teléfono fija, 90% con teléfono celular, 20%'
                        ' con pantalla de televisor, de este 20% el 92% de los '
                        'televisores son convencionales y el 36% son con cable '
                        'o satélite, el 35% tienen una computadora de escritorio,'
                        ' 26% con una computadora portátil y el 31% de las casas'
