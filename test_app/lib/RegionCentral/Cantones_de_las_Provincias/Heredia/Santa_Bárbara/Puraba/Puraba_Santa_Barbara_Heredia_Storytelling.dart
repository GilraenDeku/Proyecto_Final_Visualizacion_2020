...
class storytellingPurabaSantaBarbaraHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPurabaSantaBarbaraHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPurabaSantaBarbaraHeredia.withSampleData() {
    return new storytellingPurabaSantaBarbaraHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Purabá se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 19%'
                        ' con pantalla de televisor, de este 19% el 94% de los '
                        'televisores son convencionales y el 37% son con cable '
                        'o satélite, el 42% tienen una computadora de escritorio,'
                        ' 25% con una computadora portátil y el 34% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Purabá el'
