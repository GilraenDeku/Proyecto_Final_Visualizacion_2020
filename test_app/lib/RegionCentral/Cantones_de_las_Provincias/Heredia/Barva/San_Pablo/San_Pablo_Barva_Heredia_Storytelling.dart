...
class storytellingSanPabloBarvaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPabloBarvaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPabloBarvaHeredia.withSampleData() {
    return new storytellingSanPabloBarvaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Pablo se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 73% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 25%'
                        ' con pantalla de televisor, de este 25% el 96% de los '
                        'televisores son convencionales y el 57% son con cable '
                        'o satélite, el 48% tienen una computadora de escritorio,'
                        ' 34% con una computadora portátil y el 46% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de San Pablo'
