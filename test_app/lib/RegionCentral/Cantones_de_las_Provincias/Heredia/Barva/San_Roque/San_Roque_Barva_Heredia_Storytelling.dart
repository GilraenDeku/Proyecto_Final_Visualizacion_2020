...
class storytellingSanRoqueBarvaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRoqueBarvaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRoqueBarvaHeredia.withSampleData() {
    return new storytellingSanRoqueBarvaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Roque se observa que el 90% de las '
                        'casas cuentan con radio o equipos de sonido, el 78% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 41%'
                        ' con pantalla de televisor, de este 41% el 90% de los '
                        'televisores son convencionales y el 71% son con cable '
                        'o satélite, el 58% tienen una computadora de escritorio,'
                        ' 46% con una computadora portátil y el 64% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de San Roque'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Roque'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 78, Color(0xffFFA36C)),
      ...
      new LinearSales(8, 64, Color(0xff900C3F)),
    ];
