...
class storytellingSanJosedelaMontanaBarvaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJosedelaMontanaBarvaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJosedelaMontanaBarvaHeredia.withSampleData() {
    return new storytellingSanJosedelaMontanaBarvaHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Distrito de San José de la Montaña',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San José de la Montaña se observa que el '
                        '85% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 21%'
                        ' con pantalla de televisor, de este 21% el 93% de los '
                        'televisores son convencionales y el 46% son con cable '
                        'o satélite, el 40% tienen una computadora de escritorio,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San José de la Montaña'),
              ),
              body: ListView(
                children: [
                  Image.asset(
