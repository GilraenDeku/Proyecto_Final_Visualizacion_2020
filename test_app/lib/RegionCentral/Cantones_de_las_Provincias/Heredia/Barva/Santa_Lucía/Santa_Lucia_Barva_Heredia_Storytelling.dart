...
class storytellingSantaLuciaBarvaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaLuciaBarvaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaLuciaBarvaHeredia.withSampleData() {
    return new storytellingSantaLuciaBarvaHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Barva, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Lucía se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 76% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 35%'
                        ' con pantalla de televisor, de este 35% el 92% de los '
                        'televisores son convencionales y el 68% son con cable '
                        'o satélite, el 53% tienen una computadora de escritorio,'
                        ' 48% con una computadora portátil y el 62% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Santa Lucía'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Lucía'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/BarvaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 48, Color(0xffEEBB40)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.hacienda.go.cr/docs/58123b8ec5ca3_Mapa%20del'
                  '%20Canton%20Barva%2002%20Distrito%2001%20a%2006.pdf');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/58123b8ec5ca3_Mapa%20'
                      'del%20Canton%20Barva%2002%20Distrito%2001%20a%2006.pdf');
                }
            ),
          ),
        ),
