...
class storytellingBarvaBarvaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBarvaBarvaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBarvaBarvaHeredia.withSampleData() {
    return new storytellingBarvaBarvaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Barva se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 77% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 30%'
                        ' con pantalla de televisor, de este 30% el 94% de los '
                        'televisores son convencionales y el 68% son con cable '
                        'o satélite, el 52% tienen una computadora de escritorio,'
                        ' 42% con una computadora portátil y el 59% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Barva'
