          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Barva es el cantón número 2 de la provincia de Heredia.'
                        ' La zona montañosa del cantón es propicia para la'
                        ' agricultura, principalmente el cultivo del café en '
                        'las faldas del volcán Barva. También se da la '
                        'ganadería de producción de leche. El cantón de '
                        'Barva posee gran cantidad de mantos acuíferos que '
                        'abastecen el Gran Área Metropolitana. La región '
                        'montañosa del cantón, donde se encuentra la laguna del'
                        ' volcán Barva. Barva es uno de los cantones donde '
                        'tiene gran auge la mascarada tradicional '
                        'costarricense.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Barva, San Pedro, San Pablo, San Roque, '
                        'Santa Lucía, San José de la Montaña',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Barva se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 73% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 29%'
                        ' con pantalla de televisor, de este 29% el 93% de los '
                        'televisores son convencionales y el 61% son con cable '
                        'o satélite, el 48% tienen una computadora de escritorio,'
                        ' 37% con una computadora portátil y el 50% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Barva'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Barva'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/BarvaCanton.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://munibarva.maps.arcgis.com/apps/webappviewer'
                  '/index.html?id=7239858fa3954ef58f16b807620cd738');
            }
        ),
