...
class storytellingConcepcionSanIsidroHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingConcepcionSanIsidroHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingConcepcionSanIsidroHeredia.withSampleData() {
    return new storytellingConcepcionSanIsidroHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de San Isidro, Provincia de Heredia, Región Central',
                      style: TextStyle(
