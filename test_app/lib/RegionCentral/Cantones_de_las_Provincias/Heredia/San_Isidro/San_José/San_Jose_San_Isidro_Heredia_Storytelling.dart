...
class storytellingSanJoseSanIsidroHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJoseSanIsidroHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJoseSanIsidroHeredia.withSampleData() {
    return new storytellingSanJoseSanIsidroHeredia(
      _createSampleData(),
