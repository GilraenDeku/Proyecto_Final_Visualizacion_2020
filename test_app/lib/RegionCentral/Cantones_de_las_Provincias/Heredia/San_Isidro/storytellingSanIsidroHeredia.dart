...
class storytellingSanIsidroHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroHeredia.withSampleData() {
    return new storytellingSanIsidroHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'San Isidro es el cantón número 6 de la provincia de '
                        'Heredia, Su cabecera es San Isidro.  La economía del '
                        'cantón se basa principalmente en las actividades '
                        'agropecuarias como los cultivos de café y hortalizas,'
                        ' así como la ganadería de leche. El cantón es rico en'
                        ' mantos acuíferos. "Saca de agua" es el nombre como '
                        'se le denominaba en tiempos coloniales.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Isidro, San Francisco, San José y'
                        ' Concepción',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de San Isidro se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 71% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 29%'
                        ' con pantalla de televisor, de este 29% el 92% de los '
                        'televisores son convencionales y el 53% son con cable '
                        'o satélite, el 46% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 46% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el cantón de San Isidro el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de San Isidro'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanIsidroCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 53, Color(0xff00B7C2)),
      new LinearSales(6, 46, Color(0xff8675A9)),
      new LinearSales(7, 36, Color(0xffEEBB40)),
      new LinearSales(8, 46, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_San_Isidro');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.munisanisidro.go.cr/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source='
                  'web&cd=&cad=rja&uact=8&ved=2ahUKEwigjfLN6qDrAhVM1lkKHbsSAn'
                  'YQFjABegQIBBAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fdoc'
                  's%2F562e619a72bfb_Mapa%2520del%2520Canton%2520San%2520Isi'
                  'dro%252006%2C%2520Distritos%252001%2520a%252004.pdf&usg'
                  '=AOvVaw3S5wnuZO3-80EGQ8as3TRp');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwigjfLN6qDrA'
                      'hVM1lkKHbsSAnYQFjABegQIBBAB&url=https%3A%2F%2Fwww.ha'
                      'cienda.go.cr%2Fdocs%2F562e619a72bfb_Mapa%2520del%252'
                      '0Canton%2520San%2520Isidro%252006%2C%2520Distritos%25'
                      '2001%2520a%252004.pdf&usg=AOvVaw3S5wnuZO3-80EGQ8as3TRp');
                }
            ),
          ),
        ),
