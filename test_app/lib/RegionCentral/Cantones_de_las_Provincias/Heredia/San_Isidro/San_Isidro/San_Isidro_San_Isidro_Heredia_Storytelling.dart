...
class storytellingSanIsidroSanIsidroHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroSanIsidroHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroSanIsidroHeredia.withSampleData() {
    return new storytellingSanIsidroSanIsidroHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Isidro se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 29%'
                        ' con pantalla de televisor, de este 29% el 95% de los '
                        'televisores son convencionales y el 60% son con cable '
                        'o satélite, el 49% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 50% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Isidro el'
