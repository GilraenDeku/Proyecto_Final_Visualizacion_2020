...
class storytellingSanFranciscoSanIsidroHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanFranciscoSanIsidroHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanFranciscoSanIsidroHeredia.withSampleData() {
    return new storytellingSanFranciscoSanIsidroHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Francisco se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 67% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 24%'
                        ' con pantalla de televisor, de este 24% el 95% de los '
                        'televisores son convencionales y el 48% son con cable '
                        'o satélite, el 45% tienen una computadora de escritorio,'
                        ' 30% con una computadora portátil y el 44% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Francisco el'
