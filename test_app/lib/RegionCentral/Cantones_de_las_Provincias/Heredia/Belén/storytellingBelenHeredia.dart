          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Belén es el cantón número 7 de la provincia de Heredia. La'
                        ' economía del cantón de Belén se basa en la industria,'
                        ' el comercio y los servicios. Las nuevas industrias '
                        'instaladas son tecnologías, hotelería, manufacturas, '
                        'comercio entre otras. Al norte de la región se '
                        'localiza la zona industrial en desarrollo La Ribera y '
                        'La Asunción. Las principales actividades agropecuarias'
                        ' del cantón fueron los cultivos de cebolla, tomate, '
                        'maíz, café y la ganadería; así como la producción '
                        'avícola.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: San Antonio, La Ribera y La Asunción',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Belén se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 39%'
                        ' con pantalla de televisor, de este 39% el 89% de los '
                        'televisores son convencionales y el 73% son con cable '
                        'o satélite, el 49% tienen una computadora de escritorio,'
                        ' 48% con una computadora portátil y el 59% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Belén'
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.belen.go.cr/mapa-del-canton');
            }
        ),
