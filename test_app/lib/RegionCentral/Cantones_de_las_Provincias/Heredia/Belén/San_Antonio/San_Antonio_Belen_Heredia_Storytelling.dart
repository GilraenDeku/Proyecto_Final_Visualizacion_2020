...
class storytellingSanAntonioBelenHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAntonioBelenHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAntonioBelenHeredia.withSampleData() {
    return new storytellingSanAntonioBelenHeredia(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de San Antonio se observa que el 86% de las '
                        ...
                        ' línea de teléfono fija, 93% con teléfono celular, 33%'
                        ...
                        ' 43% con una computadora portátil y el 54% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de San Antonio'
