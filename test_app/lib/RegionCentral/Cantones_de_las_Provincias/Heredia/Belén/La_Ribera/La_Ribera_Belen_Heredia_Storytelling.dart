...
class storytellingLaRiberaBelenHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaRiberaBelenHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaRiberaBelenHeredia.withSampleData() {
    return new storytellingLaRiberaBelenHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Rivera se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 69% con'
                        ' línea de teléfono fija, 93% con teléfono celular, 35%'
                        ' con pantalla de televisor, de este 35% el 89% de los '
                        'televisores son convencionales y el 71% son con cable '
                        'o satélite, el 44% tienen una computadora de escritorio,'
                        ' 41% con una computadora portátil y el 53% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de La Rivera'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Ribera'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 53, Color(0xff900C3F)),
    ];
