...
class storytellingLaAsuncionBelenHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaAsuncionBelenHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaAsuncionBelenHeredia.withSampleData() {
    return new storytellingLaAsuncionBelenHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Belén, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Asunción se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 85% con'
                        ' línea de teléfono fija, 96% con teléfono celular, 55%'
                        ' con pantalla de televisor, de este 55% el 85% de los '
                        'televisores son convencionales y el 82% son con cable '
                        'o satélite, el 57% tienen una computadora de escritorio,'
                        ' 64% con una computadora portátil y el 75% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de La Asunción'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Asunción'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/BelenDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
