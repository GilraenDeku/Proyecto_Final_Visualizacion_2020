...
class storytellingSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantoDomingoHeredia.withSampleData() {
    return new storytellingSantoDomingoHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Santo Domingo es el cantón número 3 de la provincia de '
                        'Heredia, la cabecera del cantón es una ciudad con el '
                        'mismo nombre. Las principales actividades '
                        'agropecuarias de la región son los cultivos de café y'
                        ' hortalizas y la ganadería. Así mismo se localizan en'
                        ' el cantón zonas de explotación de canteras. El '
                        'origen del nombre del cantón se remonta a la creación'
                        ' de la ermita dedicada a Santo Domingo, y por '
                        'consiguiente conservó al crearse el cantón.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Santo Domingo, San Vicente, San Miguel,'
                        ' Paracito, Santo Tomás, Santa Rosa, Tures y Pará',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Santo Domingo se observa que el '
                        '88% de las '
                        'casas cuentan con radio o equipos de sonido, el 74% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 33%'
                        ' con pantalla de televisor, de este 33% el 93% de los '
                        'televisores son convencionales y el 63% son con cable '
                        'o satélite, el 50% tienen una computadora de escritorio,'
                        ' 42% con una computadora portátil y el 54% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el cantón de Santo Domingo el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Santo Domingo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SantoDomingoCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Santo_Domingo_(Costa_Rica)');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('http://munisantodomingo.go.cr/');
            }
        ),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source'
                  '=web&cd=&cad=rja&uact=8&ved=2ahUKEwiJtdLl25nrAhXPxVkKHXjB'
                  'CkwQFjABegQIAxAB&url=https%3A%2F%2Fwww.hacienda.go.cr%2Fd'
                  'ocs%2F562e619adb728_Mapa%2520del%2520Canton%2520Santo%25'
                  '20Domingo%252003%2C%2520Distritos%252001%2520a%252008.p'
                  'df&usg=AOvVaw0hjRx-_E0crv00d69VlnIP');
            }
        ),
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&'
                      'source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiJtdLl25n'
                      'rAhXPxVkKHXjBCkwQFjABegQIAxAB&url=https%3A%2F%2Fw'
                      'ww.hacienda.go.cr%2Fdocs%2F562e619adb728_Mapa%252'
                      '0del%2520Canton%2520Santo%2520Domingo%252003%2C%2'
                      '520Distritos%252001%2520a%252008.pdf&usg=AOvVaw0hj'
                      'Rx-_E0crv00d69VlnIP');
                }
            ),
          ),
