...
class storytellingSanVicenteSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanVicenteSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanVicenteSantoDomingoHeredia.withSampleData() {
    return new storytellingSanVicenteSantoDomingoHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Santo Domingo, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Vicente se observa que el '
                        '91% de las '
                        'casas cuentan con radio o equipos de sonido, el 83% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 47%'
                        ' con pantalla de televisor, de este 47% el 89% de los '
                        'televisores son convencionales y el 78% son con cable '
                        'o satélite, el 59% tienen una computadora de escritorio,'
                        ' 56% con una computadora portátil y el 72% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Vicente el'
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 91, Color(0xffD54062)),
      new LinearSales(1, 83, Color(0xffFFA36C)),
      new LinearSales(2, 94, Color(0xffEBDC87)),
      new LinearSales(3, 47, Color(0xff799351)),
      new LinearSales(4, 89, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 78, Color(0xff00B7C2)),
      new LinearSales(6, 59, Color(0xff8675A9)),
      new LinearSales(7, 56, Color(0xffEEBB40)),
