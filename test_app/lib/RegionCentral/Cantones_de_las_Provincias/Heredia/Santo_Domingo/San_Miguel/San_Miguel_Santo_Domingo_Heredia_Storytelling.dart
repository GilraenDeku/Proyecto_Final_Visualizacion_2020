...
class storytellingSanMiguelSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanMiguelSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanMiguelSantoDomingoHeredia.withSampleData() {
    return new storytellingSanMiguelSantoDomingoHeredia(
      _createSampleData(),
