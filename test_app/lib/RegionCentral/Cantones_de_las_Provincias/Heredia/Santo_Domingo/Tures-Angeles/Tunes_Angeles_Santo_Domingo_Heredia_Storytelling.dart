...
class storytellingTuresAngelesSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTuresAngelesSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTuresAngelesSantoDomingoHeredia.withSampleData() {
    return new storytellingTuresAngelesSantoDomingoHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tures-Ángeles se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 60% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 23%'
                        ' con pantalla de televisor, de este 23% el 95% de los '
                        'televisores son convencionales y el 46% son con cable '
                        'o satélite, el 42% tienen una computadora de escritorio,'
                        ' 32% con una computadora portátil y el 41% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Tures-Ángeles el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tures-Ángeles'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 41, Color(0xff900C3F)),
    ];
