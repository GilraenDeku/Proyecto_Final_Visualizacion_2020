...
class storytellingSantoDomingoSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantoDomingoSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantoDomingoSantoDomingoHeredia.withSampleData() {
    return new storytellingSantoDomingoSantoDomingoHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santo Domingo se observa que el '
                        '89% de las '
                        'casas cuentan con radio o equipos de sonido, el 83% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 37%'
                        ' con pantalla de televisor, de este 37% el 95% de los '
                        'televisores son convencionales y el 71% son con cable '
                        'o satélite, el 53% tienen una computadora de escritorio,'
                        ' 47% con una computadora portátil y el 60% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Santo Domingo el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santo Domingo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
