...
class storytellingSantoTomasSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantoTomasSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantoTomasSantoDomingoHeredia.withSampleData() {
    return new storytellingSantoTomasSantoDomingoHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santo Tomás se observa que el '
                        '90% de las '
                        'casas cuentan con radio o equipos de sonido, el 80% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 39%'
                        ' con pantalla de televisor, de este 39% el 91% de los '
                        'televisores son convencionales y el 69% son con cable '
                        'o satélite, el 54% tienen una computadora de escritorio,'
                        ' 48% con una computadora portátil y el 60% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Santo Tomás el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santo Tomás'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 60, Color(0xff900C3F)),
    ];
