...
class storytellingParaSanLuisSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingParaSanLuisSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingParaSanLuisSantoDomingoHeredia.withSampleData() {
    return new storytellingParaSanLuisSantoDomingoHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Pará-San Luis se observa que el '
                        '85% de las '
                        ...
                        'televisores son convencionales y el 50% son con cable '
                        'o satélite, el 43% tienen una computadora de escritorio,'
                        ' 32% con una computadora portátil y el 40% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Pará-San Luis el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Pará-San Luis'),
              ),
              body: ListView(
                children: [
                  Image.asset(
