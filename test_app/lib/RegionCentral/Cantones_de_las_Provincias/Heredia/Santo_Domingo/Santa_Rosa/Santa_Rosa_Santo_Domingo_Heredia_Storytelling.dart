...
class storytellingSantaRosaSantoDomingoHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaRosaSantoDomingoHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaRosaSantoDomingoHeredia.withSampleData() {
    return new storytellingSantaRosaSantoDomingoHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Rosa se observa que el '
                        '86% de las '
                        ...
                        'televisores son convencionales y el 59% son con cable '
                        'o satélite, el 45% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 47% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Santa Rosa el'
