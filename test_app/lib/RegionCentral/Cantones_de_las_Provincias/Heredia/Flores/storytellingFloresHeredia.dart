...
class storytellingFloresHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingFloresHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingFloresHeredia.withSampleData() {
    return new storytellingFloresHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Flores es el cantón número 8 de la provincia de Heredia y'
                        ' su cabecera es la ciudad de San Joaquín. La '
                        'principal actividad económica del cantón es el '
                        'cultivo del café. Al suroeste de Flores se localiza '
                        'un sector de la zona industrial en desarrollo Barreal '
                        'de Heredia.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: San Joaquín, Barrantes y Llorente',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Flores se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 74% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 35%'
                        ' con pantalla de televisor, de este 35% el 91% de los '
                        'televisores son convencionales y el 65% son con cable '
                        'o satélite, el 49% tienen una computadora de escritorio,'
                        ' 44% con una computadora portátil y el 57% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Flores'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Flores'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/FloresCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Flores');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://flores.go.cr/contribuyente/servicios/mapa-del-canton/');
            }
        ),
