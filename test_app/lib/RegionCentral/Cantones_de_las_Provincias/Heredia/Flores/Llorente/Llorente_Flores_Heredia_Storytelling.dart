...
class storytellingLlorenteFloresHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLlorenteFloresHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLlorenteFloresHeredia.withSampleData() {
    return new storytellingLlorenteFloresHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Llorente se observa que el 85% de las '
                        ...
                        ' 35% con una computadora portátil y el 49% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Llorente'),
              ),
              body: ListView(
                children: [
                  Image.asset(
