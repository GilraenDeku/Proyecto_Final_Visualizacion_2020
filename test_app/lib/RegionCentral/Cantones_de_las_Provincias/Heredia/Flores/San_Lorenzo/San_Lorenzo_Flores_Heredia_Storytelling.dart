...
class storytellingSanLorenzoFloresHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanLorenzoFloresHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanLorenzoFloresHeredia.withSampleData() {
    return new storytellingSanLorenzoFloresHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Distrito de San Lorenzo/Barrantes',
                      style: TextStyle(
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Flores, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Lorenzo/Barrantes se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 80% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 46%'
                        ' con pantalla de televisor, de este 46% el 88% de los '
                        'televisores son convencionales y el 73% son con cable '
                        'o satélite, el 51% tienen una computadora de escritorio,'
                        ' 54% con una computadora portátil y el 66% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de San Lorenzo/Barrantes'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Lorenzo/Barrantes'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/FloresDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 66, Color(0xff900C3F)),
    ];
