...
class storytellingSanJoaquinFloresHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJoaquinFloresHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJoaquinFloresHeredia.withSampleData() {
    return new storytellingSanJoaquinFloresHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Joaquín se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 86% con teléfono celular, 38%'
                        ' con pantalla de televisor, de este 38% el 90% de los '
                        'televisores son convencionales y el 69% son con cable '
                        'o satélite, el 51% tienen una computadora de escritorio,'
                        ' 49% con una computadora portátil y el 61% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Llorente'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Joaquín'),
              ),
              body: ListView(
                children: [
                  Image.asset(
