...
class storytellingSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelHeredia.withSampleData() {
    return new storytellingSanRafaelHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'San Rafael es el cantón número 5 de la provincia de '
                        'Heredia, su cabecera es la ciudad de San Rafael. La '
                        'economía del cantón se basa en el comercio y los '
                        'servicios. Las principales actividades agropecuarias '
                        'son los cultivos de café, hortalizas y caña de azúcar '
                        'y la ganadería de leche. El cantón tiene varios '
                        'lugares turísticos de importancia, como el Monte de '
                        'la Cruz, el Bosque de la Hoja o Las Chorreras.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Rafael, San Josecito, Santiago, '
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de San Rafael se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 69% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 29%'
                        ' con pantalla de televisor, de este 29% el 93% de los '
                        'televisores son convencionales y el 58% son con cable '
                        'o satélite, el 45% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 48% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el cantón de San Rafael el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de San Rafael'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanRafaelCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_San_Rafael');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.munisrh.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://msrh.maps.arcgis.com/apps/webappviewer/index.'
                  'html?id=234062aea2f14ad196866751af726683');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://msrh.maps.arcgis.com/apps/webappviewer/'
                      'index.html?id=234062aea2f14ad196866751af726683');
                }
            ),
          ),
        ),
