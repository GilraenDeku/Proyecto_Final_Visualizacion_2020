...
class storytellingLosAngelesSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLosAngelesSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLosAngelesSanRafaelHeredia.withSampleData() {
    return new storytellingLosAngelesSanRafaelHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Los Ángeles se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 74% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 29%'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Los Ángeles el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Los Ángeles'),
              ),
              body: ListView(
                children: [
                  Image.asset(
