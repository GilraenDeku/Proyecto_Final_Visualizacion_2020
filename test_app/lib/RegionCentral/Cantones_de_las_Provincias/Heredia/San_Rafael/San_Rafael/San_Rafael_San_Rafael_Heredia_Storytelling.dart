...
class storytellingSanRafaelSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelSanRafaelHeredia.withSampleData() {
    return new storytellingSanRafaelSanRafaelHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el '
                        '87% de las '
                        ...
                        'o satélite, el 47% tienen una computadora de escritorio,'
                        ' 36% con una computadora portátil y el 49% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Rafael el'
