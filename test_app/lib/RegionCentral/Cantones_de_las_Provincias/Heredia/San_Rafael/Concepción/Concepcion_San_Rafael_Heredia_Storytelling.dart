...
class storytellingConcepcionSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingConcepcionSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingConcepcionSanRafaelHeredia.withSampleData() {
    return new storytellingConcepcionSanRafaelHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de San Rafael, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Concepción se observa que el '
                        '87% de las '
                        'casas cuentan con radio o equipos de sonido, el 72% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 27%'
                        ' con pantalla de televisor, de este 27% el 93% de los '
                        'televisores son convencionales y el 46% son con cable '
                        'o satélite, el 44% tienen una computadora de escritorio,'
                        ' 35% con una computadora portátil y el 42% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Concepción el'
