...
class storytellingSantiagoSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantiagoSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantiagoSanRafaelHeredia.withSampleData() {
    return new storytellingSantiagoSanRafaelHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santiago se observa que el '
                        '83% de las '
                        'casas cuentan con radio o equipos de sonido, el 68% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 32%'
                        ' con pantalla de televisor, de este 32% el 92% de los '
