...
class storytellingSanJosecitoSanRafaelHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJosecitoSanRafaelHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJosecitoSanRafaelHeredia.withSampleData() {
    return new storytellingSanJosecitoSanRafaelHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Josecito se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 26%'
                        ...
                        ' 33% con una computadora portátil y el 47% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Josecito el'
