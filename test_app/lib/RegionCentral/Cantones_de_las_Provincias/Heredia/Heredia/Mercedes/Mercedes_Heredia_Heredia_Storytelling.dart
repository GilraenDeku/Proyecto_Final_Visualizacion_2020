...
class storytellingMercedesHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMercedesHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMercedesHerediaHeredia.withSampleData() {
    return new storytellingMercedesHerediaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mercedes se observa que el 88% de las '
                        'casas cuentan con radio o equipos de sonido, el 76% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 39%'
                        ' con pantalla de televisor, de este 39% el 92% de los '
                        'televisores son convencionales y el 74% son con cable '
                        'o satélite, el 53% tienen una computadora de escritorio,'
                        ' 52% con una computadora portátil y el 65% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Mercedes'
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 52, Color(0xffEEBB40)),
      new LinearSales(8, 65, Color(0xff900C3F)),
    ];
