...
class storytellingHerediaHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingHerediaHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingHerediaHerediaHeredia.withSampleData() {
    return new storytellingHerediaHerediaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Heredia se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 72% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 33%'
                        ' con pantalla de televisor, de este 33% el 92% de los '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Heredia'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Heredia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
