...
class storytellingHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingHerediaHeredia.withSampleData() {
    return new storytellingHerediaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Heredia es un cantón que corresponde al número 1 y central'
                        ' de la provincia de la provincia de Heredia. En la '
                        'parte sur del cantón se localizan las zonas '
                        'industriales: La Valencia y el Barreal, las cuales '
                        'representan un 9% del área cantonal; lo mismo que las '
                        'instalaciones del Centro Nacional de Distribución de '
                        'Alimentos (CENADA); así como el Hospital San Vicente '
                        'de Paúl y la Clínica Dr. Francisco Bolaños. Las '
                        'primeras actividades agropecuarias de la parte sur del'
                        ' cantón son el cultivo del café y la ganadería.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Heredia, Mercedes, San Francisco, Ulloa y'
                        ' Vara Blanca',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Heredia se observa que el 86% de las '
                        'casas cuentan con radio o equipos de sonido, el 71% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 34%'
                        ' con pantalla de televisor, de este 34% el 91% de los '
                        'televisores son convencionales y el 67% son con cable '
                        'o satélite, el 48% tienen una computadora de escritorio,'
                        ' 43% con una computadora portátil y el 56% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Heredia'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Heredia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/HerediaCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(6, 48, Color(0xff8675A9)),
      new LinearSales(7, 43, Color(0xffEEBB40)),
      new LinearSales(8, 56, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Heredia');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.heredia.go.cr/en');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.heredia.go.cr/sites/default/files/ubicacion.pdf');
            }
        ),
