...
class storytellingVaraBlancaHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingVaraBlancaHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingVaraBlancaHerediaHeredia.withSampleData() {
    return new storytellingVaraBlancaHerediaHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Heredia, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Vara Blanca se observa que el 72% de las '
                        'casas cuentan con radio o equipos de sonido, el 51% con'
                        ' línea de teléfono fija, 80% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 84% de los '
                        'televisores son convencionales y el 24% son con cable '
                        'o satélite, el 17% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 18% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        ' y telefonía celular y fija siendo el teléfono celular '
                        'la tecnología de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Vara Blanca'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/HerediaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 84, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 24, Color(0xff00B7C2)),
