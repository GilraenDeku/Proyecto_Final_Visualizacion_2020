...
class storytellingSanFranciscoHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanFranciscoHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanFranciscoHerediaHeredia.withSampleData() {
    return new storytellingSanFranciscoHerediaHeredia(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de San Francisco'
