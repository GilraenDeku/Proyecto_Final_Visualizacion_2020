...
class storytellingUlloaHerediaHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingUlloaHerediaHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingUlloaHerediaHeredia.withSampleData() {
    return new storytellingUlloaHerediaHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Ulloa se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 72% con'
                        ' línea de teléfono fija, 95% con teléfono celular, 34%'
                        ...
                        ' 41% con una computadora portátil y el 55% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Ulloa'
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(7, 41, Color(0xffEEBB40)),
      new LinearSales(8, 55, Color(0xff900C3F)),
    ];
