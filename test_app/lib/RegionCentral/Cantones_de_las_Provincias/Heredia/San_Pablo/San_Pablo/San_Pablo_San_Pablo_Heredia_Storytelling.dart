...
class storytellingSanPabloSanPabloHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPabloSanPabloHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPabloSanPabloHeredia.withSampleData() {
    return new storytellingSanPabloSanPabloHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Pablo se observa que el '
                        '88% de las '
                        ...
                        'televisores son convencionales y el 70% son con cable '
                        'o satélite, el 52% tienen una computadora de escritorio,'
                        ' 48% con una computadora portátil y el 61% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de San Pablo el'
