...
class storytellingSanPabloHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPabloHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPabloHeredia.withSampleData() {
    return new storytellingSanPabloHeredia(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'San Pablo es el cantón número 9 de la provincia de '
                        'Heredia. Es el penúltimo cantón en extensión del país'
                        ' (luego de Flores) y logró su cantonato gracias al '
                        'cultivo del café, que le permitió entradas económicas'
                        ' grandes a los pocos pobladores que vivían en el '
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: San Pablo y Rincón de Sabanilla',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de San Pablo se observa que el 87% de las '
                        'casas cuentan con radio o equipos de sonido, el 75% con'
                        ' línea de teléfono fija, 94% con teléfono celular, 40%'
                        ' con pantalla de televisor, de este 40% el 90% de los '
                        'televisores son convencionales y el 72% son con cable '
                        'o satélite, el 52% tienen una computadora de escritorio,'
                        ' 50% con una computadora portátil y el 63% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el cantón de San Pablo el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de San Pablo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanPabloCanton.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_San_Pablo_(Costa_Rica)');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.sanpablo.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/562e619a0d7bb_Mapa%'
                  '20del%20Canton%20de%20San%20Pablo%2009,%20Distritos'
                  '%2001%20a%2002.pdf');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/562e619a0d7bb_'
                      'Mapa%20del%20Canton%20de%20San%20Pablo%2009,'
                      '%20Distritos%2001%20a%2002.pdf');
                }
            ),
          ),
        ),
