...
class storytellingRincondeSabanillaSanPabloHeredia extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingRincondeSabanillaSanPabloHeredia(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingRincondeSabanillaSanPabloHeredia.withSampleData() {
    return new storytellingRincondeSabanillaSanPabloHeredia(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de San Pablo, Provincia de Heredia, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Rincón de Sabanilla se observa que el '
                        '86% de las '
                        'casas cuentan con radio o equipos de sonido, el 77% con'
                        ' línea de teléfono fija, 95% con teléfono celular, 45%'
                        ' con pantalla de televisor, de este 45% el 87% de los '
                        'televisores son convencionales y el 76% son con cable '
                        'o satélite, el 52% tienen una computadora de escritorio,'
                        ' 54% con una computadora portátil y el 67% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Rincón de '
                        'Sabanilla el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Rincón de Sabanilla'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/SanPabloDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(3, 45, Color(0xff799351)),
