...
class storytellingConcepcionSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingConcepcionSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingConcepcionSanRamonAlajuela.withSampleData() {
    return new storytellingConcepcionSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Concepción se observa que el 77% de las '
                        'casas cuentan con radio o equipos de sonido, el 51% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 11%'
                        ' con pantalla de televisor, de este 11% el 94% de los '
                        'televisores son convencionales y el 4% son con cable o '
                        'satélite, el 29% tienen una computadora de escritorio,'
                        ' 11% con una computadora portátil y el 12% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Concepción'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoConcepcionCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 77, Color(0xffD54062)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220B2zvl2FLVTiSTnJJN2pBeFFaaVU%22%5D,%22action%22:'
                  '%22open%22,%22userId%22:%22112664887947659340096%22%7D');
            }
        ),
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                      '%5B%220B2zvl2FLVTiSTnJJN2pBeFFaaVU%22%5D,'
                      '%22action%22:%22open%22,%22userId%22:'
