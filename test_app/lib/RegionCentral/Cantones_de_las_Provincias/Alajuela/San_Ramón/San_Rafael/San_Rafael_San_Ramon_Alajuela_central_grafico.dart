...
class storytellingSanRafaelSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelSanRamonAlajuela.withSampleData() {
    return new storytellingSanRafaelSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 18% '
                        'con pantalla de televisor, de este 18% el 93% de los '
                        'televisores son convencionales y el 49% son con cable o'
                        ' satélite, el 31% tienen una computadora de escritorio,'
                        ' 29% con una computadora portátil y el 39% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanRafaelCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkNE80NjRQenBmZGc%22%5D,%22action%22:'
