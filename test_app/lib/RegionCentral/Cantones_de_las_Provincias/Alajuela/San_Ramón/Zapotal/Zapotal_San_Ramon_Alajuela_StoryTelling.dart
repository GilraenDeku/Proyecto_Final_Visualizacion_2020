...
class storytellingZapotalSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZapotalSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZapotalSanRamonAlajuela.withSampleData() {
    return new storytellingZapotalSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Zapotal se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 36% con'
                        ' línea de teléfono fija, 75% con teléfono celular, 4%'
                        ' con pantalla de televisor, de este 4% el 84% de los '
                        'televisores son convencionales y el 11% son con cable o'
                        ' satélite, el 6% tienen una computadora de escritorio,'
                        ' 4% con una computadora portátil y el 3% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'sonido y telefonía celular y fija siendo el teléfono'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Zapotal'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoZapotalCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 36, Color(0xffFFA36C)),
      new LinearSales(2, 75, Color(0xffEBDC87)),
      new LinearSales(3, 4, Color(0xff799351)),
      new LinearSales(4, 84, Color(0xff0F4C75)),
      new LinearSales(5, 11, Color(0xff00B7C2)),
      new LinearSales(6, 7, Color(0xff8675A9)),
      new LinearSales(7, 4, Color(0xffEEBB40)),
      new LinearSales(8, 3, Color(0xff900C3F)),
    ];
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkemY0MHdXTThadW8%22%5D,%22action%22'
