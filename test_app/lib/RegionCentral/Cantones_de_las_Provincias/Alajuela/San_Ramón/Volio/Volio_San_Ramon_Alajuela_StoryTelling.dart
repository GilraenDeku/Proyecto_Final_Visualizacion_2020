...
class storytellingVolioSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingVolioSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingVolioSanRamonAlajuela.withSampleData() {
    return new storytellingVolioSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Volio se observa que el 74% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 12%'
                        ' con pantalla de televisor, de este 12% el 93% de los '
                        'televisores son convencionales y el 35% son con cable o'
                        ' satélite, el 28% tienen una computadora de escritorio,'
                        ' 17% con una computadora portátil y el 21% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Volio '
                        'el uso de las tecnologías es bastante grande, excepto'
                        ' en las pantallas de televisión y computadora '
                        'portátil ya que se encuentran menores de 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Volio'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoVolioCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 93, Color(0xff0F4C75)),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkX1R1VzJBWHRvYTg%22%5D,%22action%22:'
