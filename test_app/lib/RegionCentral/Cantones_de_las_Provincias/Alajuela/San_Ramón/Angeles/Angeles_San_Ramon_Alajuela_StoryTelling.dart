...
class storytellingAngelesSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAngelesSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAngelesSanRamonAlajuela.withSampleData() {
    return new storytellingAngelesSanRamonAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de San Ramón, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Ángeles se observa que el 75% de las '
                        'casas cuentan con radio o equipos de sonido, el 50% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 11% '
                        'con pantalla de televisor, de este 11% el 89% de los '
                        'televisores son convencionales y el 32% son con cable o'
                        ' satélite, el 25% tienen una computadora de escritorio,'
                        ' 16% con una computadora portátil y el 19% de las casas'
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'mayoritariamente del uso de radios o equipos de sonido'
                        ' y telefonía celular y fija y computadora de escritorio'
                        ' siendo el teléfono celular la tecnología de mayor uso.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Ángeles'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoAngelesCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 75, Color(0xffD54062)),
      new LinearSales(1, 50, Color(0xffFFA36C)),
      new LinearSales(2, 85, Color(0xffEBDC87)),
      new LinearSales(3, 11, Color(0xff799351)),
      new LinearSales(4, 89, Color(0xff0F4C75)), //ff6538
      new LinearSales(5, 32, Color(0xff00B7C2)),
      new LinearSales(6, 25, Color(0xff8675A9)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/'
                  '?state=%7B%22ids%22:%5B%220B2zvl2FLVTiSVEVQTFlqQk'
                  'hUQ1U%22%5D,%22action%22:%22open%22,%22userI'
                  'd%22:%22112664887947659340096%22%7D');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('http://pdfviewer.softgateon.net/?state='
                      '%7B%22ids%22:%5B%220B2zvl2FLVTiSVEVQTFlqQkhUQ'
                      '1U%22%5D,%22action%22:%22open%22,%22userId%22'
                      ':%22112664887947659340096%22%7D');
                }
            ),
          ),
        ),
