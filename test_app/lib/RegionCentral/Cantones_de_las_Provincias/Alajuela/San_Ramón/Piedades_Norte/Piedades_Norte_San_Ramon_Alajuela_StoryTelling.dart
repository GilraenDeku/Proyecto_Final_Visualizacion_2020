...
class storytellingPiedadesNorteSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPiedadesNorteSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPiedadesNorteSanRamonAlajuela.withSampleData() {
    return new storytellingPiedadesNorteSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Piedades Norte se observa que el 80% de '
                        'las casas cuentan con radio o equipos de sonido, el 58%'
                        ' con línea de teléfono fija, 88% con teléfono celular, '
                        '16% con pantalla de televisor, de este 16% el 92% de '
                        'los televisores son convencionales y el 33% son con '
                        'cable o satélite, el 35% tienen una computadora de '
                        'escritorio, 23% con una computadora portátil y el 30% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        ' cuales van en un aumento considerable. A pesar de '
                        ...
                        'muy altos, lo que indica que en el distrito de '
                        'Piedades Norte el uso de las tecnologías es bastante'
                        ' grande, excepto en las pantallas de televisión ya que'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Piedades Norte'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoPiedadesNorteCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220B2zvl2FLVTiSR0p2NUpSdVdPUlk%22%5D,%22action%22:'
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22'
                      ':%5B%220B2zvl2FLVTiSR0p2NUpSdVdPUlk%22%5D,'
