...
class storytellingSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRamonAlajuela.withSampleData() {
    return new storytellingSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'San Ramón es el cantón número 2 de la provincia '
                        'de Alajuela, Su cabecera es la ciudad de San '
                        'Ramón. El distrito primero y la ciudad de '
                        'San Ramón es un importante centro comercial y '
                        'la ciudad más importante de la zona alta del '
                        'Valle Central fuera del Gran Área Metropolitana.'
                        ' Es la sede regional de numerosas entidades '
                        'públicas entre ellas la Sede de Occidente de'
                        ' la Universidad de Costa Rica y el Hospital '
                        'Carlos Luis Valverde Vega. Los principales'
                        ' cultivos agrícolas son el café y la caña '
                        'de azúcar. Otras actividades comerciales '
                        'en el centro de la ciudad están tiendas de '
                        'ropa, zapaterías, joyerías, venta de comidas, etc.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: San Ramón, Santiago, San Juan,'
                        ' Piedades Norte, Piedades Sur, San Rafael,'
                        ' San Isidro, Ángeles, Alfaro, Volio, '
                        'Concepción, Zapotal, San Lorenzo.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de San Ramón se observa que el 79% de las '
                        'casas cuentan con radio o equipos de sonido, el 57% '
                        'con línea de teléfono fija, 87% con teléfono celular,'
                        ' 17% con pantalla de televisor, de este 17% el 90% de'
                        ' los televisores son convencionales y el 41% son con '
                        'cable o satélite, el 33% tienen una computadora de '
                        'escritorio, 24% con una computadora portátil y el 31% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'solo a esta tecnología ya que los índices de uso de '
                        'las demás tecnologías son muy altos, lo que indica '
                        'que en la cantón de San Ramón el uso de las '
                        'tecnologías es bastante grande, excepto en las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de San Ramón'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/cantonSanRamon.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(1, 57, Color(0xffFFA36C)),
      ...
      new LinearSales(8, 31, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_San_Ram%C3%B3n');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://sites.google.com/sanramondigital.net/sanramongocr');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/545cdbe2df9a6_22.pdf');
            }
        ),
