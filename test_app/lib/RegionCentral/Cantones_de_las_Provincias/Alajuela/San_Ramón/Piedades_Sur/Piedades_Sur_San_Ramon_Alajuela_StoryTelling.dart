...
class storytellingPiedadesSurSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPiedadesSurSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPiedadesSurSanRamonAlajuela.withSampleData() {
    return new storytellingPiedadesSurSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Piedades Sur se observa que el 77% de las'
                        ' casas cuentan con radio o equipos de sonido, el 58% '
                        'con línea de teléfono fija, 81% con teléfono celular, '
                        '8% con pantalla de televisor, de este 8% el 90% de los '
                        'televisores son convencionales y el 8% son con cable o '
                        'satélite, el 27% tienen una computadora de escritorio, '
                        '15% con una computadora portátil y el 14% de las casas '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Piedades Sur'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoPiedadesSurCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkcHpzOUJUNVEyNmM%22%5D,%22action%22:'
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                      '%5B%220Bz7aWmQ3CzMkcHpzOUJUNVEyNmM%22%5D,'
