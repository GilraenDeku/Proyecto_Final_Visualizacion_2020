...
class storytellingSanRamonSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRamonSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRamonSanRamonAlajuela.withSampleData() {
    return new storytellingSanRamonSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Ramón se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 67% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 27%'
                        ' con pantalla de televisor, de este 27% el 91% de los '
                        'televisores son convencionales y el 73% son con cable o'
                        ' satélite, el 44% tienen una computadora de escritorio,'
                        ' 40% con una computadora portátil y el 52% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Ramón'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San Ramón'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanRamonCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 91, Color(0xff0F4C75)),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkTVc1eE5LWk92bEk%22%5D,%22action%22:'
