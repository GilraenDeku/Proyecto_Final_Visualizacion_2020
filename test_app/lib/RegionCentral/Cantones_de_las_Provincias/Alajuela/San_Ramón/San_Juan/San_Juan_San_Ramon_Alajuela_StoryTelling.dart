...
class storytellingSanJuanSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuanSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuanSanRamonAlajuela.withSampleData() {
    return new storytellingSanJuanSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 56% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 21% '
                        'con pantalla de televisor, de este 21% el 91% de los '
                        'televisores son convencionales y el 50% son con cable o '
                        'satélite, el 37% tienen una computadora de escritorio, '
                        '27% con una computadora portátil y el 37% de las casas '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Juan '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanJuanCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 92, Color(0xff0F4C75)),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkNTVTWC03N2pnZ3c%22%5D,%22action%22:'
