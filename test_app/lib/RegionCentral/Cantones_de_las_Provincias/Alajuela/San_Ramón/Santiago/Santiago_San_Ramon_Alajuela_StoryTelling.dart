...
class storytellingSantiagoSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantiagoSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantiagoSanRamonAlajuela.withSampleData() {
    return new storytellingSantiagoSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santiago se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 53% con'
                        ' línea de teléfono fija, 82% con teléfono celular, 15%'
                        ' con pantalla de televisor, de este 15% el 89% de los '
                        'televisores son convencionales y el 30% son con cable o'
                        ' satélite, el 30% tienen una computadora de escritorio,'
                        ' 23% con una computadora portátil y el 28% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el distrito de Santiago'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSantiagoCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(4, 89, Color(0xff0F4C75)),
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/?state=%7B%22ids%22:'
                  '%5B%220Bz7aWmQ3CzMkWDNxUFNpdjN2Q2s%22%5D,%22action%22:'
