...
class storytellingAlfaroSanRamonAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlfaroSanRamonAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlfaroSanRamonAlajuela.withSampleData() {
    return new storytellingAlfaroSanRamonAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Alfaro se observa que el 79% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% '
                        'con línea de teléfono fija, 91% con teléfono celular,'
                        ' 21% con pantalla de televisor, de este 21% el 91% de'
                        ' los televisores son convencionales y el 45% son con '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en la distrito de Alfaro el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Alfaro'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoAlfaroCantonSanRamon.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://pdfviewer.softgateon.net/'
                  '?state=%7B%22ids%22:%5B%220Bz7aWmQ3CzMkdS1lVTFy'
                  'VHhReUk%22%5D,%22action%22:%22open%22,%22userId%22'
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  ...
                  launch('http://pdfviewer.softgateon.net/'
                      '?state=%7B%22ids%22:%5B%220Bz7aWmQ3CzMkdS1lVTFy'
                      'VHhReUk%22%5D,%22action%22:%22open%22,'
                      '%22userId%22:%22112664887947659340096%22%7D');
                }
            ),
          ),
        ),
