...
class storytellingSantiagoPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantiagoPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantiagoPalmaresAlajuela.withSampleData() {
    return new storytellingSantiagoPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santiago se observa que el 78% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 12% '
                        'con pantalla de televisor, de este 12% el 96% de los '
                        'televisores son convencionales y el 8% son con cable o '
                        'satélite, el 32% tienen una computadora de escritorio, '
                        '19% con una computadora portátil y el 20% de las casas '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Santiago el '
                        'uso de las tecnologías es bastante grande, excepto en '
                        'las pantallas de televisión y computadora portátiles ya'
                        ' que se encuentran menores de 20% de disponibilidad de '
