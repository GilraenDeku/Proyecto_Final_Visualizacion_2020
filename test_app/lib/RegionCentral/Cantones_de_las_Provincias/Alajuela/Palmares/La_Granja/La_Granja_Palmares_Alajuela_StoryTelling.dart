...
class storytellingLaGranjaPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaGranjaPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaGranjaPalmaresAlajuela.withSampleData() {
    return new storytellingLaGranjaPalmaresAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Palmares, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Granja se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 68% con'
                        ' línea de teléfono fija, 89% con teléfono celular, 23% '
                        'con pantalla de televisor, de este 23% el 93% de los '
                        'televisores son convencionales y el 44% son con cable o'
                        ' satélite, el 47% tienen una computadora de escritorio,'
                        ' 31% con una computadora portátil y el 44% de las casas'
                        ' cuentan con acceso de internet.En el distrito de La '
                        'Granja se observa que el 82% de las casas cuentan con '
                        'radio o equipos de sonido, el 68% con línea de teléfono'
                        ' fija, 89% con teléfono celular, 23% con pantalla de '
                        'televisor, de este 23% el 93% de los televisores son '
                        'convencionales y el 44% son con cable o satélite, el '
                        '47% tienen una computadora de escritorio, 31% con una '
                        'computadora portátil y el 44% de las casas cuentan con '
                        'acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de La Granja '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Granja'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/palmaresDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 44, Color(0xff00B7C2)),
      new LinearSales(6, 47, Color(0xff8675A9)),
      new LinearSales(7, 31, Color(0xffEEBB40)),
      new LinearSales(8, 44, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://drive.google.com/file/d/'
                  '1rg5osRqWMPzuSNHQFj29euTLO17xNHIT/view');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://drive.google.com/file/d/1rg5osRqWMPzu'
                      'SNHQFj29euTLO17xNHIT/view');
                }
            ),
          ),
        ),
