...
class storytellingPalmaresPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPalmaresPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPalmaresPalmaresAlajuela.withSampleData() {
    return new storytellingPalmaresPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Palmares se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 68% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 25% '
                        'con pantalla de televisor, de este 25% el 93% de los '
                        'televisores son convencionales y el 59% son con cable o'
                        ' satélite, el 41% tienen una computadora de escritorio,'
                        ' 33% con una computadora portátil y el 42% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Palmares '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Palmares'),
              ),
              body: ListView(
                children: [
                  Image.asset(
