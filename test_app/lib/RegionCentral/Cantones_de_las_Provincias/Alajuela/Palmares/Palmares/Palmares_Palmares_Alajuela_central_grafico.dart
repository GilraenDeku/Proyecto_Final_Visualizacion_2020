...
class GraficaRegionCentralPalmaresPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralPalmaresPalmaresAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralPalmaresPalmaresAlajuela.withSampleData() {
    return new GraficaRegionCentralPalmaresPalmaresAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Palmares'),
              ),
              body: TabBarView(
                children: [
                  Padding(
