...
class storytellingBuenosAiresPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBuenosAiresPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBuenosAiresPalmaresAlajuela.withSampleData() {
    return new storytellingBuenosAiresPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Buenos Aires se observa que el 84% de '
                        'las casas cuentan con radio o equipos de sonido, el 69%'
                        ' con línea de teléfono fija, 90% con teléfono celular, '
                        '27% con pantalla de televisor, de este 27% el 92% de '
                        'los televisores son convencionales y el 50% son con '
                        'cable o satélite, el 44% tienen una computadora de '
                        'escritorio, 34% con una computadora portátil y el 43% de'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Buenos Aires el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Buenos Aires'),
              ),
              body: ListView(
                children: [
                  Image.asset(
