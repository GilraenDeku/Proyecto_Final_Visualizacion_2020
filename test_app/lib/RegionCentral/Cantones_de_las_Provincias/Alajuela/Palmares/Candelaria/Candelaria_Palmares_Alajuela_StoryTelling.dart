...
class storytellingCandelariaPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCandelariaPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCandelariaPalmaresAlajuela.withSampleData() {
    return new storytellingCandelariaPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Candelaria se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 50% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 8% '
                        'con pantalla de televisor, de este 8% el 94% de los '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Candelaria'),
              ),
              body: ListView(
                children: [
                  Image.asset(
