...
class storytellingEsquipulasPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingEsquipulasPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingEsquipulasPalmaresAlajuela.withSampleData() {
    return new storytellingEsquipulasPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Esquipulas se observa que el 78% de las '
                        ...
                        'televisores son convencionales y el 34% son con cable o'
                        ' satélite, el 32% tienen una computadora de escritorio,'
                        ' 19% con una computadora portátil y el 26% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Esquipulas '
                        'el uso de las tecnologías es bastante grande, excepto '
                        'en las pantallas de televisión y computadora portátiles'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Esquipulas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 34, Color(0xff00B7C2)),
