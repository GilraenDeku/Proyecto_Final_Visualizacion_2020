...
class storytellingZaragozaPalmaresAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZaragozaPalmaresAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZaragozaPalmaresAlajuela.withSampleData() {
    return new storytellingZaragozaPalmaresAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Zaragoza se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 70% con'
                        ' línea de teléfono fija, 86% con teléfono celular, 20% '
                        'con pantalla de televisor, de este 20% el 94% de los '
                        'televisores son convencionales y el 36% son con cable o'
                        ' satélite, el 41% tienen una computadora de escritorio,'
                        ' 28% con una computadora portátil y el 34% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Zaragoza el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Zaragoza'),
              ),
              body: ListView(
                children: [
                  Image.asset(
