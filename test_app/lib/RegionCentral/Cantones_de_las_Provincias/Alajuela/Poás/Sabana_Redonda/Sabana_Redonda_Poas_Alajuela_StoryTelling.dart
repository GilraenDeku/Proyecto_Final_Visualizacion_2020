...
class storytellingSabanaRedondaPoasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSabanaRedondaPoasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSabanaRedondaPoasAlajuela.withSampleData() {
    return new storytellingSabanaRedondaPoasAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Poás, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sabana Redonda se observa que el 74% de '
                        'las casas cuentan con radio o equipos de sonido, el 53%'
                        ' con línea de teléfono fija, 81% con teléfono celular, '
                        '8% con pantalla de televisor, de este 8% el 92% de los '
                        'televisores son convencionales y el 6% son con cable o '
                        'satélite, el 20% tienen una computadora de escritorio, '
                        '10% con una computadora portátil y el 10% de las casas '
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        ' telefonía celular y fija, y computadora de escritorio '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Sabana Redonda'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/poasDistritos.jpeg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://poasdigital.go.cr/index.php/m-conozcanos'
                  '/mn-micanton/mn-historiacanton');
            }
        ),
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('http://poasdigital.go.cr/index.php/'
                      'm-conozcanos/mn-micanton/mn-historiacanton');
                }
            ),
          ),
        ),
