...
class storytellingSanJuanPoasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuanPoasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuanPoasAlajuela.withSampleData() {
    return new storytellingSanJuanPoasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 18%'
                        ' con pantalla de televisor, de este 18% el 93% de los '
                        'televisores son convencionales y el 28% son con cable o'
