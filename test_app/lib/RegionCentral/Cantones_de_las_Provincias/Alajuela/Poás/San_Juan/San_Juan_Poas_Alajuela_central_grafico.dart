...
class GraficaRegionCentralSanJuanPoasAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralSanJuanPoasAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralSanJuanPoasAlajuela.withSampleData() {
    return new GraficaRegionCentralSanJuanPoasAlajuela(
      _centralData(),
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(28, Color(0xffc70039), 'TV Cable/Satelital'),
