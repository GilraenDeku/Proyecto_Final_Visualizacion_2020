...
class storytellingSanRafaelPoasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelPoasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelPoasAlajuela.withSampleData() {
    return new storytellingSanRafaelPoasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 78% de las '
                        'casas cuentan con radio o equipos de sonido, el 56% con'
                        ' línea de teléfono fija, 86% con teléfono celular, 16% '
                        'con pantalla de televisor, de este 16% el 92% de los '
                        'televisores son convencionales y el 24% son con cable o'
                        ' satélite, el 30% tienen una computadora de escritorio,'
                        ' 22% con una computadora portátil y el 18% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'que los índices de uso de las demás tecnologías son muy'
                        ' altos, lo que indica que en el distrito de San Rafael '
                        'el uso de las tecnologías es bastante grande, excepto '
                        'en las pantallas de televisión e internet ya que se '
