...
class storytellingCarrillosPoasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCarrillosPoasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCarrillosPoasAlajuela.withSampleData() {
    return new storytellingCarrillosPoasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Carrillos se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 14%'
                        ' con pantalla de televisor, de este 14% el 95% de los '
                        'televisores son convencionales y el 42% son con cable '
                        'o satélite, el 35% tienen una computadora de escritorio,'
                        ' 20% con una computadora portátil y el 25% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Carrillo el uso de'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Carrillos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
