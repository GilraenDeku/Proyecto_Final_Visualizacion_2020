...
class storytellingSarchiSurValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSarchiSurValverdeVegaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSarchiSurValverdeVegaAlajuela.withSampleData() {
    return new storytellingSarchiSurValverdeVegaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sarchí Sur se observa que el 81% de las '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Sarchí Sur el'
                        ' uso de las tecnologías es bastante grande, excepto en '
                        'las pantallas de televisión ya '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Sarchí Sur'),
              ),
              body: ListView(
                children: [
                  Image.asset(
