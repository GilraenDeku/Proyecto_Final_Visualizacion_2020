...
class GraficaRegionCentralSarchiSurValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralSarchiSurValverdeVegaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralSarchiSurValverdeVegaAlajuela.withSampleData() {
    return new GraficaRegionCentralSarchiSurValverdeVegaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Sarchí Sur'),
              ),
              body: TabBarView(
                children: [
                  Padding(
