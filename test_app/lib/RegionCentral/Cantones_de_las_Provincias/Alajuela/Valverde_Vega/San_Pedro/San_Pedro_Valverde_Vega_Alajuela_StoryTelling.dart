...
class storytellingSanPedroValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanPedroValverdeVegaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanPedroValverdeVegaAlajuela.withSampleData() {
    return new storytellingSanPedroValverdeVegaAlajuela(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de San Pedro se observa que el 84% de las '
                        ...
                        ' línea de teléfono fija, 83% con teléfono celular, 11% '
                        ...
                        ' 18% con una computadora portátil y el 22% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'las pantallas de televisión y computadora portátil ya '
