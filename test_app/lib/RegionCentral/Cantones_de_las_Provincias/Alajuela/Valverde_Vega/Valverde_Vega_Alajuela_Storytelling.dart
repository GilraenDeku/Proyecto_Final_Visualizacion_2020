...
class storytellingValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingValverdeVegaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingValverdeVegaAlajuela.withSampleData() {
    return new storytellingValverdeVegaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Sarchí es el cantón número 14 de la provincia de Alajuela,'
                        ' La economía del cantón se basa principalmente en'
                        ' la agricultura, la ganadería y el turismo. Es de'
                        ' gran importancia la pequeña industria artesanal '
                        'a partir de la fabricación de muebles de madera.'
                        ' Sarchí, y en especial su cabecera, la ciudad '
                        'del mismo nombre, son considerados la "Cuna de '
                        'la Artesanía Costarricense", debido al trabajo '
                        'artístico en maderas preciosas, en especial la '
                        'decoración de carretas típicas, consideradas '
                        'icono de la cultura costarricense y declaradas '
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Sarchí Norte, Sarchí Sur, Toro Amarillo, '
                        'San Pedro, Rodríguez',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Valverde Vega se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 15%'
                        ' con pantalla de televisor, de este 15% el 92% de los '
                        'televisores son convencionales y el 25% son con cable o'
                        ' satélite, el 30% tienen una computadora de escritorio,'
                        ' 22% con una computadora portátil y el 26% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'muy altos, lo que indica que en el cantón de Valverde'
                        ' Vega el uso de las tecnologías es bastante grande, '
                        'excepto en las pantallas de televisión ya que se '
                        'encuentran menores de 20% de disponibilidad de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Valverde Vega'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/cantonValverdeVega.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Sarch%C3%AD');
            }
        ),
