...
class storytellingSarchiNorteValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSarchiNorteValverdeVegaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSarchiNorteValverdeVegaAlajuela.withSampleData() {
    return new storytellingSarchiNorteValverdeVegaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sarchí Norte se observa que el 82% de las'
                        ...
                        'escritorio, 25% con una computadora portátil y el 30% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Sarchí Norte el'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Sarchí Norte'),
              ),
              body: ListView(
                children: [
                  Image.asset(
