...
class GraficaRegionCentralSarchiNorteValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralSarchiNorteValverdeVegaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralSarchiNorteValverdeVegaAlajuela.withSampleData() {
    return new GraficaRegionCentralSarchiNorteValverdeVegaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Sarchí Norte'),
              ),
              body: TabBarView(
                children: [
                  Padding(
