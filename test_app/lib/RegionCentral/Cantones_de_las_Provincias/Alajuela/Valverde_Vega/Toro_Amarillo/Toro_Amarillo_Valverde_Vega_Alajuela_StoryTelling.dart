...
class storytellingToroAmarilloValverdeVegaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingToroAmarilloValverdeVegaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingToroAmarilloValverdeVegaAlajuela.withSampleData() {
    return new storytellingToroAmarilloValverdeVegaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Toro Amarillo se observa que el 65% de las '
                        'casas cuentan con radio o equipos de sonido, el 43% con'
                        ' línea de teléfono fija, 78% con teléfono celular, 8% '
                        'con pantalla de televisor, de este 8% el 84% de los '
                        'televisores son convencionales y el 34% son con cable o'
                        ' satélite, el 9% tienen una computadora de escritorio,'
                        ' 13% con una computadora portátil y el 9% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Toro Amarillo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      new LinearSales(0, 65, Color(0xffD54062)),
