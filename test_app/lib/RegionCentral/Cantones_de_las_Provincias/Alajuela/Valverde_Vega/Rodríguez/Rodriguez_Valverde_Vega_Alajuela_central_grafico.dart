          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Rodríguez se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% con'
                        ' línea de teléfono fija, 85% con teléfono celular, 15% '
                        'con pantalla de televisor, de este 15% el 93% de los '
                        'televisores son convencionales y el 14% son con cable o'
                        ' satélite, el 31% tienen una computadora de escritorio,'
                        ' 22% con una computadora portátil y el 27% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Rodríguez el'
