...
class GraficaRegionCentralGuacimaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralGuacimaAlajuelaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralGuacimaAlajuelaAlajuela.withSampleData() {
    return new GraficaRegionCentralGuacimaAlajuelaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito La Guácima'),
              ),
              body: TabBarView(
                children: [
                  Padding(
