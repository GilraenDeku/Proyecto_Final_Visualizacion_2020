...
class storytellingLaGuacimaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaGuacimaAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaGuacimaAlajuelaAlajuela.withSampleData() {
    return new storytellingLaGuacimaAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Guácima se observa que el 78% de las'
                        ' casas cuentan con radio o equipos de sonido, el 57% '
                        'con línea de teléfono fija, 90% con teléfono celular,'
                        ' 19% con pantalla de televisor, de este 19% el 93% de'
                        ' los televisores son convencionales y el 43% son con '
                        'cable o satélite, el 31% tienen una computadora de '
                        'escritorio, 22% con una computadora portátil y el 30% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de La Guácima el uso de las '
                        'tecnologías es bastante grande, excepto en las pantallas'
                        ' de televisión ya que se encuentran menores de 20% de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Guácima'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoLaGuacimaCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 43, Color(0xff00B7C2)),
