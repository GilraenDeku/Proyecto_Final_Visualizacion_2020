...
class storytellingAlajuelaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlajuelaAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlajuelaAlajuelaAlajuela.withSampleData() {
    return new storytellingAlajuelaAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Alajuela se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 70% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 30% '
                        'con pantalla de televisor, de este 30% el 91% de los '
                        'televisores son convencionales y el 63% son con cable o'
                        ' satélite, el 43% tienen una computadora de escritorio,'
                        ' 37% con una computadora portátil y el 46% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Alajuela el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Alajuela'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
