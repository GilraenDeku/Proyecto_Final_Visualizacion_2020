...
class GraficaRegionCentralSabanillaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralSabanillaAlajuelaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralSabanillaAlajuelaAlajuela.withSampleData() {
    return new GraficaRegionCentralSabanillaAlajuelaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Sabanilla'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(15, Color(0xffc70039), 'TV Cable/Satelital'),
