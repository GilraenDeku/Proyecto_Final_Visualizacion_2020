...
class storytellingSabanillaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSabanillaAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSabanillaAlajuelaAlajuela.withSampleData() {
    return new storytellingSabanillaAlajuelaAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Alajuela, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Sabanilla se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 13% '
                        'con pantalla de televisor, de este 13% el 93% de los '
                        'televisores son convencionales y el 15% son con cable o'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSabanillaCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://mapas.munialajuela.go.cr/portal/apps/'
                  'webappviewer/index.html?id=e64328edbbb14f498d07b5508ffa3e2a');
            }
        ),
