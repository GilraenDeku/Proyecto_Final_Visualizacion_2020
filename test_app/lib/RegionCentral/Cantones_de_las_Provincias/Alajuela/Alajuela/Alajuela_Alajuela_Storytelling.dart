...
class storytellingAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlajuelaAlajuela.withSampleData() {
    return new storytellingAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Alajuela se observa que el 81% de las casas'
                        ' cuentan con radio o equipos de sonido, el 63% con línea'
                        ' de teléfono fija, 90% con teléfono celular, 24% con '
                        'pantalla de televisor, de este 24% el 92% de los '
                        'televisores son convencionales y el 49% son con cable o'
                        ' satélite, el 37% tienen una computadora de escritorio,'
                        ' 29% con una computadora portátil y el 37% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el cantón de Alajuela el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Alajuela'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/CantonAlajuela.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
