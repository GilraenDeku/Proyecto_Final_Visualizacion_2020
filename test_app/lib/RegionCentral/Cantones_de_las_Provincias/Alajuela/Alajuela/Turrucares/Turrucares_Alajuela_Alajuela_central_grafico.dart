...
class GraficaRegionCentralTurrucaresAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralTurrucaresAlajuelaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralTurrucaresAlajuelaAlajuela.withSampleData() {
    return new GraficaRegionCentralTurrucaresAlajuelaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Turrúcares'),
              ),
              body: TabBarView(
                children: [
                  Padding(
  ...
  static List<charts.Series<centralData, String>> _centralData() {
    final central = [
      ...
      new centralData(18, Color(0xfffbfd8a), 'TV'),
