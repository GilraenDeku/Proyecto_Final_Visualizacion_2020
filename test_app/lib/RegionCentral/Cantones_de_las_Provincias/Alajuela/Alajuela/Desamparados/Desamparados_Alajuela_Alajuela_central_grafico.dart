...
class GraficaRegionCentralDesamparadosAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralDesamparadosAlajuelaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralDesamparadosAlajuelaAlajuela.withSampleData() {
    return new GraficaRegionCentralDesamparadosAlajuelaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Desamparados'),
              ),
              body: TabBarView(
                children: [
                  Padding(
