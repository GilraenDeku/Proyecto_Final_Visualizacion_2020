...
class storytellingRioSegundoAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingRioSegundoAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingRioSegundoAlajuelaAlajuela.withSampleData() {
    return new storytellingRioSegundoAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Río Segundo se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 89% con teléfono celular, 22% '
                        'con pantalla de televisor, de este 22% el 93% de los '
                        'televisores son convencionales y el 49% son con cable o'
                        ' satélite, el 25% tienen una computadora de escritorio,'
                        ' 26% con una computadora portátil y el 34% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Río Segundo el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Río Segundo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoRioSegundoCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 34, Color(0xff900C3F)),
    ];
