...
class storytellingSanAntonioAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanAntonioAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanAntonioAlajuelaAlajuela.withSampleData() {
    return new storytellingSanAntonioAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Antonio se observa que el 81% de las '
                        ...
                        ' 25% con una computadora portátil y el 36% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Antonio,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanAntonioCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
