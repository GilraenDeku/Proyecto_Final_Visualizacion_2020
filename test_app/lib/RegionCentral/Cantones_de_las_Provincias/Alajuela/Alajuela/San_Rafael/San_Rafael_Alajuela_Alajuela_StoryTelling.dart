...
class storytellingSanRafaelAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanRafaelAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanRafaelAlajuelaAlajuela.withSampleData() {
    return new storytellingSanRafaelAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Rafael se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 57% con'
                        ' línea de teléfono fija, 92% con teléfono celular, 26% '
                        'con pantalla de televisor, de este 26% el 92% de los '
                        'televisores son convencionales y el 89% son con cable o'
                        ' satélite, el 37% tienen una computadora de escritorio,'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Rafael,'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanRafaelCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 55, Color(0xff00B7C2)),
