...
class storytellingSanIsidroAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroAlajuelaAlajuela.withSampleData() {
    return new storytellingSanIsidroAlajuelaAlajuela(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En el distrito de San Isidro se observa que el 81% de las '
                        ...
                        ' línea de teléfono fija, 87% con teléfono celular, 19% '
                        'con pantalla de televisor, de este 19% el 92% de los '
                        'televisores son convencionales y el 33% son con cable o'
                        ' satélite, el 32% tienen una computadora de escritorio,'
                        ' 24% con una computadora portátil y el 26% de las casas'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanIsidroCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
