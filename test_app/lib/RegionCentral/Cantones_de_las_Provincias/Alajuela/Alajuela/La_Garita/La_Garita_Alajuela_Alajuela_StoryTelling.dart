...
class storytellingLaGaritaAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingLaGaritaAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingLaGaritaAlajuelaAlajuela.withSampleData() {
    return new storytellingLaGaritaAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de La Garita se observa que el 83% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 25% '
                        'con pantalla de televisor, de este 25% el 91% de los '
                        'televisores son convencionales y el 45% son con cable o'
                        ' satélite, el 37% tienen una computadora de escritorio,'
                        ' 31% con una computadora portátil y el 39% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de La Garita el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de La Garita'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoLaGaritaCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
