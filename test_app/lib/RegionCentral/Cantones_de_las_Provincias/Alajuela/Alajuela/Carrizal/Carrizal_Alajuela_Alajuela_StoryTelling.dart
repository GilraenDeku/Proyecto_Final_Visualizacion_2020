...
class storytellingCarrizalAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCarrizalAlajuelaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCarrizalAlajuelaAlajuela.withSampleData() {
    return new storytellingCarrizalAlajuelaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Carrizal se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 62% con'
                        ' línea de teléfono fija, 91% con teléfono celular, 16% '
                        'con pantalla de televisor, de este 16% el 93% de los '
                        'televisores son convencionales y el 37% son con cable o'
                        ' satélite, el 33% tienen una computadora de escritorio,'
                        ' 20% con una computadora portátil y el 26% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Carrizal el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Carrizal'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoCarrizalCantonAlajuela.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 37, Color(0xff00B7C2)),
