...
class GraficaRegionCentralCarrizalAlajuelaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralCarrizalAlajuelaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralCarrizalAlajuelaAlajuela.withSampleData() {
    return new GraficaRegionCentralCarrizalAlajuelaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Carrizal'),
              ),
              body: TabBarView(
                children: [
                  Padding(
