...
class storytellingNaranjoNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingNaranjoNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingNaranjoNaranjoAlajuela.withSampleData() {
    return new storytellingNaranjoNaranjoAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Naranjo se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 21% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Naranjo el uso'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Naranjo'),
              ),
              body: ListView(
                children: [
                  Image.asset(
