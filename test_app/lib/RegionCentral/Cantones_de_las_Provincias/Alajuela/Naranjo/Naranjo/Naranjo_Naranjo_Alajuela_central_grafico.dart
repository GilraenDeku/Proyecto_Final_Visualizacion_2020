...
class GraficaRegionCentralNaranjoNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralNaranjoNaranjoAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralNaranjoNaranjoAlajuela.withSampleData() {
    return new GraficaRegionCentralNaranjoNaranjoAlajuela(
      _centralData(),
