...
class storytellingSanJeronimoNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJeronimoNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJeronimoNaranjoAlajuela.withSampleData() {
    return new storytellingSanJeronimoNaranjoAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Jerónimo se observa que el 80% de las'
                        ...
                        'televisores son convencionales y el 27% son con cable o'
                        ' satélite, el 26% tienen una computadora de escritorio,'
                        ' 15% con una computadora portátil y el 20% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Jerónimo el '
                        'uso de las tecnologías es bastante grande, excepto en '
                        'las pantallas de televisión, computadora portátil'
                        ' ya que se encuentran menores de 20% de '
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 27, Color(0xff00B7C2)),
