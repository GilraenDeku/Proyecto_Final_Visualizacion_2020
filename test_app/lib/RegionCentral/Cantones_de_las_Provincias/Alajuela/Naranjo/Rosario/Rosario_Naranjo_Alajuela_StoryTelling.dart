...
class storytellingRosarioNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingRosarioNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingRosarioNaranjoAlajuela.withSampleData() {
    return new storytellingRosarioNaranjoAlajuela(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Rosario el '
                        'uso de las tecnologías es bastante grande, excepto en '
                        'las pantallas de televisión, computadora portátil e '
                        'internet ya que se encuentran menores de 20% de '
