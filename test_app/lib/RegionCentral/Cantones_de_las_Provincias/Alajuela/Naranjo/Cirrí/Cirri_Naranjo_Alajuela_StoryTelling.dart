...
class storytellingCirriNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingCirriNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingCirriNaranjoAlajuela.withSampleData() {
    return new storytellingCirriNaranjoAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Naranjo, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Cirrí se observa que el 78% de las casas '
                        'cuentan con radio o equipos de sonido, el 57% con línea'
                        ' de teléfono fija, 86% con teléfono celular, 9% con '
                        'pantalla de televisor, de este 9% el 93% de los '
                        'televisores son convencionales y el 23% son con cable o'
                        ' satélite, el 26% tienen una computadora de escritorio,'
                        ' 18% con una computadora portátil y el 21% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Cirrí el uso'
                        ' de las tecnologías es bastante grande, excepto en las '
                        'pantallas de televisión y computadora portátil ya que '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Cirrí'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/naranjoDistritos.jpeg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 23, Color(0xff00B7C2)),
      new LinearSales(6, 26, Color(0xff8675A9)),
      new LinearSales(7, 18, Color(0xffEEBB40)),
      new LinearSales(8, 21, Color(0xff900C3F)),
    ];
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://onedrive.live.com/?authkey=%21ABc6VOEt7sQKy'
                  'ss&cid=416DD1D5614C9EDC&id=416DD1D5614C9EDC%21487&par'
                  'Id=416DD1D5614C9EDC%21126&o=OneUp');
            }
        ),
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://onedrive.live.com/?authkey=%21ABc6VOEt7sQKy'
                      'ss&cid=416DD1D5614C9EDC&id=416DD1D5614C9EDC%'
                      '21487&parId=416DD1D5614C9EDC%21126&o=OneUp');
                }
            ),
          ),
        ),
