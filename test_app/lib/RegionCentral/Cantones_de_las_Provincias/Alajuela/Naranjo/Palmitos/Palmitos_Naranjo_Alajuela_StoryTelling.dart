...
class storytellingPalmitosNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPalmitosNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPalmitosNaranjoAlajuela.withSampleData() {
    return new storytellingPalmitosNaranjoAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Palmitos se observa que el 81% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% con'
                        ' línea de teléfono fija, 86% con teléfono celular, 15% '
                        'con pantalla de televisor, de este 15% el 94% de los '
                        'televisores son convencionales y el 39% son con cable o'
                        ' satélite, el 36% tienen una computadora de escritorio,'
                        ' 25% con una computadora portátil y el 29% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Palmitos el uso'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Palmitos'),
              ),
              body: ListView(
                children: [
                  Image.asset(
