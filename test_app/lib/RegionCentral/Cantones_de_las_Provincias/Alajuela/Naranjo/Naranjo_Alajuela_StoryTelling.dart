          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Naranjo se observa que el 80% de las casas '
                        'cuentan con radio o equipos de sonido, el 61% con línea'
                        ' de teléfono fija, 87% con teléfono celular, 16% con '
                        'pantalla de televisor, de este 16% el 93% de los '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el cantón de Naranjo '
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/58123b4dc9089_'
                  'Mapa%20del%20Canton%20Naranjo%2006%20'
        ...
        Container(
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/58123b4dc9089_Mapa'
                      '%20del%20Canton%20Naranjo%2006%20Distrito'
                      '%2001%20a%2008.pdf');
                }
            ),
          ),
