...
class storytellingSanJuanNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJuanNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJuanNaranjoAlajuela.withSampleData() {
    return new storytellingSanJuanNaranjoAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Juan se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 66% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 16% '
                        'con pantalla de televisor, de este 16% el 94% de los '
                        'televisores son convencionales y el 21% son con cable o'
                        ' satélite, el 35% tienen una computadora de escritorio,'
                        ' 25% con una computadora portátil y el 27% de las casas'
