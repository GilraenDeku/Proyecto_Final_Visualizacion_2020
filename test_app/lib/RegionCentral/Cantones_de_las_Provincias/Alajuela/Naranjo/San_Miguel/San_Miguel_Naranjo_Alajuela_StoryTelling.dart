...
class storytellingSanMiguelNaranjoAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanMiguelNaranjoAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanMiguelNaranjoAlajuela.withSampleData() {
    return new storytellingSanMiguelNaranjoAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Miguel se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 51% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 13% '
                        'con pantalla de televisor, de este 13% el 92% de los '
                        'televisores son convencionales y el 20% son con cable o'
                        ' satélite, el 27% tienen una computadora de escritorio,'
                        ' 19% con una computadora portátil y el 21% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de San Miguel el '
