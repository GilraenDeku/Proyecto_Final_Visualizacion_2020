...
class storytellingZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZarceroAlajuela.withSampleData() {
    return new storytellingZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Zarcero es el cantón número 11 de la provincia de '
                        'Alajuela. Su cabecera es la ciudad de Zarcero.'
                        ' La economía del cantón se basa en la agricultura,'
                        ' principalmente café y hortalizas como la zanahoria'
                        ' y el chiverre; una fuerte producción de ganadería'
                        ' y sus derivados, destacándose la "natilla Zarcero",'
                        ' producto local que aspira a obtener la denominación'
                        ' de origen; y pequeñas industrias en el campo de '
                        'postres, panes, y diferentes productos basados'
                        ' en la agricultura.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Zarcero, Laguna, Tapesco, Palmira, '
                        'Guadalupe, Zapote, Brisas',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Zarcero se observa que el 81% de las casas'
                        ' cuentan con radio o equipos de sonido, el 61% con '
                        'línea de teléfono fija, 88% con teléfono celular, 15% '
                        'con pantalla de televisor, de este 15% el 95% de los '
                        'televisores son convencionales y el 58% son con cable '
                        'o satélite, el 34% tienen una computadora de escritorio,'
                        ' 23% con una computadora portátil y el 27% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el cantón de Zarcero el uso'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Zarcero/Alfaro Ruíz'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/cantonZarcero.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Zarcero');
            }
        ),
