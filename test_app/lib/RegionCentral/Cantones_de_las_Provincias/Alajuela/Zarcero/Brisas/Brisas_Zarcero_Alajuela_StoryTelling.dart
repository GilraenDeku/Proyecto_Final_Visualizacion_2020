...
class storytellingBrisasZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBrisasZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBrisasZarceroAlajuela.withSampleData() {
    return new storytellingBrisasZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Brisas se observa que el 79% de las casas'
                        ' cuentan con radio o equipos de sonido, el 47% con '
                        'línea de teléfono fija, 88% con teléfono celular, 12% '
                        'con pantalla de televisor, de este 12% el 97% de los '
                        'televisores son convencionales y el 46% son con cable o'
                        ' satélite, el 32% tienen una computadora de escritorio,'
                        ' 19% con una computadora portátil y el 18% de las casas'
