...
class storytellingZarceroZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZarceroZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZarceroZarceroAlajuela.withSampleData() {
    return new storytellingZarceroZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Zarcero se observa que el 82% de las '
                        ...
                        'televisores son convencionales y el 76% son con cable o'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Zarcero el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Zarcero'),
              ),
              body: ListView(
                children: [
                  Image.asset(
