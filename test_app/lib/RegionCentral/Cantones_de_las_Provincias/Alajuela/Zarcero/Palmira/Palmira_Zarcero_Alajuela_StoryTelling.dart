...
class storytellingPalmiraZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPalmiraZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPalmiraZarceroAlajuela.withSampleData() {
    return new storytellingPalmiraZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Palmira se observa que el 77% de las '
                        'casas cuentan con radio o equipos de sonido, el 58% con '
                        'línea de teléfono fija, 82% con teléfono celular, 13% '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Palmira'),
              ),
              body: ListView(
                children: [
                  Image.asset(
