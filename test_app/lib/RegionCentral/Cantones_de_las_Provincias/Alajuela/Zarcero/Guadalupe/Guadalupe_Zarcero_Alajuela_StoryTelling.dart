...
class storytellingGuadalupeZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGuadalupeZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGuadalupeZarceroAlajuela.withSampleData() {
    return new storytellingGuadalupeZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Guadalupe se observa que el 79% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% con'
                        ' línea de teléfono fija, 86% con teléfono celular, 7% '
                        'con pantalla de televisor, de este 7% el 96% de los '
                        'televisores son convencionales y el 24% son con cable '
                        'o satélite, el 21% tienen una computadora de escritorio,'
                        ' 18% con una computadora portátil y el 17% de las '
                        'casas cuentan con acceso de internet.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
