...
class storytellingZapoteZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingZapoteZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingZapoteZarceroAlajuela.withSampleData() {
    return new storytellingZapoteZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Zapote se observa que el 79% de las casas'
                        ' cuentan con radio o equipos de sonido, el 66% con línea'
                        ' de teléfono fija, 81% con teléfono celular, 15% con '
                        'pantalla de televisor, de este 15% el 91% de los '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Zapote el '
