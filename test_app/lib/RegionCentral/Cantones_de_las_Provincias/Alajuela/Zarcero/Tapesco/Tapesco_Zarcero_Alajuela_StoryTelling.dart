...
class storytellingTapescoZarceroAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTapescoZarceroAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTapescoZarceroAlajuela.withSampleData() {
    return new storytellingTapescoZarceroAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tapezco se observa que el 82% de las '
                        'casas cuentan con radio o equipos de sonido, el 66% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 10% '
                        ...
                        ' 21% con una computadora portátil y el 28% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más'
                        ...
                        'altos, lo que indica que en el distrito de Tapezco el '
                        'uso de las tecnologías es bastante grande, excepto en '
                        'las pantallas de televisión ya que se encuentran menores'
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tapezco'),
              ),
              body: ListView(
                children: [
                  Image.asset(
