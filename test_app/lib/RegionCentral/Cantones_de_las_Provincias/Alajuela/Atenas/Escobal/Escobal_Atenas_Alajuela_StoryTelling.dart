...
class storytellingEscobalAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingEscobalAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingEscobalAtenasAlajuela.withSampleData() {
    return new storytellingEscobalAtenasAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Atenas, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Escobal se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 59% '
                        'con línea de teléfono fija, 86% con teléfono celular, '
                        '12% con pantalla de televisor, de este 12% el 93% de '
                        'los televisores son convencionales y el 6% son con '
                        'cable o satélite, el 20% tienen una computadora de '
                        'escritorio, 23% con una computadora portátil y el 22% '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Escobal el uso de las '
                        'tecnologías es bastante grande, excepto en las'
                        ' pantallas de televisión ya que se encuentran '
                        'menores de 20% de disponibilidad de posesión en '
                        'la población.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Escobal'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoEscobalCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(5, 06, Color(0xff00B7C2)),
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://www.atenasmuni.go.cr/index.php/mapas-territoriales');
            }
        ),
