...
class storytellingAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAtenasAlajuela.withSampleData() {
    return new storytellingAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'Atenas es el cantón número 5 de la provincia de Alajuela,'
                        ' su cabecera es la ciudad de Atenas es conocida como'
                        ' "La ciudad con el mejor clima del Mundo" La '
                        'economía del cantón se sustenta en la agricultura,'
                        ' principalmente el cultivo del café, caña de azúcar,'
                        ' maíz, frijoles y frutales. También se realizan '
                        'actividades de ganadería extensiva, comercio y '
                        'pequeñas industrias.',
                    softWrap: true,
                ...
                SizedBox(height: 20),
                Text(
                    'Distritos: Atenas, San Isidro, Jesús, Concepción, '
                        'Mercedes, San José, Santa Eulalia, Escobal.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Atenas se observa que el 81% de las casas '
                        'cuentan con radio o equipos de sonido, el 69% con línea'
                        ' de teléfono fija, 87% con teléfono celular, 22% con '
                        'pantalla de televisor, de este 22% el 91% de los '
                        'televisores son convencionales y el 31% son con cable o'
                        ' satélite, el 34% tienen una computadora de escritorio,'
                        ' 31% con una computadora portátil y el 35% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el cantón de Atenas el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Atenas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/cantonAtenas.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Atenas');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.atenasmuni.go.cr/');
            }
        ),
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              // do what you need to do when "Click here" gets clicked
              launch('https://www.hacienda.go.cr/docs/58123bb85f95e_'
                  'Mapa%20del%20Canton%20%20Atenas%2005%20Distrito'
                  '%2001%20a%2008.pdf');
            }
        ),
          ...
          child: Center(
            ...
            GestureDetector(
                ...
                onTap: () {
                  // do what you need to do when "Click here" gets clicked
                  launch('https://www.hacienda.go.cr/docs/58123bb85f95e_'
                      'Mapa%20del%20Canton%20%20Atenas%2005%20'
