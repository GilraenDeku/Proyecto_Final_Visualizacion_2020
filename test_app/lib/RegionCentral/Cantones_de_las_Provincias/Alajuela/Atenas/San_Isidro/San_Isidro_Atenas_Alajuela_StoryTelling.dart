...
class storytellingSanIsidroAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroAtenasAlajuela.withSampleData() {
    return new storytellingSanIsidroAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Isidro se observa que el 76% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 84% con teléfono celular, 15% '
                        'con pantalla de televisor, de este 15% el 87% de los '
                        'televisores son convencionales y el 7% son con cable o '
                        'satélite, el 24% tienen una computadora de escritorio, '
                        '14% con una computadora portátil y el 13% de las casas '
                ...
                Text(
                    'En conclusión, en el caso de este distrito el uso de '
                        ...
                        'sonido, telefonía celular y fija, y computadora de '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanIsidroCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      new LinearSales(8, 13, Color(0xff900C3F)),
    ];
