...
class storytellingMercedesAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingMercedesAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingMercedesAtenasAlajuela.withSampleData() {
    return new storytellingMercedesAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Mercedes se observa que el 80% de las '
                        'casas cuentan con radio o equipos de sonido, el 64% con'
                        ' línea de teléfono fija, 88% con teléfono celular, 20% '
                        'con pantalla de televisor, de este 20% el 91% de los '
                        'televisores son convencionales y el 32% son con cable o'
                        ' satélite, el 33% tienen una computadora de escritorio,'
                        ' 27% con una computadora portátil y el 28% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Mercedes el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoMercedesCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
