...
class storytellingSanJoseAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJoseAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJoseAtenasAlajuela.withSampleData() {
    return new storytellingSanJoseAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San José se observa que el 77% de las '
                        'casas cuentan con radio o equipos de sonido, el 55% con'
                        ' línea de teléfono fija, 84% con teléfono celular, 14% '
                        'con pantalla de televisor, de este 14% el 93% de los '
                        'televisores son convencionales y el 18% son con cable o'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'las pantallas de televisión e internet ya que se '
                        'encuentran menores de 20% de disponibilidad de posesión'
                        ' en la población.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de San José'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSanJoseCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
