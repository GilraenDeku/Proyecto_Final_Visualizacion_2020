...
class storytellingSantaEulaliaAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSantaEulaliaAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSantaEulaliaAtenasAlajuela.withSampleData() {
    return new storytellingSantaEulaliaAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Santa Eulalia se observa que el 80% de '
                        'las casas cuentan con radio o equipos de sonido, el '
                        '59% con línea de teléfono fija, 86% con teléfono celular,'
                        ' 20% con pantalla de televisor, de este 20% el 91% de '
                        'los televisores son convencionales y el 26% son con '
                        'cable o satélite, el 30% tienen una computadora de '
                        'escritorio, 28% con una computadora portátil y el 24% de'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Santa Eulalia el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Santa Eulalia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoSantaEulaliaCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
