...
class GraficaRegionCentralJesusAtenasAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralJesusAtenasAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralJesusAtenasAlajuela.withSampleData() {
    return new GraficaRegionCentralJesusAtenasAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Jesús'),
              ),
              body: TabBarView(
                children: [
                  Padding(
