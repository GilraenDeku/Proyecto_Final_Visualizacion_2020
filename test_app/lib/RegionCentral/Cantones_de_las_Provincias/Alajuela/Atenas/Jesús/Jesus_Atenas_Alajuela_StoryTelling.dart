...
class storytellingJesusAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingJesusAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingJesusAtenasAlajuela.withSampleData() {
    return new storytellingJesusAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Jesús se observa que el 80% de las casas '
                        'cuentan con radio o equipos de sonido, el 71% con línea'
                        ' de teléfono fija, 87% con teléfono celular, 21% con '
                        'pantalla de televisor, de este 12% el 91% de los '
                        'televisores son convencionales y el 32% son con cable o'
                        ' satélite, el 34% tienen una computadora de escritorio,'
                        ' 31% con una computadora portátil y el 37% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Jesús el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Jesús'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoJesusCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
