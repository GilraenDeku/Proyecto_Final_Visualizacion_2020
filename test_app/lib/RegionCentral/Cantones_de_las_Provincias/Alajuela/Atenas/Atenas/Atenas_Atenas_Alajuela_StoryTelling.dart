...
class storytellingAtenasAtenasAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAtenasAtenasAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAtenasAtenasAlajuela.withSampleData() {
    return new storytellingAtenasAtenasAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Atenas se observa que el 85% de las casas'
                        ' cuentan con radio o equipos de sonido, el 80% con línea'
                        ' de teléfono fija, 89% con teléfono celular, 30% con '
                        'pantalla de televisor, de este 30% el 91% de los '
                        'televisores son convencionales y el 52% son con cable o'
                        ' satélite, el 45% tienen una computadora de escritorio,'
                        ' 42% con una computadora portátil y el 52% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en el distrito de Atenas el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Atenas'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/distritoAtenasCantonAtenas.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
