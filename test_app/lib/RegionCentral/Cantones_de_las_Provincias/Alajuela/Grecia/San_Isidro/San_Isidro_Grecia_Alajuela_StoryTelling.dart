...
class storytellingSanIsidroGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanIsidroGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanIsidroGreciaAlajuela.withSampleData() {
    return new storytellingSanIsidroGreciaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San Isidro se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 65% con'
                        ' línea de teléfono fija, 90% con teléfono celular, 22% '
                        'con pantalla de televisor, de este 22% el 94% de los '
                        'televisores son convencionales y el 47% son con cable o'
                        ' satélite, el 39% tienen una computadora de escritorio,'
                        ' 30% con una computadora portátil y el 33% de las casas'
