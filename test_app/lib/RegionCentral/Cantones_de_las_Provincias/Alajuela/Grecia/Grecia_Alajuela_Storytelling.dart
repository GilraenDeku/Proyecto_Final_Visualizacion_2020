...
class storytellingGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGreciaAlajuela.withSampleData() {
    return new storytellingGreciaAlajuela(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'Grecia es el cantón número 3 de la provincia de Alajuela, '
                        'su cabecera es la ciudad de Grecia. Grecia posee '
                        'una economía diversificada en la que predomina '
                        'la producción agrícola de café y caña de azúcar, '
                        'con presencia de actividades industriales relacionadas'
                        ' a estos cultivos, además de otros sectores '
                        'dedicados al comercio, fábricas y venta de vehículos.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'Distritos: Grecia, San Isidro, San José, '
                        'San Roque, Tacares, Puente de Piedra, Bolívar',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el cantón de Grecia se observa que el 82% de las casas '
                        'cuentan con radio o equipos de sonido, el 62% con línea'
                        ' de teléfono fija, 88% con teléfono celular, 21% con '
                        'pantalla de televisor, de este 21% el 91% de los '
                        'televisores son convencionales y el 40% son con cable o'
                        ' satélite, el 34% tienen una computadora de escritorio,'
                        ' 37% con una computadora portátil y el 30% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el cantón de Grecia el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Cantón de Grecia'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/cantonGrecia.png',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Cant%C3%B3n_de_Grecia');
            }
        ),
