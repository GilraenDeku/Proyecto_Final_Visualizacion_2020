...
class storytellingGreciaGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingGreciaGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingGreciaGreciaAlajuela.withSampleData() {
    return new storytellingGreciaGreciaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Grecia se observa que el 86% de las casas'
                        ' cuentan con radio o equipos de sonido, el 71% con línea'
                        ' de teléfono fija, 88% con teléfono celular, 30% con '
                        'pantalla de televisor, de este 30% el 92% de los '
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Grecia el '
