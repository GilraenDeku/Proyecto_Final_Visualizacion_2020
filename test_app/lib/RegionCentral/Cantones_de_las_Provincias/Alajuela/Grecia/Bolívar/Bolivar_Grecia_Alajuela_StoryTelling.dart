...
class storytellingBolivarGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingBolivarGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingBolivarGreciaAlajuela.withSampleData() {
    return new storytellingBolivarGreciaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Bolívar se observa que el 84% de las '
                        'casas cuentan con radio o equipos de sonido, el 61% con'
                        ' línea de teléfono fija, 87% con teléfono celular, 17% '
                        'con pantalla de televisor, de este 17% el 92% de los '
                        'televisores son convencionales y el 24% son con cable o'
                        ' satélite, el 33% tienen una computadora de escritorio,'
                        ' 24% con una computadora portátil y el 23% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Bolívar el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Bolívar'),
              ),
              body: ListView(
                children: [
                  Image.asset(
