...
class storytellingSanJoseGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingSanJoseGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingSanJoseGreciaAlajuela.withSampleData() {
    return new storytellingSanJoseGreciaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de San José se observa que el 85% de las '
                        'casas cuentan con radio o equipos de sonido, el 63% con'
                        ' línea de teléfono fija, 89% con teléfono celular, 21% '
                        ...
                        ' 26% con una computadora portátil y el 26% de las casas'
