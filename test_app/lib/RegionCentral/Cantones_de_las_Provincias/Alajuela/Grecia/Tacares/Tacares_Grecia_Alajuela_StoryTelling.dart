...
class storytellingTacaresGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingTacaresGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingTacaresGreciaAlajuela.withSampleData() {
    return new storytellingTacaresGreciaAlajuela(
      _createSampleData(),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Tacares se observa que el 82% de las casas'
                        ' cuentan con radio o equipos de sonido, el 66% con línea'
                        ' de teléfono fija, 88% con teléfono celular, 20% con '
                        'pantalla de televisor, de este 20% el 92% de los '
                        'televisores son convencionales y el 37% son con cable o'
                        ' satélite, el 32% tienen una computadora de escritorio,'
                        ' 21% con una computadora portátil y el 23% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Tacares '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Tacares'),
              ),
              body: ListView(
                children: [
                  Image.asset(
