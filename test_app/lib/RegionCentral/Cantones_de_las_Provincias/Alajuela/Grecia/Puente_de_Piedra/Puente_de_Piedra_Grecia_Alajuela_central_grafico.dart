...
class GraficaRegionCentralPuentedePiedraGreciaAlajuela extends StatelessWidget {
  List<charts.Series> centralList;
  final bool animate;

  GraficaRegionCentralPuentedePiedraGreciaAlajuela(this.centralList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory GraficaRegionCentralPuentedePiedraGreciaAlajuela.withSampleData() {
    return new GraficaRegionCentralPuentedePiedraGreciaAlajuela(
      _centralData(),
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Región Central Distrito Puente de Piedra'),
              ),
              body: TabBarView(
                children: [
                  Padding(
