...
class storytellingPuentedePiedraGreciaAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingPuentedePiedraGreciaAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingPuentedePiedraGreciaAlajuela.withSampleData() {
    return new storytellingPuentedePiedraGreciaAlajuela(
      _createSampleData(),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Cantón de Grecia, Provincia de Alajuela, Región Central',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                    'En el distrito de Puente de Piedra se observa que el 85% de'
                        ' las casas cuentan con radio o equipos de sonido, el 65%'
                        ' con línea de teléfono fija, 89% con teléfono celular, '
                        '21% con pantalla de televisor, de este 21% el 93% de los'
                        ' televisores son convencionales y el 37% son con cable '
                        'o satélite, el 33% tienen una computadora de escritorio,'
                        ' 24% con una computadora portátil y el 28% de las casas'
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología que más '
                        ...
                        'altos, lo que indica que en el distrito de Puente de '
                        'Piedra el '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Distrito de Puente de Piedra'),
              ),
              body: ListView(
                children: [
                  Image.asset(
                    'assets/greciaDistritos.jpg',
                    fit: BoxFit.cover,
                  ),
                  titleSection,
                  buttonSection,
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('http://mapas.grecia.go.cr/');
            }
        ),
