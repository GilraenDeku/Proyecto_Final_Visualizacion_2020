...
class storytellingAlajuela extends StatelessWidget {
  List<charts.Series> seriesList;
  final bool animate;

  storytellingAlajuela(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory storytellingAlajuela.withSampleData() {
    return new storytellingAlajuela(
      _createSampleData(),
              ...
              children: [
                ...
                Text(
                    'Alajuela es la provincia número 2 de Costa Rica, '
                        'localizada en la parte septentrional del país. '
                        'Está dividida en 16 cantones y 113 distritos. '
                        'Su cabecera es Alajuela, la segunda ciudad más'
                        ' poblada de todo el país, ubicada a 16 km de la '
                        'capital nacional, San José.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
                SizedBox(height: 20),
                Text(
                    'En la economía de la provincia predomina el sector '
                        'terciario y de servicios, con numerosos parques '
                        'industriales. El Aeropuerto Internacional '
                        'Juan Santamaría, es el principal del país, '
                        'se ubica en la ciudad de Alajuela.',
                    softWrap: true,
                    style: TextStyle(fontSize: 18),
                    textAlign: TextAlign.justify),
              ],
              ...
              children: [
                ...
                Text(
                    'En conclusión, se puede observar que la tecnología'
                        ...
                        'que en la provincia de Alajuela el uso de las '
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text('Provincia de Alajuela'),
              ),
              body: ListView(
                children: [
                  Image.asset(
      ...
      children: [
        ...
        GestureDetector(
            ...
            onTap: () {
              ...
              launch('https://es.wikipedia.org/wiki/Provincia_de_Alajuela');
            }
        ),
